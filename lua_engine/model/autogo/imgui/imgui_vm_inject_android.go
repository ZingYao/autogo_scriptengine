...
import (
	autogoimgui "github.com/Dasongzi1366/AutoGo/imgui"
...
func (m *ImGuiModule) Register(engine model.Engine) error {
	engine.RegisterMethod("imgui.setAssertHandler", "ImGui.SetAssertHandler", autogoimgui.SetAssertHandler, true)
	engine.RegisterMethod("imgui.init", "ImGui.Init", autogoimgui.Init, true)
	engine.RegisterMethod("imgui.run", "ImGui.Run", autogoimgui.Run, true)
	engine.RegisterMethod("imgui.close", "ImGui.Close", autogoimgui.Close, true)
	engine.RegisterMethod("imgui.newDrawCallbackFromC", "ImGui.NewDrawCallbackFromC", autogoimgui.NewDrawCallbackFromC, true)
	engine.RegisterMethod("imgui.clearDrawCallbackPool", "ImGui.ClearDrawCallbackPool", autogoimgui.ClearDrawCallbackPool, true)
	engine.RegisterMethod("imgui.newContextHookCallbackFromC", "ImGui.NewContextHookCallbackFromC", autogoimgui.NewContextHookCallbackFromC, true)
	engine.RegisterMethod("imgui.clearContextHookCallbackPool", "ImGui.ClearContextHookCallbackPool", autogoimgui.ClearContextHookCallbackPool, true)
	engine.RegisterMethod("imgui.newErrorCallbackFromC", "ImGui.NewErrorCallbackFromC", autogoimgui.NewErrorCallbackFromC, true)
	engine.RegisterMethod("imgui.clearErrorCallbackPool", "ImGui.ClearErrorCallbackPool", autogoimgui.ClearErrorCallbackPool, true)
	engine.RegisterMethod("imgui.newMemAllocFuncFromC", "ImGui.NewMemAllocFuncFromC", autogoimgui.NewMemAllocFuncFromC, true)
	engine.RegisterMethod("imgui.clearMemAllocFuncPool", "ImGui.ClearMemAllocFuncPool", autogoimgui.ClearMemAllocFuncPool, true)
	engine.RegisterMethod("imgui.newMemFreeFuncFromC", "ImGui.NewMemFreeFuncFromC", autogoimgui.NewMemFreeFuncFromC, true)
	engine.RegisterMethod("imgui.clearMemFreeFuncPool", "ImGui.ClearMemFreeFuncPool", autogoimgui.ClearMemFreeFuncPool, true)
	engine.RegisterMethod("imgui.newSizeCallbackFromC", "ImGui.NewSizeCallbackFromC", autogoimgui.NewSizeCallbackFromC, true)
	engine.RegisterMethod("imgui.clearSizeCallbackPool", "ImGui.ClearSizeCallbackPool", autogoimgui.ClearSizeCallbackPool, true)
	engine.RegisterMethod("imgui.newVec2", "ImGui.NewVec2", autogoimgui.NewVec2, true)
	engine.RegisterMethod("imgui.newVec4", "ImGui.NewVec4", autogoimgui.NewVec4, true)
	engine.RegisterMethod("imgui.newColor", "ImGui.NewColor", autogoimgui.NewColor, true)
	engine.RegisterMethod("imgui.newColorFromPacked", "ImGui.NewColorFromPacked", autogoimgui.NewColorFromPacked, true)
	engine.RegisterMethod("imgui.newColorFromColor", "ImGui.NewColorFromColor", autogoimgui.NewColorFromColor, true)
	engine.RegisterMethod("imgui.colorHSVV", "ImGui.ColorHSVV", autogoimgui.ColorHSVV, true)
	engine.RegisterMethod("imgui.newDrawCmd", "ImGui.NewDrawCmd", autogoimgui.NewDrawCmd, true)
	engine.RegisterMethod("imgui.internalNewDrawDataBuilder", "ImGui.InternalNewDrawDataBuilder", autogoimgui.InternalNewDrawDataBuilder, true)
	engine.RegisterMethod("imgui.newDrawData", "ImGui.NewDrawData", autogoimgui.NewDrawData, true)
	engine.RegisterMethod("imgui.internalNewDrawListSharedData", "ImGui.InternalNewDrawListSharedData", autogoimgui.InternalNewDrawListSharedData, true)
	engine.RegisterMethod("imgui.newDrawListSplitter", "ImGui.NewDrawListSplitter", autogoimgui.NewDrawListSplitter, true)
	engine.RegisterMethod("imgui.newDrawList", "ImGui.NewDrawList", autogoimgui.NewDrawList, true)
	engine.RegisterMethod("imgui.internalNewFontAtlasBuilder", "ImGui.InternalNewFontAtlasBuilder", autogoimgui.InternalNewFontAtlasBuilder, true)
	engine.RegisterMethod("imgui.newFontAtlasRect", "ImGui.NewFontAtlasRect", autogoimgui.NewFontAtlasRect, true)
	engine.RegisterMethod("imgui.newFontAtlas", "ImGui.NewFontAtlas", autogoimgui.NewFontAtlas, true)
	engine.RegisterMethod("imgui.newFontBaked", "ImGui.NewFontBaked", autogoimgui.NewFontBaked, true)
	engine.RegisterMethod("imgui.newFontConfig", "ImGui.NewFontConfig", autogoimgui.NewFontConfig, true)
	engine.RegisterMethod("imgui.newFontGlyphRangesBuilder", "ImGui.NewFontGlyphRangesBuilder", autogoimgui.NewFontGlyphRangesBuilder, true)
	engine.RegisterMethod("imgui.newFontGlyph", "ImGui.NewFontGlyph", autogoimgui.NewFontGlyph, true)
	engine.RegisterMethod("imgui.internalNewFontLoader", "ImGui.InternalNewFontLoader", autogoimgui.InternalNewFontLoader, true)
	engine.RegisterMethod("imgui.newFont", "ImGui.NewFont", autogoimgui.NewFont, true)
	engine.RegisterMethod("imgui.internalNewBoxSelectState", "ImGui.InternalNewBoxSelectState", autogoimgui.InternalNewBoxSelectState, true)
	engine.RegisterMethod("imgui.internalNewComboPreviewData", "ImGui.InternalNewComboPreviewData", autogoimgui.InternalNewComboPreviewData, true)
	engine.RegisterMethod("imgui.internalNewContextHook", "ImGui.InternalNewContextHook", autogoimgui.InternalNewContextHook, true)
	engine.RegisterMethod("imgui.internalNewContext", "ImGui.InternalNewContext", autogoimgui.InternalNewContext, true)
	engine.RegisterMethod("imgui.internalNewDebugAllocInfo", "ImGui.InternalNewDebugAllocInfo", autogoimgui.InternalNewDebugAllocInfo, true)
	engine.RegisterMethod("imgui.internalNewDockContext", "ImGui.InternalNewDockContext", autogoimgui.InternalNewDockContext, true)
	engine.RegisterMethod("imgui.internalNewDockNode", "ImGui.InternalNewDockNode", autogoimgui.InternalNewDockNode, true)
	engine.RegisterMethod("imgui.internalNewErrorRecoveryState", "ImGui.InternalNewErrorRecoveryState", autogoimgui.InternalNewErrorRecoveryState, true)
	engine.RegisterMethod("imgui.internalNewIDStackTool", "ImGui.InternalNewIDStackTool", autogoimgui.InternalNewIDStackTool, true)
	engine.RegisterMethod("imgui.newIO", "ImGui.NewIO", autogoimgui.NewIO, true)
	engine.RegisterMethod("imgui.internalNewInputEvent", "ImGui.InternalNewInputEvent", autogoimgui.InternalNewInputEvent, true)
	engine.RegisterMethod("imgui.newInputTextCallbackData", "ImGui.NewInputTextCallbackData", autogoimgui.NewInputTextCallbackData, true)
	engine.RegisterMethod("imgui.internalNewInputTextDeactivatedState", "ImGui.InternalNewInputTextDeactivatedState", autogoimgui.InternalNewInputTextDeactivatedState, true)
	engine.RegisterMethod("imgui.internalNewInputTextState", "ImGui.InternalNewInputTextState", autogoimgui.InternalNewInputTextState, true)
	engine.RegisterMethod("imgui.internalNewKeyOwnerData", "ImGui.InternalNewKeyOwnerData", autogoimgui.InternalNewKeyOwnerData, true)
	engine.RegisterMethod("imgui.internalNewKeyRoutingData", "ImGui.InternalNewKeyRoutingData", autogoimgui.InternalNewKeyRoutingData, true)
	engine.RegisterMethod("imgui.internalNewKeyRoutingTable", "ImGui.InternalNewKeyRoutingTable", autogoimgui.InternalNewKeyRoutingTable, true)
	engine.RegisterMethod("imgui.internalNewLastItemData", "ImGui.InternalNewLastItemData", autogoimgui.InternalNewLastItemData, true)
	engine.RegisterMethod("imgui.internalNewListClipperData", "ImGui.InternalNewListClipperData", autogoimgui.InternalNewListClipperData, true)
	engine.RegisterMethod("imgui.internalListClipperRangeFromIndices", "ImGui.InternalListClipperRangeFromIndices", autogoimgui.InternalListClipperRangeFromIndices, true)
	engine.RegisterMethod("imgui.internalListClipperRangeFromPositions", "ImGui.InternalListClipperRangeFromPositions", autogoimgui.InternalListClipperRangeFromPositions, true)
	engine.RegisterMethod("imgui.newListClipper", "ImGui.NewListClipper", autogoimgui.NewListClipper, true)
	engine.RegisterMethod("imgui.internalNewMenuColumns", "ImGui.InternalNewMenuColumns", autogoimgui.InternalNewMenuColumns, true)
	engine.RegisterMethod("imgui.internalNewMultiSelectState", "ImGui.InternalNewMultiSelectState", autogoimgui.InternalNewMultiSelectState, true)
	engine.RegisterMethod("imgui.internalNewMultiSelectTempData", "ImGui.InternalNewMultiSelectTempData", autogoimgui.InternalNewMultiSelectTempData, true)
	engine.RegisterMethod("imgui.internalNewNavItemData", "ImGui.InternalNewNavItemData", autogoimgui.InternalNewNavItemData, true)
	engine.RegisterMethod("imgui.internalNewNextItemData", "ImGui.InternalNewNextItemData", autogoimgui.InternalNewNextItemData, true)
	engine.RegisterMethod("imgui.internalNewNextWindowData", "ImGui.InternalNewNextWindowData", autogoimgui.InternalNewNextWindowData, true)
	engine.RegisterMethod("imgui.internalNewOldColumnData", "ImGui.InternalNewOldColumnData", autogoimgui.InternalNewOldColumnData, true)
	engine.RegisterMethod("imgui.internalNewOldColumns", "ImGui.InternalNewOldColumns", autogoimgui.InternalNewOldColumns, true)
	engine.RegisterMethod("imgui.newOnceUponAFrame", "ImGui.NewOnceUponAFrame", autogoimgui.NewOnceUponAFrame, true)
	engine.RegisterMethod("imgui.newPayload", "ImGui.NewPayload", autogoimgui.NewPayload, true)
	engine.RegisterMethod("imgui.newPlatformIO", "ImGui.NewPlatformIO", autogoimgui.NewPlatformIO, true)
	engine.RegisterMethod("imgui.newPlatformImeData", "ImGui.NewPlatformImeData", autogoimgui.NewPlatformImeData, true)
	engine.RegisterMethod("imgui.newPlatformMonitor", "ImGui.NewPlatformMonitor", autogoimgui.NewPlatformMonitor, true)
	engine.RegisterMethod("imgui.internalNewPopupData", "ImGui.InternalNewPopupData", autogoimgui.InternalNewPopupData, true)
	engine.RegisterMethod("imgui.internalNewPtrOrIndexInt", "ImGui.InternalNewPtrOrIndexInt", autogoimgui.InternalNewPtrOrIndexInt, true)
	engine.RegisterMethod("imgui.internalNewPtrOrIndexPtr", "ImGui.InternalNewPtrOrIndexPtr", autogoimgui.InternalNewPtrOrIndexPtr, true)
	engine.RegisterMethod("imgui.newSelectionBasicStorage", "ImGui.NewSelectionBasicStorage", autogoimgui.NewSelectionBasicStorage, true)
	engine.RegisterMethod("imgui.newSelectionExternalStorage", "ImGui.NewSelectionExternalStorage", autogoimgui.NewSelectionExternalStorage, true)
	engine.RegisterMethod("imgui.internalNewSettingsHandler", "ImGui.InternalNewSettingsHandler", autogoimgui.InternalNewSettingsHandler, true)
	engine.RegisterMethod("imgui.internalNewStackLevelInfo", "ImGui.InternalNewStackLevelInfo", autogoimgui.InternalNewStackLevelInfo, true)
	engine.RegisterMethod("imgui.newStoragePairFloat", "ImGui.NewStoragePairFloat", autogoimgui.NewStoragePairFloat, true)
	engine.RegisterMethod("imgui.newStoragePairInt", "ImGui.NewStoragePairInt", autogoimgui.NewStoragePairInt, true)
	engine.RegisterMethod("imgui.newStoragePairPtr", "ImGui.NewStoragePairPtr", autogoimgui.NewStoragePairPtr, true)
	engine.RegisterMethod("imgui.internalNewStyleModFloat", "ImGui.InternalNewStyleModFloat", autogoimgui.InternalNewStyleModFloat, true)
	engine.RegisterMethod("imgui.internalNewStyleModInt", "ImGui.InternalNewStyleModInt", autogoimgui.InternalNewStyleModInt, true)
	engine.RegisterMethod("imgui.internalNewStyleModVec2", "ImGui.InternalNewStyleModVec2", autogoimgui.InternalNewStyleModVec2, true)
	engine.RegisterMethod("imgui.newStyle", "ImGui.NewStyle", autogoimgui.NewStyle, true)
	engine.RegisterMethod("imgui.internalNewTabBar", "ImGui.InternalNewTabBar", autogoimgui.InternalNewTabBar, true)
	engine.RegisterMethod("imgui.internalNewTabItem", "ImGui.InternalNewTabItem", autogoimgui.InternalNewTabItem, true)
	engine.RegisterMethod("imgui.internalNewTableColumnSettings", "ImGui.InternalNewTableColumnSettings", autogoimgui.InternalNewTableColumnSettings, true)
	engine.RegisterMethod("imgui.newTableColumnSortSpecs", "ImGui.NewTableColumnSortSpecs", autogoimgui.NewTableColumnSortSpecs, true)
	engine.RegisterMethod("imgui.internalNewTableColumn", "ImGui.InternalNewTableColumn", autogoimgui.InternalNewTableColumn, true)
	engine.RegisterMethod("imgui.internalNewTableInstanceData", "ImGui.InternalNewTableInstanceData", autogoimgui.InternalNewTableInstanceData, true)
	engine.RegisterMethod("imgui.internalNewTableSettings", "ImGui.InternalNewTableSettings", autogoimgui.InternalNewTableSettings, true)
	engine.RegisterMethod("imgui.newTableSortSpecs", "ImGui.NewTableSortSpecs", autogoimgui.NewTableSortSpecs, true)
	engine.RegisterMethod("imgui.internalNewTableTempData", "ImGui.InternalNewTableTempData", autogoimgui.InternalNewTableTempData, true)
	engine.RegisterMethod("imgui.internalNewTable", "ImGui.InternalNewTable", autogoimgui.InternalNewTable, true)
	engine.RegisterMethod("imgui.newTextBuffer", "ImGui.NewTextBuffer", autogoimgui.NewTextBuffer, true)
	engine.RegisterMethod("imgui.newTextFilter", "ImGui.NewTextFilter", autogoimgui.NewTextFilter, true)
	engine.RegisterMethod("imgui.newTextRangeNil", "ImGui.NewTextRangeNil", autogoimgui.NewTextRangeNil, true)
	engine.RegisterMethod("imgui.newTextRangeStr", "ImGui.NewTextRangeStr", autogoimgui.NewTextRangeStr, true)
	engine.RegisterMethod("imgui.internalNewTypingSelectState", "ImGui.InternalNewTypingSelectState", autogoimgui.InternalNewTypingSelectState, true)
	engine.RegisterMethod("imgui.internalNewViewportP", "ImGui.InternalNewViewportP", autogoimgui.InternalNewViewportP, true)
	engine.RegisterMethod("imgui.newViewport", "ImGui.NewViewport", autogoimgui.NewViewport, true)
	engine.RegisterMethod("imgui.newWindowClass", "ImGui.NewWindowClass", autogoimgui.NewWindowClass, true)
	engine.RegisterMethod("imgui.internalNewWindowSettings", "ImGui.InternalNewWindowSettings", autogoimgui.InternalNewWindowSettings, true)
	engine.RegisterMethod("imgui.internalNewWindow", "ImGui.InternalNewWindow", autogoimgui.InternalNewWindow, true)
	engine.RegisterMethod("imgui.newTextureData", "ImGui.NewTextureData", autogoimgui.NewTextureData, true)
	engine.RegisterMethod("imgui.newTextureRefNil", "ImGui.NewTextureRefNil", autogoimgui.NewTextureRefNil, true)
	engine.RegisterMethod("imgui.newTextureRefTextureID", "ImGui.NewTextureRefTextureID", autogoimgui.NewTextureRefTextureID, true)
	engine.RegisterMethod("imgui.internalNewVec1Float", "ImGui.InternalNewVec1Float", autogoimgui.InternalNewVec1Float, true)
	engine.RegisterMethod("imgui.internalNewVec1Nil", "ImGui.InternalNewVec1Nil", autogoimgui.InternalNewVec1Nil, true)
	engine.RegisterMethod("imgui.internalNewVec2iInt", "ImGui.InternalNewVec2iInt", autogoimgui.InternalNewVec2iInt, true)
	engine.RegisterMethod("imgui.internalNewVec2iNil", "ImGui.InternalNewVec2iNil", autogoimgui.InternalNewVec2iNil, true)
	engine.RegisterMethod("imgui.newVec4Float", "ImGui.NewVec4Float", autogoimgui.NewVec4Float, true)
	engine.RegisterMethod("imgui.newVec4Nil", "ImGui.NewVec4Nil", autogoimgui.NewVec4Nil, true)
	engine.RegisterMethod("imgui.acceptDragDropPayloadV", "ImGui.AcceptDragDropPayloadV", autogoimgui.AcceptDragDropPayloadV, true)
	engine.RegisterMethod("imgui.internalActivateItemByID", "ImGui.InternalActivateItemByID", autogoimgui.InternalActivateItemByID, true)
	engine.RegisterMethod("imgui.internalAddContextHook", "ImGui.InternalAddContextHook", autogoimgui.InternalAddContextHook, true)
	engine.RegisterMethod("imgui.internalAddSettingsHandler", "ImGui.InternalAddSettingsHandler", autogoimgui.InternalAddSettingsHandler, true)
	engine.RegisterMethod("imgui.alignTextToFramePadding", "ImGui.AlignTextToFramePadding", autogoimgui.AlignTextToFramePadding, true)
	engine.RegisterMethod("imgui.arrowButton", "ImGui.ArrowButton", autogoimgui.ArrowButton, true)
	engine.RegisterMethod("imgui.internalArrowButtonExV", "ImGui.InternalArrowButtonExV", autogoimgui.InternalArrowButtonExV, true)
	engine.RegisterMethod("imgui.beginV", "ImGui.BeginV", autogoimgui.BeginV, true)
	engine.RegisterMethod("imgui.internalBeginBoxSelect", "ImGui.InternalBeginBoxSelect", autogoimgui.InternalBeginBoxSelect, true)
	engine.RegisterMethod("imgui.internalBeginChildEx", "ImGui.InternalBeginChildEx", autogoimgui.InternalBeginChildEx, true)
	engine.RegisterMethod("imgui.beginChildIDV", "ImGui.BeginChildIDV", autogoimgui.BeginChildIDV, true)
	engine.RegisterMethod("imgui.beginChildStrV", "ImGui.BeginChildStrV", autogoimgui.BeginChildStrV, true)
	engine.RegisterMethod("imgui.internalBeginColumnsV", "ImGui.InternalBeginColumnsV", autogoimgui.InternalBeginColumnsV, true)
	engine.RegisterMethod("imgui.beginComboV", "ImGui.BeginComboV", autogoimgui.BeginComboV, true)
	engine.RegisterMethod("imgui.internalBeginComboPopup", "ImGui.InternalBeginComboPopup", autogoimgui.InternalBeginComboPopup, true)
	engine.RegisterMethod("imgui.internalBeginComboPreview", "ImGui.InternalBeginComboPreview", autogoimgui.InternalBeginComboPreview, true)
	engine.RegisterMethod("imgui.beginDisabledV", "ImGui.BeginDisabledV", autogoimgui.BeginDisabledV, true)
	engine.RegisterMethod("imgui.internalBeginDisabledOverrideReenable", "ImGui.InternalBeginDisabledOverrideReenable", autogoimgui.InternalBeginDisabledOverrideReenable, true)
	engine.RegisterMethod("imgui.internalBeginDockableDragDropSource", "ImGui.InternalBeginDockableDragDropSource", autogoimgui.InternalBeginDockableDragDropSource, true)
	engine.RegisterMethod("imgui.internalBeginDockableDragDropTarget", "ImGui.InternalBeginDockableDragDropTarget", autogoimgui.InternalBeginDockableDragDropTarget, true)
	engine.RegisterMethod("imgui.internalBeginDocked", "ImGui.InternalBeginDocked", autogoimgui.InternalBeginDocked, true)
	engine.RegisterMethod("imgui.beginDragDropSourceV", "ImGui.BeginDragDropSourceV", autogoimgui.BeginDragDropSourceV, true)
	engine.RegisterMethod("imgui.beginDragDropTarget", "ImGui.BeginDragDropTarget", autogoimgui.BeginDragDropTarget, true)
	engine.RegisterMethod("imgui.internalBeginDragDropTargetCustom", "ImGui.InternalBeginDragDropTargetCustom", autogoimgui.InternalBeginDragDropTargetCustom, true)
	engine.RegisterMethod("imgui.internalBeginDragDropTargetViewportV", "ImGui.InternalBeginDragDropTargetViewportV", autogoimgui.InternalBeginDragDropTargetViewportV, true)
	engine.RegisterMethod("imgui.internalBeginErrorTooltip", "ImGui.InternalBeginErrorTooltip", autogoimgui.InternalBeginErrorTooltip, true)
	engine.RegisterMethod("imgui.beginGroup", "ImGui.BeginGroup", autogoimgui.BeginGroup, true)
	engine.RegisterMethod("imgui.beginItemTooltip", "ImGui.BeginItemTooltip", autogoimgui.BeginItemTooltip, true)
	engine.RegisterMethod("imgui.beginListBoxV", "ImGui.BeginListBoxV", autogoimgui.BeginListBoxV, true)
	engine.RegisterMethod("imgui.beginMainMenuBar", "ImGui.BeginMainMenuBar", autogoimgui.BeginMainMenuBar, true)
	engine.RegisterMethod("imgui.beginMenuV", "ImGui.BeginMenuV", autogoimgui.BeginMenuV, true)
	engine.RegisterMethod("imgui.beginMenuBar", "ImGui.BeginMenuBar", autogoimgui.BeginMenuBar, true)
	engine.RegisterMethod("imgui.internalBeginMenuExV", "ImGui.InternalBeginMenuExV", autogoimgui.InternalBeginMenuExV, true)
	engine.RegisterMethod("imgui.beginMultiSelectV", "ImGui.BeginMultiSelectV", autogoimgui.BeginMultiSelectV, true)
	engine.RegisterMethod("imgui.beginPopupV", "ImGui.BeginPopupV", autogoimgui.BeginPopupV, true)
	engine.RegisterMethod("imgui.beginPopupContextItemV", "ImGui.BeginPopupContextItemV", autogoimgui.BeginPopupContextItemV, true)
	engine.RegisterMethod("imgui.beginPopupContextVoidV", "ImGui.BeginPopupContextVoidV", autogoimgui.BeginPopupContextVoidV, true)
	engine.RegisterMethod("imgui.beginPopupContextWindowV", "ImGui.BeginPopupContextWindowV", autogoimgui.BeginPopupContextWindowV, true)
	engine.RegisterMethod("imgui.internalBeginPopupEx", "ImGui.InternalBeginPopupEx", autogoimgui.InternalBeginPopupEx, true)
	engine.RegisterMethod("imgui.internalBeginPopupMenuEx", "ImGui.InternalBeginPopupMenuEx", autogoimgui.InternalBeginPopupMenuEx, true)
	engine.RegisterMethod("imgui.beginPopupModalV", "ImGui.BeginPopupModalV", autogoimgui.BeginPopupModalV, true)
	engine.RegisterMethod("imgui.beginTabBarV", "ImGui.BeginTabBarV", autogoimgui.BeginTabBarV, true)
	engine.RegisterMethod("imgui.internalBeginTabBarEx", "ImGui.InternalBeginTabBarEx", autogoimgui.InternalBeginTabBarEx, true)
	engine.RegisterMethod("imgui.beginTabItemV", "ImGui.BeginTabItemV", autogoimgui.BeginTabItemV, true)
	engine.RegisterMethod("imgui.beginTableV", "ImGui.BeginTableV", autogoimgui.BeginTableV, true)
	engine.RegisterMethod("imgui.internalBeginTableExV", "ImGui.InternalBeginTableExV", autogoimgui.InternalBeginTableExV, true)
	engine.RegisterMethod("imgui.beginTooltip", "ImGui.BeginTooltip", autogoimgui.BeginTooltip, true)
	engine.RegisterMethod("imgui.internalBeginTooltipEx", "ImGui.InternalBeginTooltipEx", autogoimgui.InternalBeginTooltipEx, true)
	engine.RegisterMethod("imgui.internalBeginTooltipHidden", "ImGui.InternalBeginTooltipHidden", autogoimgui.InternalBeginTooltipHidden, true)
	engine.RegisterMethod("imgui.internalBeginViewportSideBar", "ImGui.InternalBeginViewportSideBar", autogoimgui.InternalBeginViewportSideBar, true)
	engine.RegisterMethod("imgui.internalBringWindowToDisplayBack", "ImGui.InternalBringWindowToDisplayBack", autogoimgui.InternalBringWindowToDisplayBack, true)
	engine.RegisterMethod("imgui.internalBringWindowToDisplayBehind", "ImGui.InternalBringWindowToDisplayBehind", autogoimgui.InternalBringWindowToDisplayBehind, true)
	engine.RegisterMethod("imgui.internalBringWindowToDisplayFront", "ImGui.InternalBringWindowToDisplayFront", autogoimgui.InternalBringWindowToDisplayFront, true)
	engine.RegisterMethod("imgui.internalBringWindowToFocusFront", "ImGui.InternalBringWindowToFocusFront", autogoimgui.InternalBringWindowToFocusFront, true)
	engine.RegisterMethod("imgui.bullet", "ImGui.Bullet", autogoimgui.Bullet, true)
	engine.RegisterMethod("imgui.bulletText", "ImGui.BulletText", autogoimgui.BulletText, true)
	engine.RegisterMethod("imgui.buttonV", "ImGui.ButtonV", autogoimgui.ButtonV, true)
	engine.RegisterMethod("imgui.internalButtonBehaviorV", "ImGui.InternalButtonBehaviorV", autogoimgui.InternalButtonBehaviorV, true)
	engine.RegisterMethod("imgui.internalButtonExV", "ImGui.InternalButtonExV", autogoimgui.InternalButtonExV, true)
	engine.RegisterMethod("imgui.internalCalcClipRectVisibleItemsY", "ImGui.InternalCalcClipRectVisibleItemsY", autogoimgui.InternalCalcClipRectVisibleItemsY, true)
	engine.RegisterMethod("imgui.internalCalcItemSize", "ImGui.InternalCalcItemSize", autogoimgui.InternalCalcItemSize, true)
	engine.RegisterMethod("imgui.calcItemWidth", "ImGui.CalcItemWidth", autogoimgui.CalcItemWidth, true)
	engine.RegisterMethod("imgui.internalCalcRoundingFlagsForRectInRect", "ImGui.InternalCalcRoundingFlagsForRectInRect", autogoimgui.InternalCalcRoundingFlagsForRectInRect, true)
	engine.RegisterMethod("imgui.calcTextSizeV", "ImGui.CalcTextSizeV", autogoimgui.CalcTextSizeV, true)
	engine.RegisterMethod("imgui.internalCalcTypematicRepeatAmount", "ImGui.InternalCalcTypematicRepeatAmount", autogoimgui.InternalCalcTypematicRepeatAmount, true)
	engine.RegisterMethod("imgui.internalCalcWindowNextAutoFitSize", "ImGui.InternalCalcWindowNextAutoFitSize", autogoimgui.InternalCalcWindowNextAutoFitSize, true)
	engine.RegisterMethod("imgui.internalCalcWrapWidthForPos", "ImGui.InternalCalcWrapWidthForPos", autogoimgui.InternalCalcWrapWidthForPos, true)
	engine.RegisterMethod("imgui.internalCallContextHooks", "ImGui.InternalCallContextHooks", autogoimgui.InternalCallContextHooks, true)
	engine.RegisterMethod("imgui.checkbox", "ImGui.Checkbox", autogoimgui.Checkbox, true)
	engine.RegisterMethod("imgui.checkboxFlagsIntPtr", "ImGui.CheckboxFlagsIntPtr", autogoimgui.CheckboxFlagsIntPtr, true)
	engine.RegisterMethod("imgui.internalCheckboxFlagsS64Ptr", "ImGui.InternalCheckboxFlagsS64Ptr", autogoimgui.InternalCheckboxFlagsS64Ptr, true)
	engine.RegisterMethod("imgui.internalCheckboxFlagsU64Ptr", "ImGui.InternalCheckboxFlagsU64Ptr", autogoimgui.InternalCheckboxFlagsU64Ptr, true)
	engine.RegisterMethod("imgui.checkboxFlagsUintPtr", "ImGui.CheckboxFlagsUintPtr", autogoimgui.CheckboxFlagsUintPtr, true)
	engine.RegisterMethod("imgui.internalClearActiveID", "ImGui.InternalClearActiveID", autogoimgui.InternalClearActiveID, true)
	engine.RegisterMethod("imgui.internalClearDragDrop", "ImGui.InternalClearDragDrop", autogoimgui.InternalClearDragDrop, true)
	engine.RegisterMethod("imgui.internalClearIniSettings", "ImGui.InternalClearIniSettings", autogoimgui.InternalClearIniSettings, true)
	engine.RegisterMethod("imgui.internalClearWindowSettings", "ImGui.InternalClearWindowSettings", autogoimgui.InternalClearWindowSettings, true)
	engine.RegisterMethod("imgui.internalCloseButton", "ImGui.InternalCloseButton", autogoimgui.InternalCloseButton, true)
	engine.RegisterMethod("imgui.closeCurrentPopup", "ImGui.CloseCurrentPopup", autogoimgui.CloseCurrentPopup, true)
	engine.RegisterMethod("imgui.internalClosePopupToLevel", "ImGui.InternalClosePopupToLevel", autogoimgui.InternalClosePopupToLevel, true)
	engine.RegisterMethod("imgui.internalClosePopupsExceptModals", "ImGui.InternalClosePopupsExceptModals", autogoimgui.InternalClosePopupsExceptModals, true)
	engine.RegisterMethod("imgui.internalClosePopupsOverWindow", "ImGui.InternalClosePopupsOverWindow", autogoimgui.InternalClosePopupsOverWindow, true)
	engine.RegisterMethod("imgui.internalCollapseButton", "ImGui.InternalCollapseButton", autogoimgui.InternalCollapseButton, true)
	engine.RegisterMethod("imgui.collapsingHeaderBoolPtrV", "ImGui.CollapsingHeaderBoolPtrV", autogoimgui.CollapsingHeaderBoolPtrV, true)
	engine.RegisterMethod("imgui.collapsingHeaderTreeNodeFlagsV", "ImGui.CollapsingHeaderTreeNodeFlagsV", autogoimgui.CollapsingHeaderTreeNodeFlagsV, true)
	engine.RegisterMethod("imgui.colorButtonV", "ImGui.ColorButtonV", autogoimgui.ColorButtonV, true)
	engine.RegisterMethod("imgui.colorConvertFloat4ToU32", "ImGui.ColorConvertFloat4ToU32", autogoimgui.ColorConvertFloat4ToU32, true)
	engine.RegisterMethod("imgui.colorConvertHSVtoRGB", "ImGui.ColorConvertHSVtoRGB", autogoimgui.ColorConvertHSVtoRGB, true)
	engine.RegisterMethod("imgui.colorConvertRGBtoHSV", "ImGui.ColorConvertRGBtoHSV", autogoimgui.ColorConvertRGBtoHSV, true)
	engine.RegisterMethod("imgui.colorConvertU32ToFloat4", "ImGui.ColorConvertU32ToFloat4", autogoimgui.ColorConvertU32ToFloat4, true)
	engine.RegisterMethod("imgui.colorEdit3V", "ImGui.ColorEdit3V", autogoimgui.ColorEdit3V, true)
	engine.RegisterMethod("imgui.colorEdit4V", "ImGui.ColorEdit4V", autogoimgui.ColorEdit4V, true)
	engine.RegisterMethod("imgui.internalColorEditOptionsPopup", "ImGui.InternalColorEditOptionsPopup", autogoimgui.InternalColorEditOptionsPopup, true)
	engine.RegisterMethod("imgui.colorPicker3V", "ImGui.ColorPicker3V", autogoimgui.ColorPicker3V, true)
	engine.RegisterMethod("imgui.colorPicker4V", "ImGui.ColorPicker4V", autogoimgui.ColorPicker4V, true)
	engine.RegisterMethod("imgui.internalColorPickerOptionsPopup", "ImGui.InternalColorPickerOptionsPopup", autogoimgui.InternalColorPickerOptionsPopup, true)
	engine.RegisterMethod("imgui.internalColorTooltip", "ImGui.InternalColorTooltip", autogoimgui.InternalColorTooltip, true)
	engine.RegisterMethod("imgui.columnsV", "ImGui.ColumnsV", autogoimgui.ColumnsV, true)
	engine.RegisterMethod("imgui.comboStrV", "ImGui.ComboStrV", autogoimgui.ComboStrV, true)
	engine.RegisterMethod("imgui.comboStrarrV", "ImGui.ComboStrarrV", autogoimgui.ComboStrarrV, true)
	engine.RegisterMethod("imgui.internalConvertSingleModFlagToKey", "ImGui.InternalConvertSingleModFlagToKey", autogoimgui.InternalConvertSingleModFlagToKey, true)
	engine.RegisterMethod("imgui.createContextV", "ImGui.CreateContextV", autogoimgui.CreateContextV, true)
	engine.RegisterMethod("imgui.internalCreateNewWindowSettings", "ImGui.InternalCreateNewWindowSettings", autogoimgui.InternalCreateNewWindowSettings, true)
	engine.RegisterMethod("imgui.internalDataTypeApplyFromTextV", "ImGui.InternalDataTypeApplyFromTextV", autogoimgui.InternalDataTypeApplyFromTextV, true)
	engine.RegisterMethod("imgui.internalDataTypeApplyOp", "ImGui.InternalDataTypeApplyOp", autogoimgui.InternalDataTypeApplyOp, true)
	engine.RegisterMethod("imgui.internalDataTypeClamp", "ImGui.InternalDataTypeClamp", autogoimgui.InternalDataTypeClamp, true)
	engine.RegisterMethod("imgui.internalDataTypeCompare", "ImGui.InternalDataTypeCompare", autogoimgui.InternalDataTypeCompare, true)
	engine.RegisterMethod("imgui.internalDataTypeFormatString", "ImGui.InternalDataTypeFormatString", autogoimgui.InternalDataTypeFormatString, true)
	engine.RegisterMethod("imgui.internalDataTypeGetInfo", "ImGui.InternalDataTypeGetInfo", autogoimgui.InternalDataTypeGetInfo, true)
	engine.RegisterMethod("imgui.internalDataTypeIsZero", "ImGui.InternalDataTypeIsZero", autogoimgui.InternalDataTypeIsZero, true)
	engine.RegisterMethod("imgui.internalDebugAllocHook", "ImGui.InternalDebugAllocHook", autogoimgui.InternalDebugAllocHook, true)
	engine.RegisterMethod("imgui.internalDebugBreakButton", "ImGui.InternalDebugBreakButton", autogoimgui.InternalDebugBreakButton, true)
	engine.RegisterMethod("imgui.internalDebugBreakButtonTooltip", "ImGui.InternalDebugBreakButtonTooltip", autogoimgui.InternalDebugBreakButtonTooltip, true)
	engine.RegisterMethod("imgui.internalDebugBreakClearData", "ImGui.InternalDebugBreakClearData", autogoimgui.InternalDebugBreakClearData, true)
	engine.RegisterMethod("imgui.debugCheckVersionAndDataLayout", "ImGui.DebugCheckVersionAndDataLayout", autogoimgui.DebugCheckVersionAndDataLayout, true)
	engine.RegisterMethod("imgui.internalDebugDrawCursorPosV", "ImGui.InternalDebugDrawCursorPosV", autogoimgui.InternalDebugDrawCursorPosV, true)
	engine.RegisterMethod("imgui.internalDebugDrawItemRectV", "ImGui.InternalDebugDrawItemRectV", autogoimgui.InternalDebugDrawItemRectV, true)
	engine.RegisterMethod("imgui.internalDebugDrawLineExtentsV", "ImGui.InternalDebugDrawLineExtentsV", autogoimgui.InternalDebugDrawLineExtentsV, true)
	engine.RegisterMethod("imgui.debugFlashStyleColor", "ImGui.DebugFlashStyleColor", autogoimgui.DebugFlashStyleColor, true)
	engine.RegisterMethod("imgui.internalDebugHookIdInfo", "ImGui.InternalDebugHookIdInfo", autogoimgui.InternalDebugHookIdInfo, true)
	engine.RegisterMethod("imgui.internalDebugLocateItem", "ImGui.InternalDebugLocateItem", autogoimgui.InternalDebugLocateItem, true)
	engine.RegisterMethod("imgui.internalDebugLocateItemOnHover", "ImGui.InternalDebugLocateItemOnHover", autogoimgui.InternalDebugLocateItemOnHover, true)
	engine.RegisterMethod("imgui.internalDebugLocateItemResolveWithLastItem", "ImGui.InternalDebugLocateItemResolveWithLastItem", autogoimgui.InternalDebugLocateItemResolveWithLastItem, true)
	engine.RegisterMethod("imgui.debugLog", "ImGui.DebugLog", autogoimgui.DebugLog, true)
	engine.RegisterMethod("imgui.internalDebugNodeColumns", "ImGui.InternalDebugNodeColumns", autogoimgui.InternalDebugNodeColumns, true)
	engine.RegisterMethod("imgui.internalDebugNodeDockNode", "ImGui.InternalDebugNodeDockNode", autogoimgui.InternalDebugNodeDockNode, true)
	engine.RegisterMethod("imgui.internalDebugNodeDrawCmdShowMeshAndBoundingBox", "ImGui.InternalDebugNodeDrawCmdShowMeshAndBoundingBox", autogoimgui.InternalDebugNodeDrawCmdShowMeshAndBoundingBox, true)
	engine.RegisterMethod("imgui.internalDebugNodeDrawList", "ImGui.InternalDebugNodeDrawList", autogoimgui.InternalDebugNodeDrawList, true)
	engine.RegisterMethod("imgui.internalDebugNodeFont", "ImGui.InternalDebugNodeFont", autogoimgui.InternalDebugNodeFont, true)
	engine.RegisterMethod("imgui.internalDebugNodeFontGlyph", "ImGui.InternalDebugNodeFontGlyph", autogoimgui.InternalDebugNodeFontGlyph, true)
	engine.RegisterMethod("imgui.internalDebugNodeFontGlyphesForSrcMask", "ImGui.InternalDebugNodeFontGlyphesForSrcMask", autogoimgui.InternalDebugNodeFontGlyphesForSrcMask, true)
	engine.RegisterMethod("imgui.internalDebugNodeInputTextState", "ImGui.InternalDebugNodeInputTextState", autogoimgui.InternalDebugNodeInputTextState, true)
	engine.RegisterMethod("imgui.internalDebugNodeMultiSelectState", "ImGui.InternalDebugNodeMultiSelectState", autogoimgui.InternalDebugNodeMultiSelectState, true)
	engine.RegisterMethod("imgui.internalDebugNodePlatformMonitor", "ImGui.InternalDebugNodePlatformMonitor", autogoimgui.InternalDebugNodePlatformMonitor, true)
	engine.RegisterMethod("imgui.internalDebugNodeStorage", "ImGui.InternalDebugNodeStorage", autogoimgui.InternalDebugNodeStorage, true)
	engine.RegisterMethod("imgui.internalDebugNodeTabBar", "ImGui.InternalDebugNodeTabBar", autogoimgui.InternalDebugNodeTabBar, true)
	engine.RegisterMethod("imgui.internalDebugNodeTable", "ImGui.InternalDebugNodeTable", autogoimgui.InternalDebugNodeTable, true)
	engine.RegisterMethod("imgui.internalDebugNodeTableSettings", "ImGui.InternalDebugNodeTableSettings", autogoimgui.InternalDebugNodeTableSettings, true)
	engine.RegisterMethod("imgui.internalDebugNodeTextureV", "ImGui.InternalDebugNodeTextureV", autogoimgui.InternalDebugNodeTextureV, true)
	engine.RegisterMethod("imgui.internalDebugNodeTypingSelectState", "ImGui.InternalDebugNodeTypingSelectState", autogoimgui.InternalDebugNodeTypingSelectState, true)
	engine.RegisterMethod("imgui.internalDebugNodeViewport", "ImGui.InternalDebugNodeViewport", autogoimgui.InternalDebugNodeViewport, true)
	engine.RegisterMethod("imgui.internalDebugNodeWindow", "ImGui.InternalDebugNodeWindow", autogoimgui.InternalDebugNodeWindow, true)
	engine.RegisterMethod("imgui.internalDebugNodeWindowSettings", "ImGui.InternalDebugNodeWindowSettings", autogoimgui.InternalDebugNodeWindowSettings, true)
	engine.RegisterMethod("imgui.internalDebugRenderKeyboardPreview", "ImGui.InternalDebugRenderKeyboardPreview", autogoimgui.InternalDebugRenderKeyboardPreview, true)
	engine.RegisterMethod("imgui.internalDebugRenderViewportThumbnail", "ImGui.InternalDebugRenderViewportThumbnail", autogoimgui.InternalDebugRenderViewportThumbnail, true)
	engine.RegisterMethod("imgui.debugStartItemPicker", "ImGui.DebugStartItemPicker", autogoimgui.DebugStartItemPicker, true)
	engine.RegisterMethod("imgui.debugTextEncoding", "ImGui.DebugTextEncoding", autogoimgui.DebugTextEncoding, true)
	engine.RegisterMethod("imgui.internalDebugTextUnformattedWithLocateItem", "ImGui.InternalDebugTextUnformattedWithLocateItem", autogoimgui.InternalDebugTextUnformattedWithLocateItem, true)
	engine.RegisterMethod("imgui.destroyContextV", "ImGui.DestroyContextV", autogoimgui.DestroyContextV, true)
	engine.RegisterMethod("imgui.internalDestroyPlatformWindow", "ImGui.InternalDestroyPlatformWindow", autogoimgui.InternalDestroyPlatformWindow, true)
	engine.RegisterMethod("imgui.destroyPlatformWindows", "ImGui.DestroyPlatformWindows", autogoimgui.DestroyPlatformWindows, true)
	engine.RegisterMethod("imgui.internalDockBuilderAddNodeV", "ImGui.InternalDockBuilderAddNodeV", autogoimgui.InternalDockBuilderAddNodeV, true)
	engine.RegisterMethod("imgui.internalDockBuilderCopyWindowSettings", "ImGui.InternalDockBuilderCopyWindowSettings", autogoimgui.InternalDockBuilderCopyWindowSettings, true)
	engine.RegisterMethod("imgui.internalDockBuilderDockWindow", "ImGui.InternalDockBuilderDockWindow", autogoimgui.InternalDockBuilderDockWindow, true)
	engine.RegisterMethod("imgui.internalDockBuilderFinish", "ImGui.InternalDockBuilderFinish", autogoimgui.InternalDockBuilderFinish, true)
	engine.RegisterMethod("imgui.internalDockBuilderGetCentralNode", "ImGui.InternalDockBuilderGetCentralNode", autogoimgui.InternalDockBuilderGetCentralNode, true)
	engine.RegisterMethod("imgui.internalDockBuilderGetNode", "ImGui.InternalDockBuilderGetNode", autogoimgui.InternalDockBuilderGetNode, true)
	engine.RegisterMethod("imgui.internalDockBuilderRemoveNode", "ImGui.InternalDockBuilderRemoveNode", autogoimgui.InternalDockBuilderRemoveNode, true)
	engine.RegisterMethod("imgui.internalDockBuilderRemoveNodeChildNodes", "ImGui.InternalDockBuilderRemoveNodeChildNodes", autogoimgui.InternalDockBuilderRemoveNodeChildNodes, true)
	engine.RegisterMethod("imgui.internalDockBuilderRemoveNodeDockedWindowsV", "ImGui.InternalDockBuilderRemoveNodeDockedWindowsV", autogoimgui.InternalDockBuilderRemoveNodeDockedWindowsV, true)
	engine.RegisterMethod("imgui.internalDockBuilderSetNodePos", "ImGui.InternalDockBuilderSetNodePos", autogoimgui.InternalDockBuilderSetNodePos, true)
	engine.RegisterMethod("imgui.internalDockBuilderSetNodeSize", "ImGui.InternalDockBuilderSetNodeSize", autogoimgui.InternalDockBuilderSetNodeSize, true)
	engine.RegisterMethod("imgui.internalDockBuilderSplitNode", "ImGui.InternalDockBuilderSplitNode", autogoimgui.InternalDockBuilderSplitNode, true)
	engine.RegisterMethod("imgui.internalDockContextCalcDropPosForDocking", "ImGui.InternalDockContextCalcDropPosForDocking", autogoimgui.InternalDockContextCalcDropPosForDocking, true)
	engine.RegisterMethod("imgui.internalDockContextClearNodes", "ImGui.InternalDockContextClearNodes", autogoimgui.InternalDockContextClearNodes, true)
	engine.RegisterMethod("imgui.internalDockContextEndFrame", "ImGui.InternalDockContextEndFrame", autogoimgui.InternalDockContextEndFrame, true)
	engine.RegisterMethod("imgui.internalDockContextFindNodeByID", "ImGui.InternalDockContextFindNodeByID", autogoimgui.InternalDockContextFindNodeByID, true)
	engine.RegisterMethod("imgui.internalDockContextGenNodeID", "ImGui.InternalDockContextGenNodeID", autogoimgui.InternalDockContextGenNodeID, true)
	engine.RegisterMethod("imgui.internalDockContextInitialize", "ImGui.InternalDockContextInitialize", autogoimgui.InternalDockContextInitialize, true)
	engine.RegisterMethod("imgui.internalDockContextNewFrameUpdateDocking", "ImGui.InternalDockContextNewFrameUpdateDocking", autogoimgui.InternalDockContextNewFrameUpdateDocking, true)
	engine.RegisterMethod("imgui.internalDockContextNewFrameUpdateUndocking", "ImGui.InternalDockContextNewFrameUpdateUndocking", autogoimgui.InternalDockContextNewFrameUpdateUndocking, true)
	engine.RegisterMethod("imgui.internalDockContextProcessUndockNode", "ImGui.InternalDockContextProcessUndockNode", autogoimgui.InternalDockContextProcessUndockNode, true)
	engine.RegisterMethod("imgui.internalDockContextProcessUndockWindowV", "ImGui.InternalDockContextProcessUndockWindowV", autogoimgui.InternalDockContextProcessUndockWindowV, true)
	engine.RegisterMethod("imgui.internalDockContextQueueDock", "ImGui.InternalDockContextQueueDock", autogoimgui.InternalDockContextQueueDock, true)
	engine.RegisterMethod("imgui.internalDockContextQueueUndockNode", "ImGui.InternalDockContextQueueUndockNode", autogoimgui.InternalDockContextQueueUndockNode, true)
	engine.RegisterMethod("imgui.internalDockContextQueueUndockWindow", "ImGui.InternalDockContextQueueUndockWindow", autogoimgui.InternalDockContextQueueUndockWindow, true)
	engine.RegisterMethod("imgui.internalDockContextRebuildNodes", "ImGui.InternalDockContextRebuildNodes", autogoimgui.InternalDockContextRebuildNodes, true)
	engine.RegisterMethod("imgui.internalDockContextShutdown", "ImGui.InternalDockContextShutdown", autogoimgui.InternalDockContextShutdown, true)
	engine.RegisterMethod("imgui.internalDockNodeBeginAmendTabBar", "ImGui.InternalDockNodeBeginAmendTabBar", autogoimgui.InternalDockNodeBeginAmendTabBar, true)
	engine.RegisterMethod("imgui.internalDockNodeEndAmendTabBar", "ImGui.InternalDockNodeEndAmendTabBar", autogoimgui.InternalDockNodeEndAmendTabBar, true)
	engine.RegisterMethod("imgui.internalDockNodeGetDepth", "ImGui.InternalDockNodeGetDepth", autogoimgui.InternalDockNodeGetDepth, true)
	engine.RegisterMethod("imgui.internalDockNodeGetRootNode", "ImGui.InternalDockNodeGetRootNode", autogoimgui.InternalDockNodeGetRootNode, true)
	engine.RegisterMethod("imgui.internalDockNodeGetWindowMenuButtonId", "ImGui.InternalDockNodeGetWindowMenuButtonId", autogoimgui.InternalDockNodeGetWindowMenuButtonId, true)
	engine.RegisterMethod("imgui.internalDockNodeIsInHierarchyOf", "ImGui.InternalDockNodeIsInHierarchyOf", autogoimgui.InternalDockNodeIsInHierarchyOf, true)
	engine.RegisterMethod("imgui.internalDockNodeWindowMenuHandlerDefault", "ImGui.InternalDockNodeWindowMenuHandlerDefault", autogoimgui.InternalDockNodeWindowMenuHandlerDefault, true)
	engine.RegisterMethod("imgui.dockSpaceV", "ImGui.DockSpaceV", autogoimgui.DockSpaceV, true)
	engine.RegisterMethod("imgui.dockSpaceOverViewportV", "ImGui.DockSpaceOverViewportV", autogoimgui.DockSpaceOverViewportV, true)
	engine.RegisterMethod("imgui.internalDragBehavior", "ImGui.InternalDragBehavior", autogoimgui.InternalDragBehavior, true)
	engine.RegisterMethod("imgui.dragFloatV", "ImGui.DragFloatV", autogoimgui.DragFloatV, true)
	engine.RegisterMethod("imgui.dragFloat2V", "ImGui.DragFloat2V", autogoimgui.DragFloat2V, true)
	engine.RegisterMethod("imgui.dragFloat3V", "ImGui.DragFloat3V", autogoimgui.DragFloat3V, true)
	engine.RegisterMethod("imgui.dragFloat4V", "ImGui.DragFloat4V", autogoimgui.DragFloat4V, true)
	engine.RegisterMethod("imgui.dragFloatRange2V", "ImGui.DragFloatRange2V", autogoimgui.DragFloatRange2V, true)
	engine.RegisterMethod("imgui.dragIntV", "ImGui.DragIntV", autogoimgui.DragIntV, true)
	engine.RegisterMethod("imgui.dragInt2V", "ImGui.DragInt2V", autogoimgui.DragInt2V, true)
	engine.RegisterMethod("imgui.dragInt3V", "ImGui.DragInt3V", autogoimgui.DragInt3V, true)
	engine.RegisterMethod("imgui.dragInt4V", "ImGui.DragInt4V", autogoimgui.DragInt4V, true)
	engine.RegisterMethod("imgui.dragIntRange2V", "ImGui.DragIntRange2V", autogoimgui.DragIntRange2V, true)
	engine.RegisterMethod("imgui.dragScalarV", "ImGui.DragScalarV", autogoimgui.DragScalarV, true)
	engine.RegisterMethod("imgui.dragScalarNV", "ImGui.DragScalarNV", autogoimgui.DragScalarNV, true)
	engine.RegisterMethod("imgui.dummy", "ImGui.Dummy", autogoimgui.Dummy, true)
	engine.RegisterMethod("imgui.end", "ImGui.End", autogoimgui.End, true)
	engine.RegisterMethod("imgui.internalEndBoxSelect", "ImGui.InternalEndBoxSelect", autogoimgui.InternalEndBoxSelect, true)
	engine.RegisterMethod("imgui.endChild", "ImGui.EndChild", autogoimgui.EndChild, true)
	engine.RegisterMethod("imgui.internalEndColumns", "ImGui.InternalEndColumns", autogoimgui.InternalEndColumns, true)
	engine.RegisterMethod("imgui.endCombo", "ImGui.EndCombo", autogoimgui.EndCombo, true)
	engine.RegisterMethod("imgui.internalEndComboPreview", "ImGui.InternalEndComboPreview", autogoimgui.InternalEndComboPreview, true)
	engine.RegisterMethod("imgui.endDisabled", "ImGui.EndDisabled", autogoimgui.EndDisabled, true)
	engine.RegisterMethod("imgui.internalEndDisabledOverrideReenable", "ImGui.InternalEndDisabledOverrideReenable", autogoimgui.InternalEndDisabledOverrideReenable, true)
	engine.RegisterMethod("imgui.endDragDropSource", "ImGui.EndDragDropSource", autogoimgui.EndDragDropSource, true)
	engine.RegisterMethod("imgui.endDragDropTarget", "ImGui.EndDragDropTarget", autogoimgui.EndDragDropTarget, true)
	engine.RegisterMethod("imgui.internalEndErrorTooltip", "ImGui.InternalEndErrorTooltip", autogoimgui.InternalEndErrorTooltip, true)
	engine.RegisterMethod("imgui.endFrame", "ImGui.EndFrame", autogoimgui.EndFrame, true)
	engine.RegisterMethod("imgui.endGroup", "ImGui.EndGroup", autogoimgui.EndGroup, true)
	engine.RegisterMethod("imgui.endListBox", "ImGui.EndListBox", autogoimgui.EndListBox, true)
	engine.RegisterMethod("imgui.endMainMenuBar", "ImGui.EndMainMenuBar", autogoimgui.EndMainMenuBar, true)
	engine.RegisterMethod("imgui.endMenu", "ImGui.EndMenu", autogoimgui.EndMenu, true)
	engine.RegisterMethod("imgui.endMenuBar", "ImGui.EndMenuBar", autogoimgui.EndMenuBar, true)
	engine.RegisterMethod("imgui.endMultiSelect", "ImGui.EndMultiSelect", autogoimgui.EndMultiSelect, true)
	engine.RegisterMethod("imgui.endPopup", "ImGui.EndPopup", autogoimgui.EndPopup, true)
	engine.RegisterMethod("imgui.endTabBar", "ImGui.EndTabBar", autogoimgui.EndTabBar, true)
	engine.RegisterMethod("imgui.endTabItem", "ImGui.EndTabItem", autogoimgui.EndTabItem, true)
	engine.RegisterMethod("imgui.endTable", "ImGui.EndTable", autogoimgui.EndTable, true)
	engine.RegisterMethod("imgui.endTooltip", "ImGui.EndTooltip", autogoimgui.EndTooltip, true)
	engine.RegisterMethod("imgui.internalErrorCheckEndFrameFinalizeErrorTooltip", "ImGui.InternalErrorCheckEndFrameFinalizeErrorTooltip", autogoimgui.InternalErrorCheckEndFrameFinalizeErrorTooltip, true)
	engine.RegisterMethod("imgui.internalErrorCheckUsingSetCursorPosToExtendParentBoundaries", "ImGui.InternalErrorCheckUsingSetCursorPosToExtendParentBoundaries", autogoimgui.InternalErrorCheckUsingSetCursorPosToExtendParentBoundaries, true)
	engine.RegisterMethod("imgui.internalErrorLog", "ImGui.InternalErrorLog", autogoimgui.InternalErrorLog, true)
	engine.RegisterMethod("imgui.internalErrorRecoveryStoreState", "ImGui.InternalErrorRecoveryStoreState", autogoimgui.InternalErrorRecoveryStoreState, true)
	engine.RegisterMethod("imgui.internalErrorRecoveryTryToRecoverState", "ImGui.InternalErrorRecoveryTryToRecoverState", autogoimgui.InternalErrorRecoveryTryToRecoverState, true)
	engine.RegisterMethod("imgui.internalErrorRecoveryTryToRecoverWindowState", "ImGui.InternalErrorRecoveryTryToRecoverWindowState", autogoimgui.InternalErrorRecoveryTryToRecoverWindowState, true)
	engine.RegisterMethod("imgui.internalFindBestWindowPosForPopup", "ImGui.InternalFindBestWindowPosForPopup", autogoimgui.InternalFindBestWindowPosForPopup, true)
	engine.RegisterMethod("imgui.internalFindBestWindowPosForPopupEx", "ImGui.InternalFindBestWindowPosForPopupEx", autogoimgui.InternalFindBestWindowPosForPopupEx, true)
	engine.RegisterMethod("imgui.internalFindBlockingModal", "ImGui.InternalFindBlockingModal", autogoimgui.InternalFindBlockingModal, true)
	engine.RegisterMethod("imgui.internalFindBottomMostVisibleWindowWithinBeginStack", "ImGui.InternalFindBottomMostVisibleWindowWithinBeginStack", autogoimgui.InternalFindBottomMostVisibleWindowWithinBeginStack, true)
	engine.RegisterMethod("imgui.internalFindHoveredViewportFromPlatformWindowStack", "ImGui.InternalFindHoveredViewportFromPlatformWindowStack", autogoimgui.InternalFindHoveredViewportFromPlatformWindowStack, true)
	engine.RegisterMethod("imgui.internalFindOrCreateColumns", "ImGui.InternalFindOrCreateColumns", autogoimgui.InternalFindOrCreateColumns, true)
	engine.RegisterMethod("imgui.internalFindRenderedTextEndV", "ImGui.InternalFindRenderedTextEndV", autogoimgui.InternalFindRenderedTextEndV, true)
	engine.RegisterMethod("imgui.internalFindSettingsHandler", "ImGui.InternalFindSettingsHandler", autogoimgui.InternalFindSettingsHandler, true)
	engine.RegisterMethod("imgui.findViewportByID", "ImGui.FindViewportByID", autogoimgui.FindViewportByID, true)
	engine.RegisterMethod("imgui.findViewportByPlatformHandle", "ImGui.FindViewportByPlatformHandle", autogoimgui.FindViewportByPlatformHandle, true)
	engine.RegisterMethod("imgui.internalFindWindowByID", "ImGui.InternalFindWindowByID", autogoimgui.InternalFindWindowByID, true)
	engine.RegisterMethod("imgui.internalFindWindowByName", "ImGui.InternalFindWindowByName", autogoimgui.InternalFindWindowByName, true)
	engine.RegisterMethod("imgui.internalFindWindowDisplayIndex", "ImGui.InternalFindWindowDisplayIndex", autogoimgui.InternalFindWindowDisplayIndex, true)
	engine.RegisterMethod("imgui.internalFindWindowSettingsByID", "ImGui.InternalFindWindowSettingsByID", autogoimgui.InternalFindWindowSettingsByID, true)
	engine.RegisterMethod("imgui.internalFindWindowSettingsByWindow", "ImGui.InternalFindWindowSettingsByWindow", autogoimgui.InternalFindWindowSettingsByWindow, true)
	engine.RegisterMethod("imgui.internalFixupKeyChord", "ImGui.InternalFixupKeyChord", autogoimgui.InternalFixupKeyChord, true)
	engine.RegisterMethod("imgui.internalFocusItem", "ImGui.InternalFocusItem", autogoimgui.InternalFocusItem, true)
	engine.RegisterMethod("imgui.internalFocusTopMostWindowUnderOne", "ImGui.InternalFocusTopMostWindowUnderOne", autogoimgui.InternalFocusTopMostWindowUnderOne, true)
	engine.RegisterMethod("imgui.internalFocusWindowV", "ImGui.InternalFocusWindowV", autogoimgui.InternalFocusWindowV, true)
	engine.RegisterMethod("imgui.internalGcAwakeTransientWindowBuffers", "ImGui.InternalGcAwakeTransientWindowBuffers", autogoimgui.InternalGcAwakeTransientWindowBuffers, true)
	engine.RegisterMethod("imgui.internalGcCompactTransientMiscBuffers", "ImGui.InternalGcCompactTransientMiscBuffers", autogoimgui.InternalGcCompactTransientMiscBuffers, true)
	engine.RegisterMethod("imgui.internalGcCompactTransientWindowBuffers", "ImGui.InternalGcCompactTransientWindowBuffers", autogoimgui.InternalGcCompactTransientWindowBuffers, true)
	engine.RegisterMethod("imgui.internalActiveID", "ImGui.InternalActiveID", autogoimgui.InternalActiveID, true)
	engine.RegisterMethod("imgui.backgroundDrawListV", "ImGui.BackgroundDrawListV", autogoimgui.BackgroundDrawListV, true)
	engine.RegisterMethod("imgui.internalBoxSelectState", "ImGui.InternalBoxSelectState", autogoimgui.InternalBoxSelectState, true)
	engine.RegisterMethod("imgui.clipboardText", "ImGui.ClipboardText", autogoimgui.ClipboardText, true)
	engine.RegisterMethod("imgui.colorU32ColV", "ImGui.ColorU32ColV", autogoimgui.ColorU32ColV, true)
	engine.RegisterMethod("imgui.colorU32U32V", "ImGui.ColorU32U32V", autogoimgui.ColorU32U32V, true)
	engine.RegisterMethod("imgui.colorU32Vec4", "ImGui.ColorU32Vec4", autogoimgui.ColorU32Vec4, true)
	engine.RegisterMethod("imgui.columnIndex", "ImGui.ColumnIndex", autogoimgui.ColumnIndex, true)
	engine.RegisterMethod("imgui.internalColumnNormFromOffset", "ImGui.InternalColumnNormFromOffset", autogoimgui.InternalColumnNormFromOffset, true)
	engine.RegisterMethod("imgui.columnOffsetV", "ImGui.ColumnOffsetV", autogoimgui.ColumnOffsetV, true)
	engine.RegisterMethod("imgui.internalColumnOffsetFromNorm", "ImGui.InternalColumnOffsetFromNorm", autogoimgui.InternalColumnOffsetFromNorm, true)
	engine.RegisterMethod("imgui.columnWidthV", "ImGui.ColumnWidthV", autogoimgui.ColumnWidthV, true)
	engine.RegisterMethod("imgui.columnsCount", "ImGui.ColumnsCount", autogoimgui.ColumnsCount, true)
	engine.RegisterMethod("imgui.internalColumnsID", "ImGui.InternalColumnsID", autogoimgui.InternalColumnsID, true)
	engine.RegisterMethod("imgui.contentRegionAvail", "ImGui.ContentRegionAvail", autogoimgui.ContentRegionAvail, true)
	engine.RegisterMethod("imgui.currentContext", "ImGui.CurrentContext", autogoimgui.CurrentContext, true)
	engine.RegisterMethod("imgui.internalCurrentFocusScope", "ImGui.InternalCurrentFocusScope", autogoimgui.InternalCurrentFocusScope, true)
	engine.RegisterMethod("imgui.internalCurrentTabBar", "ImGui.InternalCurrentTabBar", autogoimgui.InternalCurrentTabBar, true)
	engine.RegisterMethod("imgui.internalCurrentTable", "ImGui.InternalCurrentTable", autogoimgui.InternalCurrentTable, true)
	engine.RegisterMethod("imgui.internalCurrentWindow", "ImGui.InternalCurrentWindow", autogoimgui.InternalCurrentWindow, true)
	engine.RegisterMethod("imgui.internalCurrentWindowRead", "ImGui.InternalCurrentWindowRead", autogoimgui.InternalCurrentWindowRead, true)
	engine.RegisterMethod("imgui.cursorPos", "ImGui.CursorPos", autogoimgui.CursorPos, true)
	engine.RegisterMethod("imgui.cursorPosX", "ImGui.CursorPosX", autogoimgui.CursorPosX, true)
	engine.RegisterMethod("imgui.cursorPosY", "ImGui.CursorPosY", autogoimgui.CursorPosY, true)
	engine.RegisterMethod("imgui.cursorScreenPos", "ImGui.CursorScreenPos", autogoimgui.CursorScreenPos, true)
	engine.RegisterMethod("imgui.cursorStartPos", "ImGui.CursorStartPos", autogoimgui.CursorStartPos, true)
	engine.RegisterMethod("imgui.internalDefaultFont", "ImGui.InternalDefaultFont", autogoimgui.InternalDefaultFont, true)
	engine.RegisterMethod("imgui.dragDropPayload", "ImGui.DragDropPayload", autogoimgui.DragDropPayload, true)
	engine.RegisterMethod("imgui.currentDrawData", "ImGui.CurrentDrawData", autogoimgui.CurrentDrawData, true)
	engine.RegisterMethod("imgui.currentDrawListSharedData", "ImGui.CurrentDrawListSharedData", autogoimgui.CurrentDrawListSharedData, true)
	engine.RegisterMethod("imgui.internalFocusID", "ImGui.InternalFocusID", autogoimgui.InternalFocusID, true)
	engine.RegisterMethod("imgui.currentFont", "ImGui.CurrentFont", autogoimgui.CurrentFont, true)
	engine.RegisterMethod("imgui.getFontBaked", "ImGui.GetFontBaked", autogoimgui.GetFontBaked, true)
	engine.RegisterMethod("imgui.internalFontRasterizerDensity", "ImGui.InternalFontRasterizerDensity", autogoimgui.InternalFontRasterizerDensity, true)
	engine.RegisterMethod("imgui.fontSize", "ImGui.FontSize", autogoimgui.FontSize, true)
	engine.RegisterMethod("imgui.fontTexUvWhitePixel", "ImGui.FontTexUvWhitePixel", autogoimgui.FontTexUvWhitePixel, true)
	engine.RegisterMethod("imgui.foregroundDrawListViewportPtrV", "ImGui.ForegroundDrawListViewportPtrV", autogoimgui.ForegroundDrawListViewportPtrV, true)
	engine.RegisterMethod("imgui.internalForegroundDrawListWindowPtr", "ImGui.InternalForegroundDrawListWindowPtr", autogoimgui.InternalForegroundDrawListWindowPtr, true)
	engine.RegisterMethod("imgui.frameCount", "ImGui.FrameCount", autogoimgui.FrameCount, true)
	engine.RegisterMethod("imgui.frameHeight", "ImGui.FrameHeight", autogoimgui.FrameHeight, true)
	engine.RegisterMethod("imgui.frameHeightWithSpacing", "ImGui.FrameHeightWithSpacing", autogoimgui.FrameHeightWithSpacing, true)
	engine.RegisterMethod("imgui.internalHoveredID", "ImGui.InternalHoveredID", autogoimgui.InternalHoveredID, true)
	engine.RegisterMethod("imgui.internalIDWithSeedInt", "ImGui.InternalIDWithSeedInt", autogoimgui.InternalIDWithSeedInt, true)
	engine.RegisterMethod("imgui.internalIDWithSeedStr", "ImGui.InternalIDWithSeedStr", autogoimgui.InternalIDWithSeedStr, true)
	engine.RegisterMethod("imgui.iDInt", "ImGui.IDInt", autogoimgui.IDInt, true)
	engine.RegisterMethod("imgui.iDPtr", "ImGui.IDPtr", autogoimgui.IDPtr, true)
	engine.RegisterMethod("imgui.iDStr", "ImGui.IDStr", autogoimgui.IDStr, true)
	engine.RegisterMethod("imgui.iDStrStr", "ImGui.IDStrStr", autogoimgui.IDStrStr, true)
	engine.RegisterMethod("imgui.internalIOContextPtr", "ImGui.InternalIOContextPtr", autogoimgui.InternalIOContextPtr, true)
	engine.RegisterMethod("imgui.currentIO", "ImGui.CurrentIO", autogoimgui.CurrentIO, true)
	engine.RegisterMethod("imgui.internalInputTextState", "ImGui.InternalInputTextState", autogoimgui.InternalInputTextState, true)
	engine.RegisterMethod("imgui.internalItemFlags", "ImGui.InternalItemFlags", autogoimgui.InternalItemFlags, true)
	engine.RegisterMethod("imgui.itemID", "ImGui.ItemID", autogoimgui.ItemID, true)
	engine.RegisterMethod("imgui.itemRectMax", "ImGui.ItemRectMax", autogoimgui.ItemRectMax, true)
	engine.RegisterMethod("imgui.itemRectMin", "ImGui.ItemRectMin", autogoimgui.ItemRectMin, true)
	engine.RegisterMethod("imgui.itemRectSize", "ImGui.ItemRectSize", autogoimgui.ItemRectSize, true)
	engine.RegisterMethod("imgui.internalItemStatusFlags", "ImGui.InternalItemStatusFlags", autogoimgui.InternalItemStatusFlags, true)
	engine.RegisterMethod("imgui.internalKeyChordName", "ImGui.InternalKeyChordName", autogoimgui.InternalKeyChordName, true)
	engine.RegisterMethod("imgui.internalKeyDataContextPtr", "ImGui.InternalKeyDataContextPtr", autogoimgui.InternalKeyDataContextPtr, true)
	engine.RegisterMethod("imgui.internalKeyDataKey", "ImGui.InternalKeyDataKey", autogoimgui.InternalKeyDataKey, true)
	engine.RegisterMethod("imgui.internalKeyMagnitude2d", "ImGui.InternalKeyMagnitude2d", autogoimgui.InternalKeyMagnitude2d, true)
	engine.RegisterMethod("imgui.keyName", "ImGui.KeyName", autogoimgui.KeyName, true)
	engine.RegisterMethod("imgui.internalKeyOwner", "ImGui.InternalKeyOwner", autogoimgui.InternalKeyOwner, true)
	engine.RegisterMethod("imgui.internalKeyOwnerData", "ImGui.InternalKeyOwnerData", autogoimgui.InternalKeyOwnerData, true)
	engine.RegisterMethod("imgui.keyPressedAmount", "ImGui.KeyPressedAmount", autogoimgui.KeyPressedAmount, true)
	engine.RegisterMethod("imgui.mainViewport", "ImGui.MainViewport", autogoimgui.MainViewport, true)
	engine.RegisterMethod("imgui.mouseClickedCount", "ImGui.MouseClickedCount", autogoimgui.MouseClickedCount, true)
	engine.RegisterMethod("imgui.currentMouseCursor", "ImGui.CurrentMouseCursor", autogoimgui.CurrentMouseCursor, true)
	engine.RegisterMethod("imgui.mouseDragDeltaV", "ImGui.MouseDragDeltaV", autogoimgui.MouseDragDeltaV, true)
	engine.RegisterMethod("imgui.mousePos", "ImGui.MousePos", autogoimgui.MousePos, true)
	engine.RegisterMethod("imgui.mousePosOnOpeningCurrentPopup", "ImGui.MousePosOnOpeningCurrentPopup", autogoimgui.MousePosOnOpeningCurrentPopup, true)
	engine.RegisterMethod("imgui.internalMultiSelectState", "ImGui.InternalMultiSelectState", autogoimgui.InternalMultiSelectState, true)
	engine.RegisterMethod("imgui.internalNavTweakPressedAmount", "ImGui.InternalNavTweakPressedAmount", autogoimgui.InternalNavTweakPressedAmount, true)
	engine.RegisterMethod("imgui.internalPlatformIOContextPtr", "ImGui.InternalPlatformIOContextPtr", autogoimgui.InternalPlatformIOContextPtr, true)
	engine.RegisterMethod("imgui.currentPlatformIO", "ImGui.CurrentPlatformIO", autogoimgui.CurrentPlatformIO, true)
	engine.RegisterMethod("imgui.internalPopupAllowedExtentRect", "ImGui.InternalPopupAllowedExtentRect", autogoimgui.InternalPopupAllowedExtentRect, true)
	engine.RegisterMethod("imgui.internalRoundedFontSize", "ImGui.InternalRoundedFontSize", autogoimgui.InternalRoundedFontSize, true)
	engine.RegisterMethod("imgui.scrollMaxX", "ImGui.ScrollMaxX", autogoimgui.ScrollMaxX, true)
	engine.RegisterMethod("imgui.scrollMaxY", "ImGui.ScrollMaxY", autogoimgui.ScrollMaxY, true)
	engine.RegisterMethod("imgui.scrollX", "ImGui.ScrollX", autogoimgui.ScrollX, true)
	engine.RegisterMethod("imgui.scrollY", "ImGui.ScrollY", autogoimgui.ScrollY, true)
	engine.RegisterMethod("imgui.internalShortcutRoutingData", "ImGui.InternalShortcutRoutingData", autogoimgui.InternalShortcutRoutingData, true)
	engine.RegisterMethod("imgui.stateStorage", "ImGui.StateStorage", autogoimgui.StateStorage, true)
	engine.RegisterMethod("imgui.currentStyle", "ImGui.CurrentStyle", autogoimgui.CurrentStyle, true)
	engine.RegisterMethod("imgui.styleColorName", "ImGui.StyleColorName", autogoimgui.StyleColorName, true)
	engine.RegisterMethod("imgui.styleColorVec4", "ImGui.StyleColorVec4", autogoimgui.StyleColorVec4, true)
	engine.RegisterMethod("imgui.internalStyleVarInfo", "ImGui.InternalStyleVarInfo", autogoimgui.InternalStyleVarInfo, true)
	engine.RegisterMethod("imgui.textLineHeight", "ImGui.TextLineHeight", autogoimgui.TextLineHeight, true)
	engine.RegisterMethod("imgui.textLineHeightWithSpacing", "ImGui.TextLineHeightWithSpacing", autogoimgui.TextLineHeightWithSpacing, true)
	engine.RegisterMethod("imgui.time", "ImGui.Time", autogoimgui.Time, true)
	engine.RegisterMethod("imgui.internalTopMostAndVisiblePopupModal", "ImGui.InternalTopMostAndVisiblePopupModal", autogoimgui.InternalTopMostAndVisiblePopupModal, true)
	engine.RegisterMethod("imgui.internalTopMostPopupModal", "ImGui.InternalTopMostPopupModal", autogoimgui.InternalTopMostPopupModal, true)
	engine.RegisterMethod("imgui.treeNodeToLabelSpacing", "ImGui.TreeNodeToLabelSpacing", autogoimgui.TreeNodeToLabelSpacing, true)
	engine.RegisterMethod("imgui.internalTypematicRepeatRate", "ImGui.InternalTypematicRepeatRate", autogoimgui.InternalTypematicRepeatRate, true)
	engine.RegisterMethod("imgui.internalTypingSelectRequestV", "ImGui.InternalTypingSelectRequestV", autogoimgui.InternalTypingSelectRequestV, true)
	engine.RegisterMethod("imgui.version", "ImGui.Version", autogoimgui.Version, true)
	engine.RegisterMethod("imgui.internalViewportPlatformMonitor", "ImGui.InternalViewportPlatformMonitor", autogoimgui.InternalViewportPlatformMonitor, true)
	engine.RegisterMethod("imgui.internalWindowAlwaysWantOwnTabBar", "ImGui.InternalWindowAlwaysWantOwnTabBar", autogoimgui.InternalWindowAlwaysWantOwnTabBar, true)
	engine.RegisterMethod("imgui.windowDockID", "ImGui.WindowDockID", autogoimgui.WindowDockID, true)
	engine.RegisterMethod("imgui.internalWindowDockNode", "ImGui.InternalWindowDockNode", autogoimgui.InternalWindowDockNode, true)
	engine.RegisterMethod("imgui.windowDpiScale", "ImGui.WindowDpiScale", autogoimgui.WindowDpiScale, true)
	engine.RegisterMethod("imgui.windowDrawList", "ImGui.WindowDrawList", autogoimgui.WindowDrawList, true)
	engine.RegisterMethod("imgui.windowHeight", "ImGui.WindowHeight", autogoimgui.WindowHeight, true)
	engine.RegisterMethod("imgui.windowPos", "ImGui.WindowPos", autogoimgui.WindowPos, true)
	engine.RegisterMethod("imgui.internalWindowResizeBorderID", "ImGui.InternalWindowResizeBorderID", autogoimgui.InternalWindowResizeBorderID, true)
	engine.RegisterMethod("imgui.internalWindowResizeCornerID", "ImGui.InternalWindowResizeCornerID", autogoimgui.InternalWindowResizeCornerID, true)
	engine.RegisterMethod("imgui.internalWindowScrollbarID", "ImGui.InternalWindowScrollbarID", autogoimgui.InternalWindowScrollbarID, true)
	engine.RegisterMethod("imgui.internalWindowScrollbarRect", "ImGui.InternalWindowScrollbarRect", autogoimgui.InternalWindowScrollbarRect, true)
	engine.RegisterMethod("imgui.windowSize", "ImGui.WindowSize", autogoimgui.WindowSize, true)
	engine.RegisterMethod("imgui.windowViewport", "ImGui.WindowViewport", autogoimgui.WindowViewport, true)
	engine.RegisterMethod("imgui.windowWidth", "ImGui.WindowWidth", autogoimgui.WindowWidth, true)
	engine.RegisterMethod("imgui.internalImAbsFloat", "ImGui.InternalImAbsFloat", autogoimgui.InternalImAbsFloat, true)
	engine.RegisterMethod("imgui.internalImAbsInt", "ImGui.InternalImAbsInt", autogoimgui.InternalImAbsInt, true)
	engine.RegisterMethod("imgui.internalImAbsDouble", "ImGui.InternalImAbsDouble", autogoimgui.InternalImAbsDouble, true)
	engine.RegisterMethod("imgui.internalImAlphaBlendColors", "ImGui.InternalImAlphaBlendColors", autogoimgui.InternalImAlphaBlendColors, true)
	engine.RegisterMethod("imgui.internalImBezierCubicCalc", "ImGui.InternalImBezierCubicCalc", autogoimgui.InternalImBezierCubicCalc, true)
	engine.RegisterMethod("imgui.internalImBezierCubicClosestPoint", "ImGui.InternalImBezierCubicClosestPoint", autogoimgui.InternalImBezierCubicClosestPoint, true)
	engine.RegisterMethod("imgui.internalImBezierCubicClosestPointCasteljau", "ImGui.InternalImBezierCubicClosestPointCasteljau", autogoimgui.InternalImBezierCubicClosestPointCasteljau, true)
	engine.RegisterMethod("imgui.internalImBezierQuadraticCalc", "ImGui.InternalImBezierQuadraticCalc", autogoimgui.InternalImBezierQuadraticCalc, true)
	engine.RegisterMethod("imgui.internalImBitArrayClearAllBits", "ImGui.InternalImBitArrayClearAllBits", autogoimgui.InternalImBitArrayClearAllBits, true)
	engine.RegisterMethod("imgui.internalImBitArrayClearBit", "ImGui.InternalImBitArrayClearBit", autogoimgui.InternalImBitArrayClearBit, true)
	engine.RegisterMethod("imgui.internalImBitArrayGetStorageSizeInBytes", "ImGui.InternalImBitArrayGetStorageSizeInBytes", autogoimgui.InternalImBitArrayGetStorageSizeInBytes, true)
	engine.RegisterMethod("imgui.internalImBitArraySetBit", "ImGui.InternalImBitArraySetBit", autogoimgui.InternalImBitArraySetBit, true)
	engine.RegisterMethod("imgui.internalImBitArraySetBitRange", "ImGui.InternalImBitArraySetBitRange", autogoimgui.InternalImBitArraySetBitRange, true)
	engine.RegisterMethod("imgui.internalImBitArrayTestBit", "ImGui.InternalImBitArrayTestBit", autogoimgui.InternalImBitArrayTestBit, true)
	engine.RegisterMethod("imgui.internalImCharIsBlankA", "ImGui.InternalImCharIsBlankA", autogoimgui.InternalImCharIsBlankA, true)
	engine.RegisterMethod("imgui.internalImCharIsBlankW", "ImGui.InternalImCharIsBlankW", autogoimgui.InternalImCharIsBlankW, true)
	engine.RegisterMethod("imgui.internalImCharIsXdigitA", "ImGui.InternalImCharIsXdigitA", autogoimgui.InternalImCharIsXdigitA, true)
	engine.RegisterMethod("imgui.internalImClamp", "ImGui.InternalImClamp", autogoimgui.InternalImClamp, true)
	engine.RegisterMethod("imgui.internalImCountSetBits", "ImGui.InternalImCountSetBits", autogoimgui.InternalImCountSetBits, true)
	engine.RegisterMethod("imgui.internalImDot", "ImGui.InternalImDot", autogoimgui.InternalImDot, true)
	engine.RegisterMethod("imgui.internalImExponentialMovingAverage", "ImGui.InternalImExponentialMovingAverage", autogoimgui.InternalImExponentialMovingAverage, true)
	engine.RegisterMethod("imgui.internalImFileLoadToMemoryV", "ImGui.InternalImFileLoadToMemoryV", autogoimgui.InternalImFileLoadToMemoryV, true)
	engine.RegisterMethod("imgui.internalImFloorFloat", "ImGui.InternalImFloorFloat", autogoimgui.InternalImFloorFloat, true)
	engine.RegisterMethod("imgui.internalImFloorVec2", "ImGui.InternalImFloorVec2", autogoimgui.InternalImFloorVec2, true)
	engine.RegisterMethod("imgui.internalImFontAtlasAddDrawListSharedData", "ImGui.InternalImFontAtlasAddDrawListSharedData", autogoimgui.InternalImFontAtlasAddDrawListSharedData, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedAdd", "ImGui.InternalImFontAtlasBakedAdd", autogoimgui.InternalImFontAtlasBakedAdd, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedAddFontGlyph", "ImGui.InternalImFontAtlasBakedAddFontGlyph", autogoimgui.InternalImFontAtlasBakedAddFontGlyph, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedAddFontGlyphAdvancedX", "ImGui.InternalImFontAtlasBakedAddFontGlyphAdvancedX", autogoimgui.InternalImFontAtlasBakedAddFontGlyphAdvancedX, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedDiscard", "ImGui.InternalImFontAtlasBakedDiscard", autogoimgui.InternalImFontAtlasBakedDiscard, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedDiscardFontGlyph", "ImGui.InternalImFontAtlasBakedDiscardFontGlyph", autogoimgui.InternalImFontAtlasBakedDiscardFontGlyph, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedGetClosestMatch", "ImGui.InternalImFontAtlasBakedGetClosestMatch", autogoimgui.InternalImFontAtlasBakedGetClosestMatch, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedGetId", "ImGui.InternalImFontAtlasBakedGetId", autogoimgui.InternalImFontAtlasBakedGetId, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedGetOrAdd", "ImGui.InternalImFontAtlasBakedGetOrAdd", autogoimgui.InternalImFontAtlasBakedGetOrAdd, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBakedSetFontGlyphBitmap", "ImGui.InternalImFontAtlasBakedSetFontGlyphBitmap", autogoimgui.InternalImFontAtlasBakedSetFontGlyphBitmap, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildClear", "ImGui.InternalImFontAtlasBuildClear", autogoimgui.InternalImFontAtlasBuildClear, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildDestroy", "ImGui.InternalImFontAtlasBuildDestroy", autogoimgui.InternalImFontAtlasBuildDestroy, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildDiscardBakes", "ImGui.InternalImFontAtlasBuildDiscardBakes", autogoimgui.InternalImFontAtlasBuildDiscardBakes, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildGetOversampleFactors", "ImGui.InternalImFontAtlasBuildGetOversampleFactors", autogoimgui.InternalImFontAtlasBuildGetOversampleFactors, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildInit", "ImGui.InternalImFontAtlasBuildInit", autogoimgui.InternalImFontAtlasBuildInit, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildLegacyPreloadAllGlyphRanges", "ImGui.InternalImFontAtlasBuildLegacyPreloadAllGlyphRanges", autogoimgui.InternalImFontAtlasBuildLegacyPreloadAllGlyphRanges, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildMain", "ImGui.InternalImFontAtlasBuildMain", autogoimgui.InternalImFontAtlasBuildMain, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildRenderBitmapFromString", "ImGui.InternalImFontAtlasBuildRenderBitmapFromString", autogoimgui.InternalImFontAtlasBuildRenderBitmapFromString, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildSetupFontLoader", "ImGui.InternalImFontAtlasBuildSetupFontLoader", autogoimgui.InternalImFontAtlasBuildSetupFontLoader, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildSetupFontSpecialGlyphs", "ImGui.InternalImFontAtlasBuildSetupFontSpecialGlyphs", autogoimgui.InternalImFontAtlasBuildSetupFontSpecialGlyphs, true)
	engine.RegisterMethod("imgui.internalImFontAtlasBuildUpdatePointers", "ImGui.InternalImFontAtlasBuildUpdatePointers", autogoimgui.InternalImFontAtlasBuildUpdatePointers, true)
	engine.RegisterMethod("imgui.internalImFontAtlasDebugLogTextureRequests", "ImGui.InternalImFontAtlasDebugLogTextureRequests", autogoimgui.InternalImFontAtlasDebugLogTextureRequests, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontDestroyOutput", "ImGui.InternalImFontAtlasFontDestroyOutput", autogoimgui.InternalImFontAtlasFontDestroyOutput, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontDestroySourceData", "ImGui.InternalImFontAtlasFontDestroySourceData", autogoimgui.InternalImFontAtlasFontDestroySourceData, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontDiscardBakes", "ImGui.InternalImFontAtlasFontDiscardBakes", autogoimgui.InternalImFontAtlasFontDiscardBakes, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontInitOutput", "ImGui.InternalImFontAtlasFontInitOutput", autogoimgui.InternalImFontAtlasFontInitOutput, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontSourceAddToFont", "ImGui.InternalImFontAtlasFontSourceAddToFont", autogoimgui.InternalImFontAtlasFontSourceAddToFont, true)
	engine.RegisterMethod("imgui.internalImFontAtlasFontSourceInit", "ImGui.InternalImFontAtlasFontSourceInit", autogoimgui.InternalImFontAtlasFontSourceInit, true)
	engine.RegisterMethod("imgui.internalImFontAtlasGetFontLoaderForStbTruetype", "ImGui.InternalImFontAtlasGetFontLoaderForStbTruetype", autogoimgui.InternalImFontAtlasGetFontLoaderForStbTruetype, true)
	engine.RegisterMethod("imgui.internalImFontAtlasGetMouseCursorTexData", "ImGui.InternalImFontAtlasGetMouseCursorTexData", autogoimgui.InternalImFontAtlasGetMouseCursorTexData, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackAddRectV", "ImGui.InternalImFontAtlasPackAddRectV", autogoimgui.InternalImFontAtlasPackAddRectV, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackDiscardRect", "ImGui.InternalImFontAtlasPackDiscardRect", autogoimgui.InternalImFontAtlasPackDiscardRect, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackGetRect", "ImGui.InternalImFontAtlasPackGetRect", autogoimgui.InternalImFontAtlasPackGetRect, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackGetRectSafe", "ImGui.InternalImFontAtlasPackGetRectSafe", autogoimgui.InternalImFontAtlasPackGetRectSafe, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackInit", "ImGui.InternalImFontAtlasPackInit", autogoimgui.InternalImFontAtlasPackInit, true)
	engine.RegisterMethod("imgui.internalImFontAtlasRectIdGetGeneration", "ImGui.InternalImFontAtlasRectIdGetGeneration", autogoimgui.InternalImFontAtlasRectIdGetGeneration, true)
	engine.RegisterMethod("imgui.internalImFontAtlasRectIdGetIndex", "ImGui.InternalImFontAtlasRectIdGetIndex", autogoimgui.InternalImFontAtlasRectIdGetIndex, true)
	engine.RegisterMethod("imgui.internalImFontAtlasRectIdMake", "ImGui.InternalImFontAtlasRectIdMake", autogoimgui.InternalImFontAtlasRectIdMake, true)
	engine.RegisterMethod("imgui.internalImFontAtlasRemoveDrawListSharedData", "ImGui.InternalImFontAtlasRemoveDrawListSharedData", autogoimgui.InternalImFontAtlasRemoveDrawListSharedData, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureAdd", "ImGui.InternalImFontAtlasTextureAdd", autogoimgui.InternalImFontAtlasTextureAdd, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockConvert", "ImGui.InternalImFontAtlasTextureBlockConvert", autogoimgui.InternalImFontAtlasTextureBlockConvert, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockCopy", "ImGui.InternalImFontAtlasTextureBlockCopy", autogoimgui.InternalImFontAtlasTextureBlockCopy, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockFill", "ImGui.InternalImFontAtlasTextureBlockFill", autogoimgui.InternalImFontAtlasTextureBlockFill, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockPostProcess", "ImGui.InternalImFontAtlasTextureBlockPostProcess", autogoimgui.InternalImFontAtlasTextureBlockPostProcess, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockPostProcessMultiply", "ImGui.InternalImFontAtlasTextureBlockPostProcessMultiply", autogoimgui.InternalImFontAtlasTextureBlockPostProcessMultiply, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureBlockQueueUpload", "ImGui.InternalImFontAtlasTextureBlockQueueUpload", autogoimgui.InternalImFontAtlasTextureBlockQueueUpload, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureCompact", "ImGui.InternalImFontAtlasTextureCompact", autogoimgui.InternalImFontAtlasTextureCompact, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureGetSizeEstimate", "ImGui.InternalImFontAtlasTextureGetSizeEstimate", autogoimgui.InternalImFontAtlasTextureGetSizeEstimate, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureGrowV", "ImGui.InternalImFontAtlasTextureGrowV", autogoimgui.InternalImFontAtlasTextureGrowV, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureMakeSpace", "ImGui.InternalImFontAtlasTextureMakeSpace", autogoimgui.InternalImFontAtlasTextureMakeSpace, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureRepack", "ImGui.InternalImFontAtlasTextureRepack", autogoimgui.InternalImFontAtlasTextureRepack, true)
	engine.RegisterMethod("imgui.internalImFontAtlasUpdateDrawListsSharedData", "ImGui.InternalImFontAtlasUpdateDrawListsSharedData", autogoimgui.InternalImFontAtlasUpdateDrawListsSharedData, true)
	engine.RegisterMethod("imgui.internalImFontAtlasUpdateDrawListsTextures", "ImGui.InternalImFontAtlasUpdateDrawListsTextures", autogoimgui.InternalImFontAtlasUpdateDrawListsTextures, true)
	engine.RegisterMethod("imgui.internalImFontAtlasUpdateNewFrame", "ImGui.InternalImFontAtlasUpdateNewFrame", autogoimgui.InternalImFontAtlasUpdateNewFrame, true)
	engine.RegisterMethod("imgui.internalImFontCalcTextSizeEx", "ImGui.InternalImFontCalcTextSizeEx", autogoimgui.InternalImFontCalcTextSizeEx, true)
	engine.RegisterMethod("imgui.internalImFontCalcWordWrapPositionExV", "ImGui.InternalImFontCalcWordWrapPositionExV", autogoimgui.InternalImFontCalcWordWrapPositionExV, true)
	engine.RegisterMethod("imgui.internalImFormatString", "ImGui.InternalImFormatString", autogoimgui.InternalImFormatString, true)
	engine.RegisterMethod("imgui.internalImFormatStringToTempBuffer", "ImGui.InternalImFormatStringToTempBuffer", autogoimgui.InternalImFormatStringToTempBuffer, true)
	engine.RegisterMethod("imgui.internalImHashDataV", "ImGui.InternalImHashDataV", autogoimgui.InternalImHashDataV, true)
	engine.RegisterMethod("imgui.internalImHashSkipUncontributingPrefix", "ImGui.InternalImHashSkipUncontributingPrefix", autogoimgui.InternalImHashSkipUncontributingPrefix, true)
	engine.RegisterMethod("imgui.internalImHashStrV", "ImGui.InternalImHashStrV", autogoimgui.InternalImHashStrV, true)
	engine.RegisterMethod("imgui.internalImInvLength", "ImGui.InternalImInvLength", autogoimgui.InternalImInvLength, true)
	engine.RegisterMethod("imgui.internalImIsFloatAboveGuaranteedIntegerPrecision", "ImGui.InternalImIsFloatAboveGuaranteedIntegerPrecision", autogoimgui.InternalImIsFloatAboveGuaranteedIntegerPrecision, true)
	engine.RegisterMethod("imgui.internalImIsPowerOfTwoInt", "ImGui.InternalImIsPowerOfTwoInt", autogoimgui.InternalImIsPowerOfTwoInt, true)
	engine.RegisterMethod("imgui.internalImIsPowerOfTwoU64", "ImGui.InternalImIsPowerOfTwoU64", autogoimgui.InternalImIsPowerOfTwoU64, true)
	engine.RegisterMethod("imgui.internalImLengthSqrVec2", "ImGui.InternalImLengthSqrVec2", autogoimgui.InternalImLengthSqrVec2, true)
	engine.RegisterMethod("imgui.internalImLengthSqrVec4", "ImGui.InternalImLengthSqrVec4", autogoimgui.InternalImLengthSqrVec4, true)
	engine.RegisterMethod("imgui.internalImLerpVec2Float", "ImGui.InternalImLerpVec2Float", autogoimgui.InternalImLerpVec2Float, true)
	engine.RegisterMethod("imgui.internalImLerpVec2Vec2", "ImGui.InternalImLerpVec2Vec2", autogoimgui.InternalImLerpVec2Vec2, true)
	engine.RegisterMethod("imgui.internalImLerpVec4", "ImGui.InternalImLerpVec4", autogoimgui.InternalImLerpVec4, true)
	engine.RegisterMethod("imgui.internalImLineClosestPoint", "ImGui.InternalImLineClosestPoint", autogoimgui.InternalImLineClosestPoint, true)
	engine.RegisterMethod("imgui.internalImLinearRemapClamp", "ImGui.InternalImLinearRemapClamp", autogoimgui.InternalImLinearRemapClamp, true)
	engine.RegisterMethod("imgui.internalImLinearSweep", "ImGui.InternalImLinearSweep", autogoimgui.InternalImLinearSweep, true)
	engine.RegisterMethod("imgui.internalImLogFloat", "ImGui.InternalImLogFloat", autogoimgui.InternalImLogFloat, true)
	engine.RegisterMethod("imgui.internalImLogDouble", "ImGui.InternalImLogDouble", autogoimgui.InternalImLogDouble, true)
	engine.RegisterMethod("imgui.internalImLowerBound", "ImGui.InternalImLowerBound", autogoimgui.InternalImLowerBound, true)
	engine.RegisterMethod("imgui.internalImMax", "ImGui.InternalImMax", autogoimgui.InternalImMax, true)
	engine.RegisterMethod("imgui.internalImMemdup", "ImGui.InternalImMemdup", autogoimgui.InternalImMemdup, true)
	engine.RegisterMethod("imgui.internalImMin", "ImGui.InternalImMin", autogoimgui.InternalImMin, true)
	engine.RegisterMethod("imgui.internalImModPositive", "ImGui.InternalImModPositive", autogoimgui.InternalImModPositive, true)
	engine.RegisterMethod("imgui.internalImMul", "ImGui.InternalImMul", autogoimgui.InternalImMul, true)
	engine.RegisterMethod("imgui.internalImParseFormatFindEnd", "ImGui.InternalImParseFormatFindEnd", autogoimgui.InternalImParseFormatFindEnd, true)
	engine.RegisterMethod("imgui.internalImParseFormatFindStart", "ImGui.InternalImParseFormatFindStart", autogoimgui.InternalImParseFormatFindStart, true)
	engine.RegisterMethod("imgui.internalImParseFormatPrecision", "ImGui.InternalImParseFormatPrecision", autogoimgui.InternalImParseFormatPrecision, true)
	engine.RegisterMethod("imgui.internalImParseFormatSanitizeForPrinting", "ImGui.InternalImParseFormatSanitizeForPrinting", autogoimgui.InternalImParseFormatSanitizeForPrinting, true)
	engine.RegisterMethod("imgui.internalImParseFormatSanitizeForScanning", "ImGui.InternalImParseFormatSanitizeForScanning", autogoimgui.InternalImParseFormatSanitizeForScanning, true)
	engine.RegisterMethod("imgui.internalImParseFormatTrimDecorations", "ImGui.InternalImParseFormatTrimDecorations", autogoimgui.InternalImParseFormatTrimDecorations, true)
	engine.RegisterMethod("imgui.internalImPowFloat", "ImGui.InternalImPowFloat", autogoimgui.InternalImPowFloat, true)
	engine.RegisterMethod("imgui.internalImPowDouble", "ImGui.InternalImPowDouble", autogoimgui.InternalImPowDouble, true)
	engine.RegisterMethod("imgui.internalImRotate", "ImGui.InternalImRotate", autogoimgui.InternalImRotate, true)
	engine.RegisterMethod("imgui.internalImRound64", "ImGui.InternalImRound64", autogoimgui.InternalImRound64, true)
	engine.RegisterMethod("imgui.internalImRsqrtFloat", "ImGui.InternalImRsqrtFloat", autogoimgui.InternalImRsqrtFloat, true)
	engine.RegisterMethod("imgui.internalImRsqrtDouble", "ImGui.InternalImRsqrtDouble", autogoimgui.InternalImRsqrtDouble, true)
	engine.RegisterMethod("imgui.internalImSaturate", "ImGui.InternalImSaturate", autogoimgui.InternalImSaturate, true)
	engine.RegisterMethod("imgui.internalImSignFloat", "ImGui.InternalImSignFloat", autogoimgui.InternalImSignFloat, true)
	engine.RegisterMethod("imgui.internalImSignDouble", "ImGui.InternalImSignDouble", autogoimgui.InternalImSignDouble, true)
	engine.RegisterMethod("imgui.internalImStrSkipBlank", "ImGui.InternalImStrSkipBlank", autogoimgui.InternalImStrSkipBlank, true)
	engine.RegisterMethod("imgui.internalImStrTrimBlanks", "ImGui.InternalImStrTrimBlanks", autogoimgui.InternalImStrTrimBlanks, true)
	engine.RegisterMethod("imgui.internalImStrbol", "ImGui.InternalImStrbol", autogoimgui.InternalImStrbol, true)
	engine.RegisterMethod("imgui.internalImStrchrRange", "ImGui.InternalImStrchrRange", autogoimgui.InternalImStrchrRange, true)
	engine.RegisterMethod("imgui.internalImStrdup", "ImGui.InternalImStrdup", autogoimgui.InternalImStrdup, true)
	engine.RegisterMethod("imgui.internalImStrdupcpy", "ImGui.InternalImStrdupcpy", autogoimgui.InternalImStrdupcpy, true)
	engine.RegisterMethod("imgui.internalImStreolRange", "ImGui.InternalImStreolRange", autogoimgui.InternalImStreolRange, true)
	engine.RegisterMethod("imgui.internalImStricmp", "ImGui.InternalImStricmp", autogoimgui.InternalImStricmp, true)
	engine.RegisterMethod("imgui.internalImStristr", "ImGui.InternalImStristr", autogoimgui.InternalImStristr, true)
	engine.RegisterMethod("imgui.internalImStrlenW", "ImGui.InternalImStrlenW", autogoimgui.InternalImStrlenW, true)
	engine.RegisterMethod("imgui.internalImStrncpy", "ImGui.InternalImStrncpy", autogoimgui.InternalImStrncpy, true)
	engine.RegisterMethod("imgui.internalImStrnicmp", "ImGui.InternalImStrnicmp", autogoimgui.InternalImStrnicmp, true)
	engine.RegisterMethod("imgui.internalImTextCalcWordWrapNextLineStartV", "ImGui.InternalImTextCalcWordWrapNextLineStartV", autogoimgui.InternalImTextCalcWordWrapNextLineStartV, true)
	engine.RegisterMethod("imgui.internalImTextCharFromUtf8", "ImGui.InternalImTextCharFromUtf8", autogoimgui.InternalImTextCharFromUtf8, true)
	engine.RegisterMethod("imgui.internalImTextCharToUtf8", "ImGui.InternalImTextCharToUtf8", autogoimgui.InternalImTextCharToUtf8, true)
	engine.RegisterMethod("imgui.internalImTextCountCharsFromUtf8", "ImGui.InternalImTextCountCharsFromUtf8", autogoimgui.InternalImTextCountCharsFromUtf8, true)
	engine.RegisterMethod("imgui.internalImTextCountLines", "ImGui.InternalImTextCountLines", autogoimgui.InternalImTextCountLines, true)
	engine.RegisterMethod("imgui.internalImTextCountUtf8BytesFromChar", "ImGui.InternalImTextCountUtf8BytesFromChar", autogoimgui.InternalImTextCountUtf8BytesFromChar, true)
	engine.RegisterMethod("imgui.internalImTextCountUtf8BytesFromStr", "ImGui.InternalImTextCountUtf8BytesFromStr", autogoimgui.InternalImTextCountUtf8BytesFromStr, true)
	engine.RegisterMethod("imgui.internalImTextFindPreviousUtf8Codepoint", "ImGui.InternalImTextFindPreviousUtf8Codepoint", autogoimgui.InternalImTextFindPreviousUtf8Codepoint, true)
	engine.RegisterMethod("imgui.internalImTextStrFromUtf8V", "ImGui.InternalImTextStrFromUtf8V", autogoimgui.InternalImTextStrFromUtf8V, true)
	engine.RegisterMethod("imgui.internalImTextStrToUtf8", "ImGui.InternalImTextStrToUtf8", autogoimgui.InternalImTextStrToUtf8, true)
	engine.RegisterMethod("imgui.internalImTextureDataGetFormatBytesPerPixel", "ImGui.InternalImTextureDataGetFormatBytesPerPixel", autogoimgui.InternalImTextureDataGetFormatBytesPerPixel, true)
	engine.RegisterMethod("imgui.internalImTextureDataGetFormatName", "ImGui.InternalImTextureDataGetFormatName", autogoimgui.InternalImTextureDataGetFormatName, true)
	engine.RegisterMethod("imgui.internalImTextureDataGetStatusName", "ImGui.InternalImTextureDataGetStatusName", autogoimgui.InternalImTextureDataGetStatusName, true)
	engine.RegisterMethod("imgui.internalImToUpper", "ImGui.InternalImToUpper", autogoimgui.InternalImToUpper, true)
	engine.RegisterMethod("imgui.internalImTriangleArea", "ImGui.InternalImTriangleArea", autogoimgui.InternalImTriangleArea, true)
	engine.RegisterMethod("imgui.internalImTriangleBarycentricCoords", "ImGui.InternalImTriangleBarycentricCoords", autogoimgui.InternalImTriangleBarycentricCoords, true)
	engine.RegisterMethod("imgui.internalImTriangleClosestPoint", "ImGui.InternalImTriangleClosestPoint", autogoimgui.InternalImTriangleClosestPoint, true)
	engine.RegisterMethod("imgui.internalImTriangleContainsPoint", "ImGui.InternalImTriangleContainsPoint", autogoimgui.InternalImTriangleContainsPoint, true)
	engine.RegisterMethod("imgui.internalImTriangleIsClockwise", "ImGui.InternalImTriangleIsClockwise", autogoimgui.InternalImTriangleIsClockwise, true)
	engine.RegisterMethod("imgui.internalImTrunc64", "ImGui.InternalImTrunc64", autogoimgui.InternalImTrunc64, true)
	engine.RegisterMethod("imgui.internalImTruncFloat", "ImGui.InternalImTruncFloat", autogoimgui.InternalImTruncFloat, true)
	engine.RegisterMethod("imgui.internalImTruncVec2", "ImGui.InternalImTruncVec2", autogoimgui.InternalImTruncVec2, true)
	engine.RegisterMethod("imgui.internalImUpperPowerOfTwo", "ImGui.InternalImUpperPowerOfTwo", autogoimgui.InternalImUpperPowerOfTwo, true)
	engine.RegisterMethod("imgui.imageV", "ImGui.ImageV", autogoimgui.ImageV, true)
	engine.RegisterMethod("imgui.imageButtonV", "ImGui.ImageButtonV", autogoimgui.ImageButtonV, true)
	engine.RegisterMethod("imgui.internalImageButtonExV", "ImGui.InternalImageButtonExV", autogoimgui.InternalImageButtonExV, true)
	engine.RegisterMethod("imgui.imageWithBgV", "ImGui.ImageWithBgV", autogoimgui.ImageWithBgV, true)
	engine.RegisterMethod("imgui.indentV", "ImGui.IndentV", autogoimgui.IndentV, true)
	engine.RegisterMethod("imgui.internalInitialize", "ImGui.InternalInitialize", autogoimgui.InternalInitialize, true)
	engine.RegisterMethod("imgui.inputDoubleV", "ImGui.InputDoubleV", autogoimgui.InputDoubleV, true)
	engine.RegisterMethod("imgui.inputFloatV", "ImGui.InputFloatV", autogoimgui.InputFloatV, true)
	engine.RegisterMethod("imgui.inputFloat2V", "ImGui.InputFloat2V", autogoimgui.InputFloat2V, true)
	engine.RegisterMethod("imgui.inputFloat3V", "ImGui.InputFloat3V", autogoimgui.InputFloat3V, true)
	engine.RegisterMethod("imgui.inputFloat4V", "ImGui.InputFloat4V", autogoimgui.InputFloat4V, true)
	engine.RegisterMethod("imgui.inputIntV", "ImGui.InputIntV", autogoimgui.InputIntV, true)
	engine.RegisterMethod("imgui.inputInt2V", "ImGui.InputInt2V", autogoimgui.InputInt2V, true)
	engine.RegisterMethod("imgui.inputInt3V", "ImGui.InputInt3V", autogoimgui.InputInt3V, true)
	engine.RegisterMethod("imgui.inputInt4V", "ImGui.InputInt4V", autogoimgui.InputInt4V, true)
	engine.RegisterMethod("imgui.inputScalarV", "ImGui.InputScalarV", autogoimgui.InputScalarV, true)
	engine.RegisterMethod("imgui.inputScalarNV", "ImGui.InputScalarNV", autogoimgui.InputScalarNV, true)
	engine.RegisterMethod("imgui.internalInputTextDeactivateHook", "ImGui.InternalInputTextDeactivateHook", autogoimgui.InternalInputTextDeactivateHook, true)
	engine.RegisterMethod("imgui.invisibleButtonV", "ImGui.InvisibleButtonV", autogoimgui.InvisibleButtonV, true)
	engine.RegisterMethod("imgui.internalIsActiveIdUsingNavDir", "ImGui.InternalIsActiveIdUsingNavDir", autogoimgui.InternalIsActiveIdUsingNavDir, true)
	engine.RegisterMethod("imgui.internalIsAliasKey", "ImGui.InternalIsAliasKey", autogoimgui.InternalIsAliasKey, true)
	engine.RegisterMethod("imgui.isAnyItemActive", "ImGui.IsAnyItemActive", autogoimgui.IsAnyItemActive, true)
	engine.RegisterMethod("imgui.isAnyItemFocused", "ImGui.IsAnyItemFocused", autogoimgui.IsAnyItemFocused, true)
	engine.RegisterMethod("imgui.isAnyItemHovered", "ImGui.IsAnyItemHovered", autogoimgui.IsAnyItemHovered, true)
	engine.RegisterMethod("imgui.isAnyMouseDown", "ImGui.IsAnyMouseDown", autogoimgui.IsAnyMouseDown, true)
	engine.RegisterMethod("imgui.internalIsClippedEx", "ImGui.InternalIsClippedEx", autogoimgui.InternalIsClippedEx, true)
	engine.RegisterMethod("imgui.internalIsDragDropActive", "ImGui.InternalIsDragDropActive", autogoimgui.InternalIsDragDropActive, true)
	engine.RegisterMethod("imgui.internalIsDragDropPayloadBeingAccepted", "ImGui.InternalIsDragDropPayloadBeingAccepted", autogoimgui.InternalIsDragDropPayloadBeingAccepted, true)
	engine.RegisterMethod("imgui.internalIsGamepadKey", "ImGui.InternalIsGamepadKey", autogoimgui.InternalIsGamepadKey, true)
	engine.RegisterMethod("imgui.isItemActivated", "ImGui.IsItemActivated", autogoimgui.IsItemActivated, true)
	engine.RegisterMethod("imgui.isItemActive", "ImGui.IsItemActive", autogoimgui.IsItemActive, true)
	engine.RegisterMethod("imgui.internalIsItemActiveAsInputText", "ImGui.InternalIsItemActiveAsInputText", autogoimgui.InternalIsItemActiveAsInputText, true)
	engine.RegisterMethod("imgui.isItemClickedV", "ImGui.IsItemClickedV", autogoimgui.IsItemClickedV, true)
	engine.RegisterMethod("imgui.isItemDeactivated", "ImGui.IsItemDeactivated", autogoimgui.IsItemDeactivated, true)
	engine.RegisterMethod("imgui.isItemDeactivatedAfterEdit", "ImGui.IsItemDeactivatedAfterEdit", autogoimgui.IsItemDeactivatedAfterEdit, true)
	engine.RegisterMethod("imgui.isItemEdited", "ImGui.IsItemEdited", autogoimgui.IsItemEdited, true)
	engine.RegisterMethod("imgui.isItemFocused", "ImGui.IsItemFocused", autogoimgui.IsItemFocused, true)
	engine.RegisterMethod("imgui.isItemHoveredV", "ImGui.IsItemHoveredV", autogoimgui.IsItemHoveredV, true)
	engine.RegisterMethod("imgui.isItemToggledOpen", "ImGui.IsItemToggledOpen", autogoimgui.IsItemToggledOpen, true)
	engine.RegisterMethod("imgui.isItemToggledSelection", "ImGui.IsItemToggledSelection", autogoimgui.IsItemToggledSelection, true)
	engine.RegisterMethod("imgui.isItemVisible", "ImGui.IsItemVisible", autogoimgui.IsItemVisible, true)
	engine.RegisterMethod("imgui.internalIsKeyChordPressedInputFlagsV", "ImGui.InternalIsKeyChordPressedInputFlagsV", autogoimgui.InternalIsKeyChordPressedInputFlagsV, true)
	engine.RegisterMethod("imgui.isKeyChordPressed", "ImGui.IsKeyChordPressed", autogoimgui.IsKeyChordPressed, true)
	engine.RegisterMethod("imgui.internalIsKeyDownID", "ImGui.InternalIsKeyDownID", autogoimgui.InternalIsKeyDownID, true)
	engine.RegisterMethod("imgui.isKeyDown", "ImGui.IsKeyDown", autogoimgui.IsKeyDown, true)
	engine.RegisterMethod("imgui.isKeyPressedBoolV", "ImGui.IsKeyPressedBoolV", autogoimgui.IsKeyPressedBoolV, true)
	engine.RegisterMethod("imgui.internalIsKeyPressedInputFlagsV", "ImGui.InternalIsKeyPressedInputFlagsV", autogoimgui.InternalIsKeyPressedInputFlagsV, true)
	engine.RegisterMethod("imgui.internalIsKeyReleasedID", "ImGui.InternalIsKeyReleasedID", autogoimgui.InternalIsKeyReleasedID, true)
	engine.RegisterMethod("imgui.isKeyReleased", "ImGui.IsKeyReleased", autogoimgui.IsKeyReleased, true)
	engine.RegisterMethod("imgui.internalIsKeyboardKey", "ImGui.InternalIsKeyboardKey", autogoimgui.InternalIsKeyboardKey, true)
	engine.RegisterMethod("imgui.internalIsLRModKey", "ImGui.InternalIsLRModKey", autogoimgui.InternalIsLRModKey, true)
	engine.RegisterMethod("imgui.internalIsLegacyKey", "ImGui.InternalIsLegacyKey", autogoimgui.InternalIsLegacyKey, true)
	engine.RegisterMethod("imgui.isMouseClickedBoolV", "ImGui.IsMouseClickedBoolV", autogoimgui.IsMouseClickedBoolV, true)
	engine.RegisterMethod("imgui.internalIsMouseClickedInputFlagsV", "ImGui.InternalIsMouseClickedInputFlagsV", autogoimgui.InternalIsMouseClickedInputFlagsV, true)
	engine.RegisterMethod("imgui.internalIsMouseDoubleClickedID", "ImGui.InternalIsMouseDoubleClickedID", autogoimgui.InternalIsMouseDoubleClickedID, true)
	engine.RegisterMethod("imgui.isMouseDoubleClicked", "ImGui.IsMouseDoubleClicked", autogoimgui.IsMouseDoubleClicked, true)
	engine.RegisterMethod("imgui.internalIsMouseDownID", "ImGui.InternalIsMouseDownID", autogoimgui.InternalIsMouseDownID, true)
	engine.RegisterMethod("imgui.isMouseDown", "ImGui.IsMouseDown", autogoimgui.IsMouseDown, true)
	engine.RegisterMethod("imgui.internalIsMouseDragPastThresholdV", "ImGui.InternalIsMouseDragPastThresholdV", autogoimgui.InternalIsMouseDragPastThresholdV, true)
	engine.RegisterMethod("imgui.isMouseDraggingV", "ImGui.IsMouseDraggingV", autogoimgui.IsMouseDraggingV, true)
	engine.RegisterMethod("imgui.isMouseHoveringRectV", "ImGui.IsMouseHoveringRectV", autogoimgui.IsMouseHoveringRectV, true)
	engine.RegisterMethod("imgui.internalIsMouseKey", "ImGui.InternalIsMouseKey", autogoimgui.InternalIsMouseKey, true)
	engine.RegisterMethod("imgui.isMousePosValidV", "ImGui.IsMousePosValidV", autogoimgui.IsMousePosValidV, true)
	engine.RegisterMethod("imgui.isMouseReleasedWithDelay", "ImGui.IsMouseReleasedWithDelay", autogoimgui.IsMouseReleasedWithDelay, true)
	engine.RegisterMethod("imgui.internalIsMouseReleasedID", "ImGui.InternalIsMouseReleasedID", autogoimgui.InternalIsMouseReleasedID, true)
	engine.RegisterMethod("imgui.isMouseReleased", "ImGui.IsMouseReleased", autogoimgui.IsMouseReleased, true)
	engine.RegisterMethod("imgui.internalIsNamedKey", "ImGui.InternalIsNamedKey", autogoimgui.InternalIsNamedKey, true)
	engine.RegisterMethod("imgui.internalIsNamedKeyOrMod", "ImGui.InternalIsNamedKeyOrMod", autogoimgui.InternalIsNamedKeyOrMod, true)
	engine.RegisterMethod("imgui.internalIsPopupOpenID", "ImGui.InternalIsPopupOpenID", autogoimgui.InternalIsPopupOpenID, true)
	engine.RegisterMethod("imgui.isPopupOpenStrV", "ImGui.IsPopupOpenStrV", autogoimgui.IsPopupOpenStrV, true)
	engine.RegisterMethod("imgui.isRectVisible", "ImGui.IsRectVisible", autogoimgui.IsRectVisible, true)
	engine.RegisterMethod("imgui.isRectVisibleVec2", "ImGui.IsRectVisibleVec2", autogoimgui.IsRectVisibleVec2, true)
	engine.RegisterMethod("imgui.internalIsWindowAbove", "ImGui.InternalIsWindowAbove", autogoimgui.InternalIsWindowAbove, true)
	engine.RegisterMethod("imgui.isWindowAppearing", "ImGui.IsWindowAppearing", autogoimgui.IsWindowAppearing, true)
	engine.RegisterMethod("imgui.internalIsWindowChildOf", "ImGui.InternalIsWindowChildOf", autogoimgui.InternalIsWindowChildOf, true)
	engine.RegisterMethod("imgui.isWindowCollapsed", "ImGui.IsWindowCollapsed", autogoimgui.IsWindowCollapsed, true)
	engine.RegisterMethod("imgui.internalIsWindowContentHoverableV", "ImGui.InternalIsWindowContentHoverableV", autogoimgui.InternalIsWindowContentHoverableV, true)
	engine.RegisterMethod("imgui.isWindowDocked", "ImGui.IsWindowDocked", autogoimgui.IsWindowDocked, true)
	engine.RegisterMethod("imgui.isWindowFocusedV", "ImGui.IsWindowFocusedV", autogoimgui.IsWindowFocusedV, true)
	engine.RegisterMethod("imgui.isWindowHoveredV", "ImGui.IsWindowHoveredV", autogoimgui.IsWindowHoveredV, true)
	engine.RegisterMethod("imgui.internalIsWindowNavFocusable", "ImGui.InternalIsWindowNavFocusable", autogoimgui.InternalIsWindowNavFocusable, true)
	engine.RegisterMethod("imgui.internalIsWindowWithinBeginStackOf", "ImGui.InternalIsWindowWithinBeginStackOf", autogoimgui.InternalIsWindowWithinBeginStackOf, true)
	engine.RegisterMethod("imgui.internalItemAddV", "ImGui.InternalItemAddV", autogoimgui.InternalItemAddV, true)
	engine.RegisterMethod("imgui.internalItemHoverable", "ImGui.InternalItemHoverable", autogoimgui.InternalItemHoverable, true)
	engine.RegisterMethod("imgui.internalItemSizeRectV", "ImGui.InternalItemSizeRectV", autogoimgui.InternalItemSizeRectV, true)
	engine.RegisterMethod("imgui.internalItemSizeVec2V", "ImGui.InternalItemSizeVec2V", autogoimgui.InternalItemSizeVec2V, true)
	engine.RegisterMethod("imgui.internalKeepAliveID", "ImGui.InternalKeepAliveID", autogoimgui.InternalKeepAliveID, true)
	engine.RegisterMethod("imgui.labelText", "ImGui.LabelText", autogoimgui.LabelText, true)
	engine.RegisterMethod("imgui.listBoxStrarrV", "ImGui.ListBoxStrarrV", autogoimgui.ListBoxStrarrV, true)
	engine.RegisterMethod("imgui.loadIniSettingsFromDisk", "ImGui.LoadIniSettingsFromDisk", autogoimgui.LoadIniSettingsFromDisk, true)
	engine.RegisterMethod("imgui.loadIniSettingsFromMemoryV", "ImGui.LoadIniSettingsFromMemoryV", autogoimgui.LoadIniSettingsFromMemoryV, true)
	engine.RegisterMethod("imgui.internalLocalizeGetMsg", "ImGui.InternalLocalizeGetMsg", autogoimgui.InternalLocalizeGetMsg, true)
	engine.RegisterMethod("imgui.internalLocalizeRegisterEntries", "ImGui.InternalLocalizeRegisterEntries", autogoimgui.InternalLocalizeRegisterEntries, true)
	engine.RegisterMethod("imgui.internalLogBegin", "ImGui.InternalLogBegin", autogoimgui.InternalLogBegin, true)
	engine.RegisterMethod("imgui.logButtons", "ImGui.LogButtons", autogoimgui.LogButtons, true)
	engine.RegisterMethod("imgui.logFinish", "ImGui.LogFinish", autogoimgui.LogFinish, true)
	engine.RegisterMethod("imgui.internalLogRenderedTextV", "ImGui.InternalLogRenderedTextV", autogoimgui.InternalLogRenderedTextV, true)
	engine.RegisterMethod("imgui.internalLogSetNextTextDecoration", "ImGui.InternalLogSetNextTextDecoration", autogoimgui.InternalLogSetNextTextDecoration, true)
	engine.RegisterMethod("imgui.logText", "ImGui.LogText", autogoimgui.LogText, true)
	engine.RegisterMethod("imgui.internalLogToBufferV", "ImGui.InternalLogToBufferV", autogoimgui.InternalLogToBufferV, true)
	engine.RegisterMethod("imgui.logToClipboardV", "ImGui.LogToClipboardV", autogoimgui.LogToClipboardV, true)
	engine.RegisterMethod("imgui.logToFileV", "ImGui.LogToFileV", autogoimgui.LogToFileV, true)
	engine.RegisterMethod("imgui.logToTTYV", "ImGui.LogToTTYV", autogoimgui.LogToTTYV, true)
	engine.RegisterMethod("imgui.internalMarkIniSettingsDirty", "ImGui.InternalMarkIniSettingsDirty", autogoimgui.InternalMarkIniSettingsDirty, true)
	engine.RegisterMethod("imgui.internalMarkIniSettingsDirtyWindowPtr", "ImGui.InternalMarkIniSettingsDirtyWindowPtr", autogoimgui.InternalMarkIniSettingsDirtyWindowPtr, true)
	engine.RegisterMethod("imgui.internalMarkItemEdited", "ImGui.InternalMarkItemEdited", autogoimgui.InternalMarkItemEdited, true)
	engine.RegisterMethod("imgui.memAlloc", "ImGui.MemAlloc", autogoimgui.MemAlloc, true)
	engine.RegisterMethod("imgui.memFree", "ImGui.MemFree", autogoimgui.MemFree, true)
	engine.RegisterMethod("imgui.internalMenuItemExV", "ImGui.InternalMenuItemExV", autogoimgui.InternalMenuItemExV, true)
	engine.RegisterMethod("imgui.menuItemBoolV", "ImGui.MenuItemBoolV", autogoimgui.MenuItemBoolV, true)
	engine.RegisterMethod("imgui.menuItemBoolPtrV", "ImGui.MenuItemBoolPtrV", autogoimgui.MenuItemBoolPtrV, true)
	engine.RegisterMethod("imgui.internalMouseButtonToKey", "ImGui.InternalMouseButtonToKey", autogoimgui.InternalMouseButtonToKey, true)
	engine.RegisterMethod("imgui.internalMultiSelectAddSetAll", "ImGui.InternalMultiSelectAddSetAll", autogoimgui.InternalMultiSelectAddSetAll, true)
	engine.RegisterMethod("imgui.internalMultiSelectAddSetRange", "ImGui.InternalMultiSelectAddSetRange", autogoimgui.InternalMultiSelectAddSetRange, true)
	engine.RegisterMethod("imgui.internalMultiSelectItemFooter", "ImGui.InternalMultiSelectItemFooter", autogoimgui.InternalMultiSelectItemFooter, true)
	engine.RegisterMethod("imgui.internalMultiSelectItemHeader", "ImGui.InternalMultiSelectItemHeader", autogoimgui.InternalMultiSelectItemHeader, true)
	engine.RegisterMethod("imgui.internalNavClearPreferredPosForAxis", "ImGui.InternalNavClearPreferredPosForAxis", autogoimgui.InternalNavClearPreferredPosForAxis, true)
	engine.RegisterMethod("imgui.internalNavHighlightActivated", "ImGui.InternalNavHighlightActivated", autogoimgui.InternalNavHighlightActivated, true)
	engine.RegisterMethod("imgui.internalNavInitRequestApplyResult", "ImGui.InternalNavInitRequestApplyResult", autogoimgui.InternalNavInitRequestApplyResult, true)
	engine.RegisterMethod("imgui.internalNavInitWindow", "ImGui.InternalNavInitWindow", autogoimgui.InternalNavInitWindow, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestApplyResult", "ImGui.InternalNavMoveRequestApplyResult", autogoimgui.InternalNavMoveRequestApplyResult, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestButNoResultYet", "ImGui.InternalNavMoveRequestButNoResultYet", autogoimgui.InternalNavMoveRequestButNoResultYet, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestCancel", "ImGui.InternalNavMoveRequestCancel", autogoimgui.InternalNavMoveRequestCancel, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestForward", "ImGui.InternalNavMoveRequestForward", autogoimgui.InternalNavMoveRequestForward, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestResolveWithLastItem", "ImGui.InternalNavMoveRequestResolveWithLastItem", autogoimgui.InternalNavMoveRequestResolveWithLastItem, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestResolveWithPastTreeNode", "ImGui.InternalNavMoveRequestResolveWithPastTreeNode", autogoimgui.InternalNavMoveRequestResolveWithPastTreeNode, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestSubmit", "ImGui.InternalNavMoveRequestSubmit", autogoimgui.InternalNavMoveRequestSubmit, true)
	engine.RegisterMethod("imgui.internalNavMoveRequestTryWrapping", "ImGui.InternalNavMoveRequestTryWrapping", autogoimgui.InternalNavMoveRequestTryWrapping, true)
	engine.RegisterMethod("imgui.internalNavUpdateCurrentWindowIsScrollPushableX", "ImGui.InternalNavUpdateCurrentWindowIsScrollPushableX", autogoimgui.InternalNavUpdateCurrentWindowIsScrollPushableX, true)
	engine.RegisterMethod("imgui.newFrame", "ImGui.NewFrame", autogoimgui.NewFrame, true)
	engine.RegisterMethod("imgui.newLine", "ImGui.NewLine", autogoimgui.NewLine, true)
	engine.RegisterMethod("imgui.nextColumn", "ImGui.NextColumn", autogoimgui.NextColumn, true)
	engine.RegisterMethod("imgui.internalOpenPopupExV", "ImGui.InternalOpenPopupExV", autogoimgui.InternalOpenPopupExV, true)
	engine.RegisterMethod("imgui.openPopupOnItemClickV", "ImGui.OpenPopupOnItemClickV", autogoimgui.OpenPopupOnItemClickV, true)
	engine.RegisterMethod("imgui.openPopupIDV", "ImGui.OpenPopupIDV", autogoimgui.OpenPopupIDV, true)
	engine.RegisterMethod("imgui.openPopupStrV", "ImGui.OpenPopupStrV", autogoimgui.OpenPopupStrV, true)
	engine.RegisterMethod("imgui.plotHistogramFloatPtrV", "ImGui.PlotHistogramFloatPtrV", autogoimgui.PlotHistogramFloatPtrV, true)
	engine.RegisterMethod("imgui.plotLinesFloatPtrV", "ImGui.PlotLinesFloatPtrV", autogoimgui.PlotLinesFloatPtrV, true)
	engine.RegisterMethod("imgui.popClipRect", "ImGui.PopClipRect", autogoimgui.PopClipRect, true)
	engine.RegisterMethod("imgui.internalPopColumnsBackground", "ImGui.InternalPopColumnsBackground", autogoimgui.InternalPopColumnsBackground, true)
	engine.RegisterMethod("imgui.internalPopFocusScope", "ImGui.InternalPopFocusScope", autogoimgui.InternalPopFocusScope, true)
	engine.RegisterMethod("imgui.popFont", "ImGui.PopFont", autogoimgui.PopFont, true)
	engine.RegisterMethod("imgui.popID", "ImGui.PopID", autogoimgui.PopID, true)
	engine.RegisterMethod("imgui.popItemFlag", "ImGui.PopItemFlag", autogoimgui.PopItemFlag, true)
	engine.RegisterMethod("imgui.popItemWidth", "ImGui.PopItemWidth", autogoimgui.PopItemWidth, true)
	engine.RegisterMethod("imgui.internalPopPasswordFont", "ImGui.InternalPopPasswordFont", autogoimgui.InternalPopPasswordFont, true)
	engine.RegisterMethod("imgui.popStyleColorV", "ImGui.PopStyleColorV", autogoimgui.PopStyleColorV, true)
	engine.RegisterMethod("imgui.popStyleVarV", "ImGui.PopStyleVarV", autogoimgui.PopStyleVarV, true)
	engine.RegisterMethod("imgui.popTextWrapPos", "ImGui.PopTextWrapPos", autogoimgui.PopTextWrapPos, true)
	engine.RegisterMethod("imgui.progressBarV", "ImGui.ProgressBarV", autogoimgui.ProgressBarV, true)
	engine.RegisterMethod("imgui.pushClipRect", "ImGui.PushClipRect", autogoimgui.PushClipRect, true)
	engine.RegisterMethod("imgui.internalPushColumnClipRect", "ImGui.InternalPushColumnClipRect", autogoimgui.InternalPushColumnClipRect, true)
	engine.RegisterMethod("imgui.internalPushColumnsBackground", "ImGui.InternalPushColumnsBackground", autogoimgui.InternalPushColumnsBackground, true)
	engine.RegisterMethod("imgui.internalPushFocusScope", "ImGui.InternalPushFocusScope", autogoimgui.InternalPushFocusScope, true)
	engine.RegisterMethod("imgui.pushFont", "ImGui.PushFont", autogoimgui.PushFont, true)
	engine.RegisterMethod("imgui.pushIDInt", "ImGui.PushIDInt", autogoimgui.PushIDInt, true)
	engine.RegisterMethod("imgui.pushIDPtr", "ImGui.PushIDPtr", autogoimgui.PushIDPtr, true)
	engine.RegisterMethod("imgui.pushIDStr", "ImGui.PushIDStr", autogoimgui.PushIDStr, true)
	engine.RegisterMethod("imgui.pushIDStrStr", "ImGui.PushIDStrStr", autogoimgui.PushIDStrStr, true)
	engine.RegisterMethod("imgui.pushItemFlag", "ImGui.PushItemFlag", autogoimgui.PushItemFlag, true)
	engine.RegisterMethod("imgui.pushItemWidth", "ImGui.PushItemWidth", autogoimgui.PushItemWidth, true)
	engine.RegisterMethod("imgui.internalPushMultiItemsWidths", "ImGui.InternalPushMultiItemsWidths", autogoimgui.InternalPushMultiItemsWidths, true)
	engine.RegisterMethod("imgui.internalPushOverrideID", "ImGui.InternalPushOverrideID", autogoimgui.InternalPushOverrideID, true)
	engine.RegisterMethod("imgui.internalPushPasswordFont", "ImGui.InternalPushPasswordFont", autogoimgui.InternalPushPasswordFont, true)
	engine.RegisterMethod("imgui.pushStyleColorU32", "ImGui.PushStyleColorU32", autogoimgui.PushStyleColorU32, true)
	engine.RegisterMethod("imgui.pushStyleColorVec4", "ImGui.PushStyleColorVec4", autogoimgui.PushStyleColorVec4, true)
	engine.RegisterMethod("imgui.pushStyleVarX", "ImGui.PushStyleVarX", autogoimgui.PushStyleVarX, true)
	engine.RegisterMethod("imgui.pushStyleVarY", "ImGui.PushStyleVarY", autogoimgui.PushStyleVarY, true)
	engine.RegisterMethod("imgui.pushStyleVarFloat", "ImGui.PushStyleVarFloat", autogoimgui.PushStyleVarFloat, true)
	engine.RegisterMethod("imgui.pushStyleVarVec2", "ImGui.PushStyleVarVec2", autogoimgui.PushStyleVarVec2, true)
	engine.RegisterMethod("imgui.pushTextWrapPosV", "ImGui.PushTextWrapPosV", autogoimgui.PushTextWrapPosV, true)
	engine.RegisterMethod("imgui.radioButtonBool", "ImGui.RadioButtonBool", autogoimgui.RadioButtonBool, true)
	engine.RegisterMethod("imgui.radioButtonIntPtr", "ImGui.RadioButtonIntPtr", autogoimgui.RadioButtonIntPtr, true)
	engine.RegisterMethod("imgui.internalRegisterFontAtlas", "ImGui.InternalRegisterFontAtlas", autogoimgui.InternalRegisterFontAtlas, true)
	engine.RegisterMethod("imgui.internalRegisterUserTexture", "ImGui.InternalRegisterUserTexture", autogoimgui.InternalRegisterUserTexture, true)
	engine.RegisterMethod("imgui.internalRemoveContextHook", "ImGui.InternalRemoveContextHook", autogoimgui.InternalRemoveContextHook, true)
	engine.RegisterMethod("imgui.internalRemoveSettingsHandler", "ImGui.InternalRemoveSettingsHandler", autogoimgui.InternalRemoveSettingsHandler, true)
	engine.RegisterMethod("imgui.render", "ImGui.Render", autogoimgui.Render, true)
	engine.RegisterMethod("imgui.internalRenderArrowV", "ImGui.InternalRenderArrowV", autogoimgui.InternalRenderArrowV, true)
	engine.RegisterMethod("imgui.internalRenderArrowDockMenu", "ImGui.InternalRenderArrowDockMenu", autogoimgui.InternalRenderArrowDockMenu, true)
	engine.RegisterMethod("imgui.internalRenderArrowPointingAt", "ImGui.InternalRenderArrowPointingAt", autogoimgui.InternalRenderArrowPointingAt, true)
	engine.RegisterMethod("imgui.internalRenderBullet", "ImGui.InternalRenderBullet", autogoimgui.InternalRenderBullet, true)
	engine.RegisterMethod("imgui.internalRenderCheckMark", "ImGui.InternalRenderCheckMark", autogoimgui.InternalRenderCheckMark, true)
	engine.RegisterMethod("imgui.internalRenderColorRectWithAlphaCheckerboardV", "ImGui.InternalRenderColorRectWithAlphaCheckerboardV", autogoimgui.InternalRenderColorRectWithAlphaCheckerboardV, true)
	engine.RegisterMethod("imgui.internalRenderDragDropTargetRectEx", "ImGui.InternalRenderDragDropTargetRectEx", autogoimgui.InternalRenderDragDropTargetRectEx, true)
	engine.RegisterMethod("imgui.internalRenderDragDropTargetRectForItem", "ImGui.InternalRenderDragDropTargetRectForItem", autogoimgui.InternalRenderDragDropTargetRectForItem, true)
	engine.RegisterMethod("imgui.internalRenderFrameV", "ImGui.InternalRenderFrameV", autogoimgui.InternalRenderFrameV, true)
	engine.RegisterMethod("imgui.internalRenderFrameBorderV", "ImGui.InternalRenderFrameBorderV", autogoimgui.InternalRenderFrameBorderV, true)
	engine.RegisterMethod("imgui.internalRenderMouseCursor", "ImGui.InternalRenderMouseCursor", autogoimgui.InternalRenderMouseCursor, true)
	engine.RegisterMethod("imgui.internalRenderNavCursorV", "ImGui.InternalRenderNavCursorV", autogoimgui.InternalRenderNavCursorV, true)
	engine.RegisterMethod("imgui.renderPlatformWindowsDefaultV", "ImGui.RenderPlatformWindowsDefaultV", autogoimgui.RenderPlatformWindowsDefaultV, true)
	engine.RegisterMethod("imgui.internalRenderRectFilledRangeH", "ImGui.InternalRenderRectFilledRangeH", autogoimgui.InternalRenderRectFilledRangeH, true)
	engine.RegisterMethod("imgui.internalRenderRectFilledWithHole", "ImGui.InternalRenderRectFilledWithHole", autogoimgui.InternalRenderRectFilledWithHole, true)
	engine.RegisterMethod("imgui.internalRenderTextV", "ImGui.InternalRenderTextV", autogoimgui.InternalRenderTextV, true)
	engine.RegisterMethod("imgui.internalRenderTextClippedV", "ImGui.InternalRenderTextClippedV", autogoimgui.InternalRenderTextClippedV, true)
	engine.RegisterMethod("imgui.internalRenderTextClippedExV", "ImGui.InternalRenderTextClippedExV", autogoimgui.InternalRenderTextClippedExV, true)
	engine.RegisterMethod("imgui.internalRenderTextEllipsis", "ImGui.InternalRenderTextEllipsis", autogoimgui.InternalRenderTextEllipsis, true)
	engine.RegisterMethod("imgui.internalRenderTextWrapped", "ImGui.InternalRenderTextWrapped", autogoimgui.InternalRenderTextWrapped, true)
	engine.RegisterMethod("imgui.resetMouseDragDeltaV", "ImGui.ResetMouseDragDeltaV", autogoimgui.ResetMouseDragDeltaV, true)
	engine.RegisterMethod("imgui.sameLineV", "ImGui.SameLineV", autogoimgui.SameLineV, true)
	engine.RegisterMethod("imgui.saveIniSettingsToDisk", "ImGui.SaveIniSettingsToDisk", autogoimgui.SaveIniSettingsToDisk, true)
	engine.RegisterMethod("imgui.saveIniSettingsToMemoryV", "ImGui.SaveIniSettingsToMemoryV", autogoimgui.SaveIniSettingsToMemoryV, true)
	engine.RegisterMethod("imgui.internalScaleWindowsInViewport", "ImGui.InternalScaleWindowsInViewport", autogoimgui.InternalScaleWindowsInViewport, true)
	engine.RegisterMethod("imgui.internalScrollToBringRectIntoView", "ImGui.InternalScrollToBringRectIntoView", autogoimgui.InternalScrollToBringRectIntoView, true)
	engine.RegisterMethod("imgui.internalScrollToItemV", "ImGui.InternalScrollToItemV", autogoimgui.InternalScrollToItemV, true)
	engine.RegisterMethod("imgui.internalScrollToRectV", "ImGui.InternalScrollToRectV", autogoimgui.InternalScrollToRectV, true)
	engine.RegisterMethod("imgui.internalScrollToRectExV", "ImGui.InternalScrollToRectExV", autogoimgui.InternalScrollToRectExV, true)
	engine.RegisterMethod("imgui.internalScrollbar", "ImGui.InternalScrollbar", autogoimgui.InternalScrollbar, true)
	engine.RegisterMethod("imgui.internalScrollbarExV", "ImGui.InternalScrollbarExV", autogoimgui.InternalScrollbarExV, true)
	engine.RegisterMethod("imgui.selectableBoolV", "ImGui.SelectableBoolV", autogoimgui.SelectableBoolV, true)
	engine.RegisterMethod("imgui.selectableBoolPtrV", "ImGui.SelectableBoolPtrV", autogoimgui.SelectableBoolPtrV, true)
	engine.RegisterMethod("imgui.separator", "ImGui.Separator", autogoimgui.Separator, true)
	engine.RegisterMethod("imgui.internalSeparatorExV", "ImGui.InternalSeparatorExV", autogoimgui.InternalSeparatorExV, true)
	engine.RegisterMethod("imgui.separatorText", "ImGui.SeparatorText", autogoimgui.SeparatorText, true)
	engine.RegisterMethod("imgui.drawRect", "ImGui.DrawRect", autogoimgui.DrawRect, true)
	engine.RegisterMethod("imgui.internalSeparatorTextEx", "ImGui.InternalSeparatorTextEx", autogoimgui.InternalSeparatorTextEx, true)
	engine.RegisterMethod("imgui.internalSetActiveID", "ImGui.InternalSetActiveID", autogoimgui.InternalSetActiveID, true)
	engine.RegisterMethod("imgui.internalSetActiveIdUsingAllKeyboardKeys", "ImGui.InternalSetActiveIdUsingAllKeyboardKeys", autogoimgui.InternalSetActiveIdUsingAllKeyboardKeys, true)
	engine.RegisterMethod("imgui.setAllocatorFunctionsV", "ImGui.SetAllocatorFunctionsV", autogoimgui.SetAllocatorFunctionsV, true)
	engine.RegisterMethod("imgui.setClipboardText", "ImGui.SetClipboardText", autogoimgui.SetClipboardText, true)
	engine.RegisterMethod("imgui.setColorEditOptions", "ImGui.SetColorEditOptions", autogoimgui.SetColorEditOptions, true)
	engine.RegisterMethod("imgui.setColumnOffset", "ImGui.SetColumnOffset", autogoimgui.SetColumnOffset, true)
	engine.RegisterMethod("imgui.setColumnWidth", "ImGui.SetColumnWidth", autogoimgui.SetColumnWidth, true)
	engine.RegisterMethod("imgui.setCurrentContext", "ImGui.SetCurrentContext", autogoimgui.SetCurrentContext, true)
	engine.RegisterMethod("imgui.internalSetCurrentFont", "ImGui.InternalSetCurrentFont", autogoimgui.InternalSetCurrentFont, true)
	engine.RegisterMethod("imgui.internalSetCurrentViewport", "ImGui.InternalSetCurrentViewport", autogoimgui.InternalSetCurrentViewport, true)
	engine.RegisterMethod("imgui.setCursorPos", "ImGui.SetCursorPos", autogoimgui.SetCursorPos, true)
	engine.RegisterMethod("imgui.setCursorPosX", "ImGui.SetCursorPosX", autogoimgui.SetCursorPosX, true)
	engine.RegisterMethod("imgui.setCursorPosY", "ImGui.SetCursorPosY", autogoimgui.SetCursorPosY, true)
	engine.RegisterMethod("imgui.setCursorScreenPos", "ImGui.SetCursorScreenPos", autogoimgui.SetCursorScreenPos, true)
	engine.RegisterMethod("imgui.setDragDropPayloadV", "ImGui.SetDragDropPayloadV", autogoimgui.SetDragDropPayloadV, true)
	engine.RegisterMethod("imgui.internalSetFocusID", "ImGui.InternalSetFocusID", autogoimgui.InternalSetFocusID, true)
	engine.RegisterMethod("imgui.internalSetFontRasterizerDensity", "ImGui.InternalSetFontRasterizerDensity", autogoimgui.InternalSetFontRasterizerDensity, true)
	engine.RegisterMethod("imgui.internalSetHoveredID", "ImGui.InternalSetHoveredID", autogoimgui.InternalSetHoveredID, true)
	engine.RegisterMethod("imgui.setItemDefaultFocus", "ImGui.SetItemDefaultFocus", autogoimgui.SetItemDefaultFocus, true)
	engine.RegisterMethod("imgui.internalSetItemKeyOwnerInputFlags", "ImGui.InternalSetItemKeyOwnerInputFlags", autogoimgui.InternalSetItemKeyOwnerInputFlags, true)
	engine.RegisterMethod("imgui.setItemKeyOwner", "ImGui.SetItemKeyOwner", autogoimgui.SetItemKeyOwner, true)
	engine.RegisterMethod("imgui.setItemTooltip", "ImGui.SetItemTooltip", autogoimgui.SetItemTooltip, true)
	engine.RegisterMethod("imgui.internalSetKeyOwnerV", "ImGui.InternalSetKeyOwnerV", autogoimgui.InternalSetKeyOwnerV, true)
	engine.RegisterMethod("imgui.internalSetKeyOwnersForKeyChordV", "ImGui.InternalSetKeyOwnersForKeyChordV", autogoimgui.InternalSetKeyOwnersForKeyChordV, true)
	engine.RegisterMethod("imgui.setKeyboardFocusHereV", "ImGui.SetKeyboardFocusHereV", autogoimgui.SetKeyboardFocusHereV, true)
	engine.RegisterMethod("imgui.internalSetLastItemData", "ImGui.InternalSetLastItemData", autogoimgui.InternalSetLastItemData, true)
	engine.RegisterMethod("imgui.setMouseCursor", "ImGui.SetMouseCursor", autogoimgui.SetMouseCursor, true)
	engine.RegisterMethod("imgui.setNavCursorVisible", "ImGui.SetNavCursorVisible", autogoimgui.SetNavCursorVisible, true)
	engine.RegisterMethod("imgui.internalSetNavCursorVisibleAfterMove", "ImGui.InternalSetNavCursorVisibleAfterMove", autogoimgui.InternalSetNavCursorVisibleAfterMove, true)
	engine.RegisterMethod("imgui.internalSetNavFocusScope", "ImGui.InternalSetNavFocusScope", autogoimgui.InternalSetNavFocusScope, true)
	engine.RegisterMethod("imgui.internalSetNavID", "ImGui.InternalSetNavID", autogoimgui.InternalSetNavID, true)
	engine.RegisterMethod("imgui.internalSetNavWindow", "ImGui.InternalSetNavWindow", autogoimgui.InternalSetNavWindow, true)
	engine.RegisterMethod("imgui.setNextFrameWantCaptureKeyboard", "ImGui.SetNextFrameWantCaptureKeyboard", autogoimgui.SetNextFrameWantCaptureKeyboard, true)
	engine.RegisterMethod("imgui.setNextFrameWantCaptureMouse", "ImGui.SetNextFrameWantCaptureMouse", autogoimgui.SetNextFrameWantCaptureMouse, true)
	engine.RegisterMethod("imgui.setNextItemAllowOverlap", "ImGui.SetNextItemAllowOverlap", autogoimgui.SetNextItemAllowOverlap, true)
	engine.RegisterMethod("imgui.setNextItemOpenV", "ImGui.SetNextItemOpenV", autogoimgui.SetNextItemOpenV, true)
	engine.RegisterMethod("imgui.internalSetNextItemRefVal", "ImGui.InternalSetNextItemRefVal", autogoimgui.InternalSetNextItemRefVal, true)
	engine.RegisterMethod("imgui.setNextItemSelectionUserData", "ImGui.SetNextItemSelectionUserData", autogoimgui.SetNextItemSelectionUserData, true)
	engine.RegisterMethod("imgui.setNextItemShortcutV", "ImGui.SetNextItemShortcutV", autogoimgui.SetNextItemShortcutV, true)
	engine.RegisterMethod("imgui.setNextItemStorageID", "ImGui.SetNextItemStorageID", autogoimgui.SetNextItemStorageID, true)
	engine.RegisterMethod("imgui.setNextItemWidth", "ImGui.SetNextItemWidth", autogoimgui.SetNextItemWidth, true)
	engine.RegisterMethod("imgui.setNextWindowBgAlpha", "ImGui.SetNextWindowBgAlpha", autogoimgui.SetNextWindowBgAlpha, true)
	engine.RegisterMethod("imgui.setNextWindowClass", "ImGui.SetNextWindowClass", autogoimgui.SetNextWindowClass, true)
	engine.RegisterMethod("imgui.setNextWindowCollapsedV", "ImGui.SetNextWindowCollapsedV", autogoimgui.SetNextWindowCollapsedV, true)
	engine.RegisterMethod("imgui.setNextWindowContentSize", "ImGui.SetNextWindowContentSize", autogoimgui.SetNextWindowContentSize, true)
	engine.RegisterMethod("imgui.setNextWindowDockIDV", "ImGui.SetNextWindowDockIDV", autogoimgui.SetNextWindowDockIDV, true)
	engine.RegisterMethod("imgui.setNextWindowFocus", "ImGui.SetNextWindowFocus", autogoimgui.SetNextWindowFocus, true)
	engine.RegisterMethod("imgui.setNextWindowPosV", "ImGui.SetNextWindowPosV", autogoimgui.SetNextWindowPosV, true)
	engine.RegisterMethod("imgui.internalSetNextWindowRefreshPolicy", "ImGui.InternalSetNextWindowRefreshPolicy", autogoimgui.InternalSetNextWindowRefreshPolicy, true)
	engine.RegisterMethod("imgui.setNextWindowScroll", "ImGui.SetNextWindowScroll", autogoimgui.SetNextWindowScroll, true)
	engine.RegisterMethod("imgui.setNextWindowSizeV", "ImGui.SetNextWindowSizeV", autogoimgui.SetNextWindowSizeV, true)
	engine.RegisterMethod("imgui.setNextWindowSizeConstraintsV", "ImGui.SetNextWindowSizeConstraintsV", autogoimgui.SetNextWindowSizeConstraintsV, true)
	engine.RegisterMethod("imgui.setNextWindowViewport", "ImGui.SetNextWindowViewport", autogoimgui.SetNextWindowViewport, true)
	engine.RegisterMethod("imgui.setScrollFromPosXFloatV", "ImGui.SetScrollFromPosXFloatV", autogoimgui.SetScrollFromPosXFloatV, true)
	engine.RegisterMethod("imgui.internalSetScrollFromPosXWindowPtr", "ImGui.InternalSetScrollFromPosXWindowPtr", autogoimgui.InternalSetScrollFromPosXWindowPtr, true)
	engine.RegisterMethod("imgui.setScrollFromPosYFloatV", "ImGui.SetScrollFromPosYFloatV", autogoimgui.SetScrollFromPosYFloatV, true)
	engine.RegisterMethod("imgui.internalSetScrollFromPosYWindowPtr", "ImGui.InternalSetScrollFromPosYWindowPtr", autogoimgui.InternalSetScrollFromPosYWindowPtr, true)
	engine.RegisterMethod("imgui.setScrollHereXV", "ImGui.SetScrollHereXV", autogoimgui.SetScrollHereXV, true)
	engine.RegisterMethod("imgui.setScrollHereYV", "ImGui.SetScrollHereYV", autogoimgui.SetScrollHereYV, true)
	engine.RegisterMethod("imgui.setScrollXFloat", "ImGui.SetScrollXFloat", autogoimgui.SetScrollXFloat, true)
	engine.RegisterMethod("imgui.internalSetScrollXWindowPtr", "ImGui.InternalSetScrollXWindowPtr", autogoimgui.InternalSetScrollXWindowPtr, true)
	engine.RegisterMethod("imgui.setScrollYFloat", "ImGui.SetScrollYFloat", autogoimgui.SetScrollYFloat, true)
	engine.RegisterMethod("imgui.internalSetScrollYWindowPtr", "ImGui.InternalSetScrollYWindowPtr", autogoimgui.InternalSetScrollYWindowPtr, true)
	engine.RegisterMethod("imgui.internalSetShortcutRouting", "ImGui.InternalSetShortcutRouting", autogoimgui.InternalSetShortcutRouting, true)
	engine.RegisterMethod("imgui.setStateStorage", "ImGui.SetStateStorage", autogoimgui.SetStateStorage, true)
	engine.RegisterMethod("imgui.setTabItemClosed", "ImGui.SetTabItemClosed", autogoimgui.SetTabItemClosed, true)
	engine.RegisterMethod("imgui.setTooltip", "ImGui.SetTooltip", autogoimgui.SetTooltip, true)
	engine.RegisterMethod("imgui.internalSetWindowClipRectBeforeSetChannel", "ImGui.InternalSetWindowClipRectBeforeSetChannel", autogoimgui.InternalSetWindowClipRectBeforeSetChannel, true)
	engine.RegisterMethod("imgui.setWindowCollapsedBoolV", "ImGui.SetWindowCollapsedBoolV", autogoimgui.SetWindowCollapsedBoolV, true)
	engine.RegisterMethod("imgui.setWindowCollapsedStrV", "ImGui.SetWindowCollapsedStrV", autogoimgui.SetWindowCollapsedStrV, true)
	engine.RegisterMethod("imgui.internalSetWindowCollapsedWindowPtrV", "ImGui.InternalSetWindowCollapsedWindowPtrV", autogoimgui.InternalSetWindowCollapsedWindowPtrV, true)
	engine.RegisterMethod("imgui.internalSetWindowDock", "ImGui.InternalSetWindowDock", autogoimgui.InternalSetWindowDock, true)
	engine.RegisterMethod("imgui.setWindowFocus", "ImGui.SetWindowFocus", autogoimgui.SetWindowFocus, true)
	engine.RegisterMethod("imgui.setWindowFocusStr", "ImGui.SetWindowFocusStr", autogoimgui.SetWindowFocusStr, true)
	engine.RegisterMethod("imgui.setWindowFontScale", "ImGui.SetWindowFontScale", autogoimgui.SetWindowFontScale, true)
	engine.RegisterMethod("imgui.internalSetWindowHiddenAndSkipItemsForCurrentFrame", "ImGui.InternalSetWindowHiddenAndSkipItemsForCurrentFrame", autogoimgui.InternalSetWindowHiddenAndSkipItemsForCurrentFrame, true)
	engine.RegisterMethod("imgui.internalSetWindowHitTestHole", "ImGui.InternalSetWindowHitTestHole", autogoimgui.InternalSetWindowHitTestHole, true)
	engine.RegisterMethod("imgui.internalSetWindowParentWindowForFocusRoute", "ImGui.InternalSetWindowParentWindowForFocusRoute", autogoimgui.InternalSetWindowParentWindowForFocusRoute, true)
	engine.RegisterMethod("imgui.setWindowPosStrV", "ImGui.SetWindowPosStrV", autogoimgui.SetWindowPosStrV, true)
	engine.RegisterMethod("imgui.setWindowPosVec2V", "ImGui.SetWindowPosVec2V", autogoimgui.SetWindowPosVec2V, true)
	engine.RegisterMethod("imgui.internalSetWindowPosWindowPtrV", "ImGui.InternalSetWindowPosWindowPtrV", autogoimgui.InternalSetWindowPosWindowPtrV, true)
	engine.RegisterMethod("imgui.setWindowSizeStrV", "ImGui.SetWindowSizeStrV", autogoimgui.SetWindowSizeStrV, true)
	engine.RegisterMethod("imgui.setWindowSizeVec2V", "ImGui.SetWindowSizeVec2V", autogoimgui.SetWindowSizeVec2V, true)
	engine.RegisterMethod("imgui.internalSetWindowSizeWindowPtrV", "ImGui.InternalSetWindowSizeWindowPtrV", autogoimgui.InternalSetWindowSizeWindowPtrV, true)
	engine.RegisterMethod("imgui.internalSetWindowViewport", "ImGui.InternalSetWindowViewport", autogoimgui.InternalSetWindowViewport, true)
	engine.RegisterMethod("imgui.internalShadeVertsLinearColorGradientKeepAlpha", "ImGui.InternalShadeVertsLinearColorGradientKeepAlpha", autogoimgui.InternalShadeVertsLinearColorGradientKeepAlpha, true)
	engine.RegisterMethod("imgui.internalShadeVertsLinearUV", "ImGui.InternalShadeVertsLinearUV", autogoimgui.InternalShadeVertsLinearUV, true)
	engine.RegisterMethod("imgui.internalShadeVertsTransformPos", "ImGui.InternalShadeVertsTransformPos", autogoimgui.InternalShadeVertsTransformPos, true)
	engine.RegisterMethod("imgui.internalShortcutID", "ImGui.InternalShortcutID", autogoimgui.InternalShortcutID, true)
	engine.RegisterMethod("imgui.shortcutNilV", "ImGui.ShortcutNilV", autogoimgui.ShortcutNilV, true)
	engine.RegisterMethod("imgui.showAboutWindowV", "ImGui.ShowAboutWindowV", autogoimgui.ShowAboutWindowV, true)
	engine.RegisterMethod("imgui.showDebugLogWindowV", "ImGui.ShowDebugLogWindowV", autogoimgui.ShowDebugLogWindowV, true)
	engine.RegisterMethod("imgui.showDemoWindowV", "ImGui.ShowDemoWindowV", autogoimgui.ShowDemoWindowV, true)
	engine.RegisterMethod("imgui.internalShowFontAtlas", "ImGui.InternalShowFontAtlas", autogoimgui.InternalShowFontAtlas, true)
	engine.RegisterMethod("imgui.showFontSelector", "ImGui.ShowFontSelector", autogoimgui.ShowFontSelector, true)
	engine.RegisterMethod("imgui.showIDStackToolWindowV", "ImGui.ShowIDStackToolWindowV", autogoimgui.ShowIDStackToolWindowV, true)
	engine.RegisterMethod("imgui.showMetricsWindowV", "ImGui.ShowMetricsWindowV", autogoimgui.ShowMetricsWindowV, true)
	engine.RegisterMethod("imgui.showStyleEditorV", "ImGui.ShowStyleEditorV", autogoimgui.ShowStyleEditorV, true)
	engine.RegisterMethod("imgui.showStyleSelector", "ImGui.ShowStyleSelector", autogoimgui.ShowStyleSelector, true)
	engine.RegisterMethod("imgui.showUserGuide", "ImGui.ShowUserGuide", autogoimgui.ShowUserGuide, true)
	engine.RegisterMethod("imgui.internalShrinkWidths", "ImGui.InternalShrinkWidths", autogoimgui.InternalShrinkWidths, true)
	engine.RegisterMethod("imgui.internalShutdown", "ImGui.InternalShutdown", autogoimgui.InternalShutdown, true)
	engine.RegisterMethod("imgui.sliderAngleV", "ImGui.SliderAngleV", autogoimgui.SliderAngleV, true)
	engine.RegisterMethod("imgui.internalSliderBehavior", "ImGui.InternalSliderBehavior", autogoimgui.InternalSliderBehavior, true)
	engine.RegisterMethod("imgui.sliderFloatV", "ImGui.SliderFloatV", autogoimgui.SliderFloatV, true)
	engine.RegisterMethod("imgui.sliderFloat2V", "ImGui.SliderFloat2V", autogoimgui.SliderFloat2V, true)
	engine.RegisterMethod("imgui.sliderFloat3V", "ImGui.SliderFloat3V", autogoimgui.SliderFloat3V, true)
	engine.RegisterMethod("imgui.sliderFloat4V", "ImGui.SliderFloat4V", autogoimgui.SliderFloat4V, true)
	engine.RegisterMethod("imgui.sliderIntV", "ImGui.SliderIntV", autogoimgui.SliderIntV, true)
	engine.RegisterMethod("imgui.sliderInt2V", "ImGui.SliderInt2V", autogoimgui.SliderInt2V, true)
	engine.RegisterMethod("imgui.sliderInt3V", "ImGui.SliderInt3V", autogoimgui.SliderInt3V, true)
	engine.RegisterMethod("imgui.sliderInt4V", "ImGui.SliderInt4V", autogoimgui.SliderInt4V, true)
	engine.RegisterMethod("imgui.sliderScalarV", "ImGui.SliderScalarV", autogoimgui.SliderScalarV, true)
	engine.RegisterMethod("imgui.sliderScalarNV", "ImGui.SliderScalarNV", autogoimgui.SliderScalarNV, true)
	engine.RegisterMethod("imgui.smallButton", "ImGui.SmallButton", autogoimgui.SmallButton, true)
	engine.RegisterMethod("imgui.spacing", "ImGui.Spacing", autogoimgui.Spacing, true)
	engine.RegisterMethod("imgui.internalSplitterBehaviorV", "ImGui.InternalSplitterBehaviorV", autogoimgui.InternalSplitterBehaviorV, true)
	engine.RegisterMethod("imgui.internalStartMouseMovingWindow", "ImGui.InternalStartMouseMovingWindow", autogoimgui.InternalStartMouseMovingWindow, true)
	engine.RegisterMethod("imgui.internalStartMouseMovingWindowOrNode", "ImGui.InternalStartMouseMovingWindowOrNode", autogoimgui.InternalStartMouseMovingWindowOrNode, true)
	engine.RegisterMethod("imgui.internalStopMouseMovingWindow", "ImGui.InternalStopMouseMovingWindow", autogoimgui.InternalStopMouseMovingWindow, true)
	engine.RegisterMethod("imgui.styleColorsClassicV", "ImGui.StyleColorsClassicV", autogoimgui.StyleColorsClassicV, true)
	engine.RegisterMethod("imgui.styleColorsDarkV", "ImGui.StyleColorsDarkV", autogoimgui.StyleColorsDarkV, true)
	engine.RegisterMethod("imgui.styleColorsLightV", "ImGui.StyleColorsLightV", autogoimgui.StyleColorsLightV, true)
	engine.RegisterMethod("imgui.internalTabBarAddTab", "ImGui.InternalTabBarAddTab", autogoimgui.InternalTabBarAddTab, true)
	engine.RegisterMethod("imgui.internalTabBarCloseTab", "ImGui.InternalTabBarCloseTab", autogoimgui.InternalTabBarCloseTab, true)
	engine.RegisterMethod("imgui.internalTabBarFindByID", "ImGui.InternalTabBarFindByID", autogoimgui.InternalTabBarFindByID, true)
	engine.RegisterMethod("imgui.internalTabBarFindMostRecentlySelectedTabForActiveWindow", "ImGui.InternalTabBarFindMostRecentlySelectedTabForActiveWindow", autogoimgui.InternalTabBarFindMostRecentlySelectedTabForActiveWindow, true)
	engine.RegisterMethod("imgui.internalTabBarFindTabByID", "ImGui.InternalTabBarFindTabByID", autogoimgui.InternalTabBarFindTabByID, true)
	engine.RegisterMethod("imgui.internalTabBarFindTabByOrder", "ImGui.InternalTabBarFindTabByOrder", autogoimgui.InternalTabBarFindTabByOrder, true)
	engine.RegisterMethod("imgui.internalTabBarGetCurrentTab", "ImGui.InternalTabBarGetCurrentTab", autogoimgui.InternalTabBarGetCurrentTab, true)
	engine.RegisterMethod("imgui.internalTabBarGetTabName", "ImGui.InternalTabBarGetTabName", autogoimgui.InternalTabBarGetTabName, true)
	engine.RegisterMethod("imgui.internalTabBarGetTabOrder", "ImGui.InternalTabBarGetTabOrder", autogoimgui.InternalTabBarGetTabOrder, true)
	engine.RegisterMethod("imgui.internalTabBarProcessReorder", "ImGui.InternalTabBarProcessReorder", autogoimgui.InternalTabBarProcessReorder, true)
	engine.RegisterMethod("imgui.internalTabBarQueueFocusStr", "ImGui.InternalTabBarQueueFocusStr", autogoimgui.InternalTabBarQueueFocusStr, true)
	engine.RegisterMethod("imgui.internalTabBarQueueFocusTabItemPtr", "ImGui.InternalTabBarQueueFocusTabItemPtr", autogoimgui.InternalTabBarQueueFocusTabItemPtr, true)
	engine.RegisterMethod("imgui.internalTabBarQueueReorder", "ImGui.InternalTabBarQueueReorder", autogoimgui.InternalTabBarQueueReorder, true)
	engine.RegisterMethod("imgui.internalTabBarQueueReorderFromMousePos", "ImGui.InternalTabBarQueueReorderFromMousePos", autogoimgui.InternalTabBarQueueReorderFromMousePos, true)
	engine.RegisterMethod("imgui.internalTabBarRemove", "ImGui.InternalTabBarRemove", autogoimgui.InternalTabBarRemove, true)
	engine.RegisterMethod("imgui.internalTabBarRemoveTab", "ImGui.InternalTabBarRemoveTab", autogoimgui.InternalTabBarRemoveTab, true)
	engine.RegisterMethod("imgui.internalTabItemBackground", "ImGui.InternalTabItemBackground", autogoimgui.InternalTabItemBackground, true)
	engine.RegisterMethod("imgui.tabItemButtonV", "ImGui.TabItemButtonV", autogoimgui.TabItemButtonV, true)
	engine.RegisterMethod("imgui.internalTabItemCalcSizeStr", "ImGui.InternalTabItemCalcSizeStr", autogoimgui.InternalTabItemCalcSizeStr, true)
	engine.RegisterMethod("imgui.internalTabItemCalcSizeWindowPtr", "ImGui.InternalTabItemCalcSizeWindowPtr", autogoimgui.InternalTabItemCalcSizeWindowPtr, true)
	engine.RegisterMethod("imgui.internalTabItemEx", "ImGui.InternalTabItemEx", autogoimgui.InternalTabItemEx, true)
	engine.RegisterMethod("imgui.internalTabItemLabelAndCloseButton", "ImGui.InternalTabItemLabelAndCloseButton", autogoimgui.InternalTabItemLabelAndCloseButton, true)
	engine.RegisterMethod("imgui.internalTabItemSpacing", "ImGui.InternalTabItemSpacing", autogoimgui.InternalTabItemSpacing, true)
	engine.RegisterMethod("imgui.tableAngledHeadersRow", "ImGui.TableAngledHeadersRow", autogoimgui.TableAngledHeadersRow, true)
	engine.RegisterMethod("imgui.internalTableAngledHeadersRowEx", "ImGui.InternalTableAngledHeadersRowEx", autogoimgui.InternalTableAngledHeadersRowEx, true)
	engine.RegisterMethod("imgui.internalTableBeginApplyRequests", "ImGui.InternalTableBeginApplyRequests", autogoimgui.InternalTableBeginApplyRequests, true)
	engine.RegisterMethod("imgui.internalTableBeginCell", "ImGui.InternalTableBeginCell", autogoimgui.InternalTableBeginCell, true)
	engine.RegisterMethod("imgui.internalTableBeginContextMenuPopup", "ImGui.InternalTableBeginContextMenuPopup", autogoimgui.InternalTableBeginContextMenuPopup, true)
	engine.RegisterMethod("imgui.internalTableBeginInitMemory", "ImGui.InternalTableBeginInitMemory", autogoimgui.InternalTableBeginInitMemory, true)
	engine.RegisterMethod("imgui.internalTableBeginRow", "ImGui.InternalTableBeginRow", autogoimgui.InternalTableBeginRow, true)
	engine.RegisterMethod("imgui.internalTableCalcMaxColumnWidth", "ImGui.InternalTableCalcMaxColumnWidth", autogoimgui.InternalTableCalcMaxColumnWidth, true)
	engine.RegisterMethod("imgui.internalTableDrawBorders", "ImGui.InternalTableDrawBorders", autogoimgui.InternalTableDrawBorders, true)
	engine.RegisterMethod("imgui.internalTableDrawDefaultContextMenu", "ImGui.InternalTableDrawDefaultContextMenu", autogoimgui.InternalTableDrawDefaultContextMenu, true)
	engine.RegisterMethod("imgui.internalTableEndCell", "ImGui.InternalTableEndCell", autogoimgui.InternalTableEndCell, true)
	engine.RegisterMethod("imgui.internalTableEndRow", "ImGui.InternalTableEndRow", autogoimgui.InternalTableEndRow, true)
	engine.RegisterMethod("imgui.internalTableFindByID", "ImGui.InternalTableFindByID", autogoimgui.InternalTableFindByID, true)
	engine.RegisterMethod("imgui.internalTableFixColumnSortDirection", "ImGui.InternalTableFixColumnSortDirection", autogoimgui.InternalTableFixColumnSortDirection, true)
	engine.RegisterMethod("imgui.internalTableGcCompactSettings", "ImGui.InternalTableGcCompactSettings", autogoimgui.InternalTableGcCompactSettings, true)
	engine.RegisterMethod("imgui.internalTableGcCompactTransientBuffersTablePtr", "ImGui.InternalTableGcCompactTransientBuffersTablePtr", autogoimgui.InternalTableGcCompactTransientBuffersTablePtr, true)
	engine.RegisterMethod("imgui.internalTableGcCompactTransientBuffersTableTempDataPtr", "ImGui.InternalTableGcCompactTransientBuffersTableTempDataPtr", autogoimgui.InternalTableGcCompactTransientBuffersTableTempDataPtr, true)
	engine.RegisterMethod("imgui.internalTableGetBoundSettings", "ImGui.InternalTableGetBoundSettings", autogoimgui.InternalTableGetBoundSettings, true)
	engine.RegisterMethod("imgui.internalTableGetCellBgRect", "ImGui.InternalTableGetCellBgRect", autogoimgui.InternalTableGetCellBgRect, true)
	engine.RegisterMethod("imgui.tableGetColumnCount", "ImGui.TableGetColumnCount", autogoimgui.TableGetColumnCount, true)
	engine.RegisterMethod("imgui.tableGetColumnFlagsV", "ImGui.TableGetColumnFlagsV", autogoimgui.TableGetColumnFlagsV, true)
	engine.RegisterMethod("imgui.tableGetColumnIndex", "ImGui.TableGetColumnIndex", autogoimgui.TableGetColumnIndex, true)
	engine.RegisterMethod("imgui.tableGetColumnNameIntV", "ImGui.TableGetColumnNameIntV", autogoimgui.TableGetColumnNameIntV, true)
	engine.RegisterMethod("imgui.internalTableGetColumnNameTablePtr", "ImGui.InternalTableGetColumnNameTablePtr", autogoimgui.InternalTableGetColumnNameTablePtr, true)
	engine.RegisterMethod("imgui.internalTableGetColumnNextSortDirection", "ImGui.InternalTableGetColumnNextSortDirection", autogoimgui.InternalTableGetColumnNextSortDirection, true)
	engine.RegisterMethod("imgui.internalTableGetColumnResizeIDV", "ImGui.InternalTableGetColumnResizeIDV", autogoimgui.InternalTableGetColumnResizeIDV, true)
	engine.RegisterMethod("imgui.internalTableGetColumnWidthAuto", "ImGui.InternalTableGetColumnWidthAuto", autogoimgui.InternalTableGetColumnWidthAuto, true)
	engine.RegisterMethod("imgui.internalTableGetHeaderAngledMaxLabelWidth", "ImGui.InternalTableGetHeaderAngledMaxLabelWidth", autogoimgui.InternalTableGetHeaderAngledMaxLabelWidth, true)
	engine.RegisterMethod("imgui.internalTableGetHeaderRowHeight", "ImGui.InternalTableGetHeaderRowHeight", autogoimgui.InternalTableGetHeaderRowHeight, true)
	engine.RegisterMethod("imgui.tableGetHoveredColumn", "ImGui.TableGetHoveredColumn", autogoimgui.TableGetHoveredColumn, true)
	engine.RegisterMethod("imgui.internalTableGetHoveredRow", "ImGui.InternalTableGetHoveredRow", autogoimgui.InternalTableGetHoveredRow, true)
	engine.RegisterMethod("imgui.internalTableGetInstanceData", "ImGui.InternalTableGetInstanceData", autogoimgui.InternalTableGetInstanceData, true)
	engine.RegisterMethod("imgui.internalTableGetInstanceID", "ImGui.InternalTableGetInstanceID", autogoimgui.InternalTableGetInstanceID, true)
	engine.RegisterMethod("imgui.tableGetRowIndex", "ImGui.TableGetRowIndex", autogoimgui.TableGetRowIndex, true)
	engine.RegisterMethod("imgui.tableGetSortSpecs", "ImGui.TableGetSortSpecs", autogoimgui.TableGetSortSpecs, true)
	engine.RegisterMethod("imgui.tableHeader", "ImGui.TableHeader", autogoimgui.TableHeader, true)
	engine.RegisterMethod("imgui.tableHeadersRow", "ImGui.TableHeadersRow", autogoimgui.TableHeadersRow, true)
	engine.RegisterMethod("imgui.internalTableLoadSettings", "ImGui.InternalTableLoadSettings", autogoimgui.InternalTableLoadSettings, true)
	engine.RegisterMethod("imgui.internalTableMergeDrawChannels", "ImGui.InternalTableMergeDrawChannels", autogoimgui.InternalTableMergeDrawChannels, true)
	engine.RegisterMethod("imgui.tableNextColumn", "ImGui.TableNextColumn", autogoimgui.TableNextColumn, true)
	engine.RegisterMethod("imgui.tableNextRowV", "ImGui.TableNextRowV", autogoimgui.TableNextRowV, true)
	engine.RegisterMethod("imgui.internalTableOpenContextMenuV", "ImGui.InternalTableOpenContextMenuV", autogoimgui.InternalTableOpenContextMenuV, true)
	engine.RegisterMethod("imgui.internalTablePopBackgroundChannel", "ImGui.InternalTablePopBackgroundChannel", autogoimgui.InternalTablePopBackgroundChannel, true)
	engine.RegisterMethod("imgui.internalTablePopColumnChannel", "ImGui.InternalTablePopColumnChannel", autogoimgui.InternalTablePopColumnChannel, true)
	engine.RegisterMethod("imgui.internalTablePushBackgroundChannel", "ImGui.InternalTablePushBackgroundChannel", autogoimgui.InternalTablePushBackgroundChannel, true)
	engine.RegisterMethod("imgui.internalTablePushColumnChannel", "ImGui.InternalTablePushColumnChannel", autogoimgui.InternalTablePushColumnChannel, true)
	engine.RegisterMethod("imgui.internalTableRemove", "ImGui.InternalTableRemove", autogoimgui.InternalTableRemove, true)
	engine.RegisterMethod("imgui.internalTableResetSettings", "ImGui.InternalTableResetSettings", autogoimgui.InternalTableResetSettings, true)
	engine.RegisterMethod("imgui.internalTableSaveSettings", "ImGui.InternalTableSaveSettings", autogoimgui.InternalTableSaveSettings, true)
	engine.RegisterMethod("imgui.tableSetBgColorV", "ImGui.TableSetBgColorV", autogoimgui.TableSetBgColorV, true)
	engine.RegisterMethod("imgui.tableSetColumnEnabled", "ImGui.TableSetColumnEnabled", autogoimgui.TableSetColumnEnabled, true)
	engine.RegisterMethod("imgui.tableSetColumnIndex", "ImGui.TableSetColumnIndex", autogoimgui.TableSetColumnIndex, true)
	engine.RegisterMethod("imgui.internalTableSetColumnSortDirection", "ImGui.InternalTableSetColumnSortDirection", autogoimgui.InternalTableSetColumnSortDirection, true)
	engine.RegisterMethod("imgui.internalTableSetColumnWidth", "ImGui.InternalTableSetColumnWidth", autogoimgui.InternalTableSetColumnWidth, true)
	engine.RegisterMethod("imgui.internalTableSetColumnWidthAutoAll", "ImGui.InternalTableSetColumnWidthAutoAll", autogoimgui.InternalTableSetColumnWidthAutoAll, true)
	engine.RegisterMethod("imgui.internalTableSetColumnWidthAutoSingle", "ImGui.InternalTableSetColumnWidthAutoSingle", autogoimgui.InternalTableSetColumnWidthAutoSingle, true)
	engine.RegisterMethod("imgui.internalTableSettingsAddSettingsHandler", "ImGui.InternalTableSettingsAddSettingsHandler", autogoimgui.InternalTableSettingsAddSettingsHandler, true)
	engine.RegisterMethod("imgui.internalTableSettingsCreate", "ImGui.InternalTableSettingsCreate", autogoimgui.InternalTableSettingsCreate, true)
	engine.RegisterMethod("imgui.internalTableSettingsFindByID", "ImGui.InternalTableSettingsFindByID", autogoimgui.InternalTableSettingsFindByID, true)
	engine.RegisterMethod("imgui.tableSetupColumnV", "ImGui.TableSetupColumnV", autogoimgui.TableSetupColumnV, true)
	engine.RegisterMethod("imgui.internalTableSetupDrawChannels", "ImGui.InternalTableSetupDrawChannels", autogoimgui.InternalTableSetupDrawChannels, true)
	engine.RegisterMethod("imgui.tableSetupScrollFreeze", "ImGui.TableSetupScrollFreeze", autogoimgui.TableSetupScrollFreeze, true)
	engine.RegisterMethod("imgui.internalTableSortSpecsBuild", "ImGui.InternalTableSortSpecsBuild", autogoimgui.InternalTableSortSpecsBuild, true)
	engine.RegisterMethod("imgui.internalTableSortSpecsSanitize", "ImGui.InternalTableSortSpecsSanitize", autogoimgui.InternalTableSortSpecsSanitize, true)
	engine.RegisterMethod("imgui.internalTableUpdateBorders", "ImGui.InternalTableUpdateBorders", autogoimgui.InternalTableUpdateBorders, true)
	engine.RegisterMethod("imgui.internalTableUpdateColumnsWeightFromWidth", "ImGui.InternalTableUpdateColumnsWeightFromWidth", autogoimgui.InternalTableUpdateColumnsWeightFromWidth, true)
	engine.RegisterMethod("imgui.internalTableUpdateLayout", "ImGui.InternalTableUpdateLayout", autogoimgui.InternalTableUpdateLayout, true)
	engine.RegisterMethod("imgui.internalTeleportMousePos", "ImGui.InternalTeleportMousePos", autogoimgui.InternalTeleportMousePos, true)
	engine.RegisterMethod("imgui.internalTempInputIsActive", "ImGui.InternalTempInputIsActive", autogoimgui.InternalTempInputIsActive, true)
	engine.RegisterMethod("imgui.internalTempInputScalarV", "ImGui.InternalTempInputScalarV", autogoimgui.InternalTempInputScalarV, true)
	engine.RegisterMethod("imgui.internalTempInputText", "ImGui.InternalTempInputText", autogoimgui.InternalTempInputText, true)
	engine.RegisterMethod("imgui.internalTestKeyOwner", "ImGui.InternalTestKeyOwner", autogoimgui.InternalTestKeyOwner, true)
	engine.RegisterMethod("imgui.internalTestShortcutRouting", "ImGui.InternalTestShortcutRouting", autogoimgui.InternalTestShortcutRouting, true)
	engine.RegisterMethod("imgui.text", "ImGui.Text", autogoimgui.Text, true)
	engine.RegisterMethod("imgui.internalTextAligned", "ImGui.InternalTextAligned", autogoimgui.InternalTextAligned, true)
	engine.RegisterMethod("imgui.textColored", "ImGui.TextColored", autogoimgui.TextColored, true)
	engine.RegisterMethod("imgui.textDisabled", "ImGui.TextDisabled", autogoimgui.TextDisabled, true)
	engine.RegisterMethod("imgui.internalTextExV", "ImGui.InternalTextExV", autogoimgui.InternalTextExV, true)
	engine.RegisterMethod("imgui.textLink", "ImGui.TextLink", autogoimgui.TextLink, true)
	engine.RegisterMethod("imgui.textLinkOpenURLV", "ImGui.TextLinkOpenURLV", autogoimgui.TextLinkOpenURLV, true)
	engine.RegisterMethod("imgui.textUnformattedV", "ImGui.TextUnformattedV", autogoimgui.TextUnformattedV, true)
	engine.RegisterMethod("imgui.textWrapped", "ImGui.TextWrapped", autogoimgui.TextWrapped, true)
	engine.RegisterMethod("imgui.internalTranslateWindowsInViewport", "ImGui.InternalTranslateWindowsInViewport", autogoimgui.InternalTranslateWindowsInViewport, true)
	engine.RegisterMethod("imgui.internalTreeNodeBehaviorV", "ImGui.InternalTreeNodeBehaviorV", autogoimgui.InternalTreeNodeBehaviorV, true)
	engine.RegisterMethod("imgui.internalTreeNodeDrawLineToChildNode", "ImGui.InternalTreeNodeDrawLineToChildNode", autogoimgui.InternalTreeNodeDrawLineToChildNode, true)
	engine.RegisterMethod("imgui.internalTreeNodeDrawLineToTreePop", "ImGui.InternalTreeNodeDrawLineToTreePop", autogoimgui.InternalTreeNodeDrawLineToTreePop, true)
	engine.RegisterMethod("imgui.treeNodeExPtr", "ImGui.TreeNodeExPtr", autogoimgui.TreeNodeExPtr, true)
	engine.RegisterMethod("imgui.treeNodeExStrV", "ImGui.TreeNodeExStrV", autogoimgui.TreeNodeExStrV, true)
	engine.RegisterMethod("imgui.treeNodeExStrStr", "ImGui.TreeNodeExStrStr", autogoimgui.TreeNodeExStrStr, true)
	engine.RegisterMethod("imgui.internalTreeNodeGetOpen", "ImGui.InternalTreeNodeGetOpen", autogoimgui.InternalTreeNodeGetOpen, true)
	engine.RegisterMethod("imgui.internalTreeNodeSetOpen", "ImGui.InternalTreeNodeSetOpen", autogoimgui.InternalTreeNodeSetOpen, true)
	engine.RegisterMethod("imgui.internalTreeNodeUpdateNextOpen", "ImGui.InternalTreeNodeUpdateNextOpen", autogoimgui.InternalTreeNodeUpdateNextOpen, true)
	engine.RegisterMethod("imgui.treeNodePtr", "ImGui.TreeNodePtr", autogoimgui.TreeNodePtr, true)
	engine.RegisterMethod("imgui.treeNodeStr", "ImGui.TreeNodeStr", autogoimgui.TreeNodeStr, true)
	engine.RegisterMethod("imgui.treeNodeStrStr", "ImGui.TreeNodeStrStr", autogoimgui.TreeNodeStrStr, true)
	engine.RegisterMethod("imgui.treePop", "ImGui.TreePop", autogoimgui.TreePop, true)
	engine.RegisterMethod("imgui.internalTreePushOverrideID", "ImGui.InternalTreePushOverrideID", autogoimgui.InternalTreePushOverrideID, true)
	engine.RegisterMethod("imgui.treePushPtr", "ImGui.TreePushPtr", autogoimgui.TreePushPtr, true)
	engine.RegisterMethod("imgui.treePushStr", "ImGui.TreePushStr", autogoimgui.TreePushStr, true)
	engine.RegisterMethod("imgui.unindentV", "ImGui.UnindentV", autogoimgui.UnindentV, true)
	engine.RegisterMethod("imgui.internalUnregisterFontAtlas", "ImGui.InternalUnregisterFontAtlas", autogoimgui.InternalUnregisterFontAtlas, true)
	engine.RegisterMethod("imgui.internalUnregisterUserTexture", "ImGui.InternalUnregisterUserTexture", autogoimgui.InternalUnregisterUserTexture, true)
	engine.RegisterMethod("imgui.internalUpdateCurrentFontSize", "ImGui.InternalUpdateCurrentFontSize", autogoimgui.InternalUpdateCurrentFontSize, true)
	engine.RegisterMethod("imgui.internalUpdateHoveredWindowAndCaptureFlags", "ImGui.InternalUpdateHoveredWindowAndCaptureFlags", autogoimgui.InternalUpdateHoveredWindowAndCaptureFlags, true)
	engine.RegisterMethod("imgui.internalUpdateInputEvents", "ImGui.InternalUpdateInputEvents", autogoimgui.InternalUpdateInputEvents, true)
	engine.RegisterMethod("imgui.internalUpdateMouseMovingWindowEndFrame", "ImGui.InternalUpdateMouseMovingWindowEndFrame", autogoimgui.InternalUpdateMouseMovingWindowEndFrame, true)
	engine.RegisterMethod("imgui.internalUpdateMouseMovingWindowNewFrame", "ImGui.InternalUpdateMouseMovingWindowNewFrame", autogoimgui.InternalUpdateMouseMovingWindowNewFrame, true)
	engine.RegisterMethod("imgui.updatePlatformWindows", "ImGui.UpdatePlatformWindows", autogoimgui.UpdatePlatformWindows, true)
	engine.RegisterMethod("imgui.internalUpdateWindowParentAndRootLinks", "ImGui.InternalUpdateWindowParentAndRootLinks", autogoimgui.InternalUpdateWindowParentAndRootLinks, true)
	engine.RegisterMethod("imgui.internalUpdateWindowSkipRefresh", "ImGui.InternalUpdateWindowSkipRefresh", autogoimgui.InternalUpdateWindowSkipRefresh, true)
	engine.RegisterMethod("imgui.vSliderFloatV", "ImGui.VSliderFloatV", autogoimgui.VSliderFloatV, true)
	engine.RegisterMethod("imgui.vSliderIntV", "ImGui.VSliderIntV", autogoimgui.VSliderIntV, true)
	engine.RegisterMethod("imgui.vSliderScalarV", "ImGui.VSliderScalarV", autogoimgui.VSliderScalarV, true)
	engine.RegisterMethod("imgui.valueBool", "ImGui.ValueBool", autogoimgui.ValueBool, true)
	engine.RegisterMethod("imgui.valueFloatV", "ImGui.ValueFloatV", autogoimgui.ValueFloatV, true)
	engine.RegisterMethod("imgui.valueInt", "ImGui.ValueInt", autogoimgui.ValueInt, true)
	engine.RegisterMethod("imgui.valueUint", "ImGui.ValueUint", autogoimgui.ValueUint, true)
	engine.RegisterMethod("imgui.internalWindowPosAbsToRel", "ImGui.InternalWindowPosAbsToRel", autogoimgui.InternalWindowPosAbsToRel, true)
	engine.RegisterMethod("imgui.internalWindowPosRelToAbs", "ImGui.InternalWindowPosRelToAbs", autogoimgui.InternalWindowPosRelToAbs, true)
	engine.RegisterMethod("imgui.internalWindowRectAbsToRel", "ImGui.InternalWindowRectAbsToRel", autogoimgui.InternalWindowRectAbsToRel, true)
	engine.RegisterMethod("imgui.internalWindowRectRelToAbs", "ImGui.InternalWindowRectRelToAbs", autogoimgui.InternalWindowRectRelToAbs, true)
	engine.RegisterMethod("imgui.colorHSV", "ImGui.ColorHSV", autogoimgui.ColorHSV, true)
	engine.RegisterMethod("imgui.acceptDragDropPayload", "ImGui.AcceptDragDropPayload", autogoimgui.AcceptDragDropPayload, true)
	engine.RegisterMethod("imgui.internalArrowButtonEx", "ImGui.InternalArrowButtonEx", autogoimgui.InternalArrowButtonEx, true)
	engine.RegisterMethod("imgui.begin", "ImGui.Begin", autogoimgui.Begin, true)
	engine.RegisterMethod("imgui.beginChildID", "ImGui.BeginChildID", autogoimgui.BeginChildID, true)
	engine.RegisterMethod("imgui.beginChildStr", "ImGui.BeginChildStr", autogoimgui.BeginChildStr, true)
	engine.RegisterMethod("imgui.internalBeginColumns", "ImGui.InternalBeginColumns", autogoimgui.InternalBeginColumns, true)
	engine.RegisterMethod("imgui.beginCombo", "ImGui.BeginCombo", autogoimgui.BeginCombo, true)
	engine.RegisterMethod("imgui.beginDisabled", "ImGui.BeginDisabled", autogoimgui.BeginDisabled, true)
	engine.RegisterMethod("imgui.beginDragDropSource", "ImGui.BeginDragDropSource", autogoimgui.BeginDragDropSource, true)
	engine.RegisterMethod("imgui.internalBeginDragDropTargetViewport", "ImGui.InternalBeginDragDropTargetViewport", autogoimgui.InternalBeginDragDropTargetViewport, true)
	engine.RegisterMethod("imgui.beginListBox", "ImGui.BeginListBox", autogoimgui.BeginListBox, true)
	engine.RegisterMethod("imgui.beginMenu", "ImGui.BeginMenu", autogoimgui.BeginMenu, true)
	engine.RegisterMethod("imgui.internalBeginMenuEx", "ImGui.InternalBeginMenuEx", autogoimgui.InternalBeginMenuEx, true)
	engine.RegisterMethod("imgui.beginMultiSelect", "ImGui.BeginMultiSelect", autogoimgui.BeginMultiSelect, true)
	engine.RegisterMethod("imgui.beginPopup", "ImGui.BeginPopup", autogoimgui.BeginPopup, true)
	engine.RegisterMethod("imgui.beginPopupContextItem", "ImGui.BeginPopupContextItem", autogoimgui.BeginPopupContextItem, true)
	engine.RegisterMethod("imgui.beginPopupContextVoid", "ImGui.BeginPopupContextVoid", autogoimgui.BeginPopupContextVoid, true)
	engine.RegisterMethod("imgui.beginPopupContextWindow", "ImGui.BeginPopupContextWindow", autogoimgui.BeginPopupContextWindow, true)
	engine.RegisterMethod("imgui.beginPopupModal", "ImGui.BeginPopupModal", autogoimgui.BeginPopupModal, true)
	engine.RegisterMethod("imgui.beginTabBar", "ImGui.BeginTabBar", autogoimgui.BeginTabBar, true)
	engine.RegisterMethod("imgui.beginTabItem", "ImGui.BeginTabItem", autogoimgui.BeginTabItem, true)
	engine.RegisterMethod("imgui.beginTable", "ImGui.BeginTable", autogoimgui.BeginTable, true)
	engine.RegisterMethod("imgui.internalBeginTableEx", "ImGui.InternalBeginTableEx", autogoimgui.InternalBeginTableEx, true)
	engine.RegisterMethod("imgui.button", "ImGui.Button", autogoimgui.Button, true)
	engine.RegisterMethod("imgui.internalButtonBehavior", "ImGui.InternalButtonBehavior", autogoimgui.InternalButtonBehavior, true)
	engine.RegisterMethod("imgui.internalButtonEx", "ImGui.InternalButtonEx", autogoimgui.InternalButtonEx, true)
	engine.RegisterMethod("imgui.calcTextSize", "ImGui.CalcTextSize", autogoimgui.CalcTextSize, true)
	engine.RegisterMethod("imgui.collapsingHeaderBoolPtr", "ImGui.CollapsingHeaderBoolPtr", autogoimgui.CollapsingHeaderBoolPtr, true)
	engine.RegisterMethod("imgui.collapsingHeaderTreeNodeFlags", "ImGui.CollapsingHeaderTreeNodeFlags", autogoimgui.CollapsingHeaderTreeNodeFlags, true)
	engine.RegisterMethod("imgui.colorButton", "ImGui.ColorButton", autogoimgui.ColorButton, true)
	engine.RegisterMethod("imgui.colorEdit3", "ImGui.ColorEdit3", autogoimgui.ColorEdit3, true)
	engine.RegisterMethod("imgui.colorEdit4", "ImGui.ColorEdit4", autogoimgui.ColorEdit4, true)
	engine.RegisterMethod("imgui.colorPicker3", "ImGui.ColorPicker3", autogoimgui.ColorPicker3, true)
	engine.RegisterMethod("imgui.colorPicker4", "ImGui.ColorPicker4", autogoimgui.ColorPicker4, true)
	engine.RegisterMethod("imgui.columns", "ImGui.Columns", autogoimgui.Columns, true)
	engine.RegisterMethod("imgui.comboStr", "ImGui.ComboStr", autogoimgui.ComboStr, true)
	engine.RegisterMethod("imgui.comboStrarr", "ImGui.ComboStrarr", autogoimgui.ComboStrarr, true)
	engine.RegisterMethod("imgui.createContext", "ImGui.CreateContext", autogoimgui.CreateContext, true)
	engine.RegisterMethod("imgui.internalDataTypeApplyFromText", "ImGui.InternalDataTypeApplyFromText", autogoimgui.InternalDataTypeApplyFromText, true)
	engine.RegisterMethod("imgui.internalDebugDrawCursorPos", "ImGui.InternalDebugDrawCursorPos", autogoimgui.InternalDebugDrawCursorPos, true)
	engine.RegisterMethod("imgui.internalDebugDrawItemRect", "ImGui.InternalDebugDrawItemRect", autogoimgui.InternalDebugDrawItemRect, true)
	engine.RegisterMethod("imgui.internalDebugDrawLineExtents", "ImGui.InternalDebugDrawLineExtents", autogoimgui.InternalDebugDrawLineExtents, true)
	engine.RegisterMethod("imgui.internalDebugNodeTexture", "ImGui.InternalDebugNodeTexture", autogoimgui.InternalDebugNodeTexture, true)
	engine.RegisterMethod("imgui.destroyContext", "ImGui.DestroyContext", autogoimgui.DestroyContext, true)
	engine.RegisterMethod("imgui.internalDockBuilderAddNode", "ImGui.InternalDockBuilderAddNode", autogoimgui.InternalDockBuilderAddNode, true)
	engine.RegisterMethod("imgui.internalDockBuilderRemoveNodeDockedWindows", "ImGui.InternalDockBuilderRemoveNodeDockedWindows", autogoimgui.InternalDockBuilderRemoveNodeDockedWindows, true)
	engine.RegisterMethod("imgui.internalDockContextProcessUndockWindow", "ImGui.InternalDockContextProcessUndockWindow", autogoimgui.InternalDockContextProcessUndockWindow, true)
	engine.RegisterMethod("imgui.dockSpace", "ImGui.DockSpace", autogoimgui.DockSpace, true)
	engine.RegisterMethod("imgui.dockSpaceOverViewport", "ImGui.DockSpaceOverViewport", autogoimgui.DockSpaceOverViewport, true)
	engine.RegisterMethod("imgui.dragFloat", "ImGui.DragFloat", autogoimgui.DragFloat, true)
	engine.RegisterMethod("imgui.dragFloat2", "ImGui.DragFloat2", autogoimgui.DragFloat2, true)
	engine.RegisterMethod("imgui.dragFloat3", "ImGui.DragFloat3", autogoimgui.DragFloat3, true)
	engine.RegisterMethod("imgui.dragFloat4", "ImGui.DragFloat4", autogoimgui.DragFloat4, true)
	engine.RegisterMethod("imgui.dragFloatRange2", "ImGui.DragFloatRange2", autogoimgui.DragFloatRange2, true)
	engine.RegisterMethod("imgui.dragInt", "ImGui.DragInt", autogoimgui.DragInt, true)
	engine.RegisterMethod("imgui.dragInt2", "ImGui.DragInt2", autogoimgui.DragInt2, true)
	engine.RegisterMethod("imgui.dragInt3", "ImGui.DragInt3", autogoimgui.DragInt3, true)
	engine.RegisterMethod("imgui.dragInt4", "ImGui.DragInt4", autogoimgui.DragInt4, true)
	engine.RegisterMethod("imgui.dragIntRange2", "ImGui.DragIntRange2", autogoimgui.DragIntRange2, true)
	engine.RegisterMethod("imgui.dragScalar", "ImGui.DragScalar", autogoimgui.DragScalar, true)
	engine.RegisterMethod("imgui.dragScalarN", "ImGui.DragScalarN", autogoimgui.DragScalarN, true)
	engine.RegisterMethod("imgui.internalFindRenderedTextEnd", "ImGui.InternalFindRenderedTextEnd", autogoimgui.InternalFindRenderedTextEnd, true)
	engine.RegisterMethod("imgui.internalFocusWindow", "ImGui.InternalFocusWindow", autogoimgui.InternalFocusWindow, true)
	engine.RegisterMethod("imgui.backgroundDrawList", "ImGui.BackgroundDrawList", autogoimgui.BackgroundDrawList, true)
	engine.RegisterMethod("imgui.colorU32Col", "ImGui.ColorU32Col", autogoimgui.ColorU32Col, true)
	engine.RegisterMethod("imgui.colorU32U32", "ImGui.ColorU32U32", autogoimgui.ColorU32U32, true)
	engine.RegisterMethod("imgui.columnOffset", "ImGui.ColumnOffset", autogoimgui.ColumnOffset, true)
	engine.RegisterMethod("imgui.columnWidth", "ImGui.ColumnWidth", autogoimgui.ColumnWidth, true)
	engine.RegisterMethod("imgui.foregroundDrawListViewportPtr", "ImGui.ForegroundDrawListViewportPtr", autogoimgui.ForegroundDrawListViewportPtr, true)
	engine.RegisterMethod("imgui.mouseDragDelta", "ImGui.MouseDragDelta", autogoimgui.MouseDragDelta, true)
	engine.RegisterMethod("imgui.internalTypingSelectRequest", "ImGui.InternalTypingSelectRequest", autogoimgui.InternalTypingSelectRequest, true)
	engine.RegisterMethod("imgui.internalImFileLoadToMemory", "ImGui.InternalImFileLoadToMemory", autogoimgui.InternalImFileLoadToMemory, true)
	engine.RegisterMethod("imgui.internalImFontAtlasPackAddRect", "ImGui.InternalImFontAtlasPackAddRect", autogoimgui.InternalImFontAtlasPackAddRect, true)
	engine.RegisterMethod("imgui.internalImFontAtlasTextureGrow", "ImGui.InternalImFontAtlasTextureGrow", autogoimgui.InternalImFontAtlasTextureGrow, true)
	engine.RegisterMethod("imgui.internalImFontCalcWordWrapPositionEx", "ImGui.InternalImFontCalcWordWrapPositionEx", autogoimgui.InternalImFontCalcWordWrapPositionEx, true)
	engine.RegisterMethod("imgui.internalImHashData", "ImGui.InternalImHashData", autogoimgui.InternalImHashData, true)
	engine.RegisterMethod("imgui.internalImHashStr", "ImGui.InternalImHashStr", autogoimgui.InternalImHashStr, true)
	engine.RegisterMethod("imgui.internalImTextCalcWordWrapNextLineStart", "ImGui.InternalImTextCalcWordWrapNextLineStart", autogoimgui.InternalImTextCalcWordWrapNextLineStart, true)
	engine.RegisterMethod("imgui.internalImTextStrFromUtf8", "ImGui.InternalImTextStrFromUtf8", autogoimgui.InternalImTextStrFromUtf8, true)
	engine.RegisterMethod("imgui.image", "ImGui.Image", autogoimgui.Image, true)
	engine.RegisterMethod("imgui.imageButton", "ImGui.ImageButton", autogoimgui.ImageButton, true)
	engine.RegisterMethod("imgui.internalImageButtonEx", "ImGui.InternalImageButtonEx", autogoimgui.InternalImageButtonEx, true)
	engine.RegisterMethod("imgui.imageWithBg", "ImGui.ImageWithBg", autogoimgui.ImageWithBg, true)
	engine.RegisterMethod("imgui.indent", "ImGui.Indent", autogoimgui.Indent, true)
	engine.RegisterMethod("imgui.inputDouble", "ImGui.InputDouble", autogoimgui.InputDouble, true)
	engine.RegisterMethod("imgui.inputFloat", "ImGui.InputFloat", autogoimgui.InputFloat, true)
	engine.RegisterMethod("imgui.inputFloat2", "ImGui.InputFloat2", autogoimgui.InputFloat2, true)
	engine.RegisterMethod("imgui.inputFloat3", "ImGui.InputFloat3", autogoimgui.InputFloat3, true)
	engine.RegisterMethod("imgui.inputFloat4", "ImGui.InputFloat4", autogoimgui.InputFloat4, true)
	engine.RegisterMethod("imgui.inputInt", "ImGui.InputInt", autogoimgui.InputInt, true)
	engine.RegisterMethod("imgui.inputInt2", "ImGui.InputInt2", autogoimgui.InputInt2, true)
	engine.RegisterMethod("imgui.inputInt3", "ImGui.InputInt3", autogoimgui.InputInt3, true)
	engine.RegisterMethod("imgui.inputInt4", "ImGui.InputInt4", autogoimgui.InputInt4, true)
	engine.RegisterMethod("imgui.inputScalar", "ImGui.InputScalar", autogoimgui.InputScalar, true)
	engine.RegisterMethod("imgui.inputScalarN", "ImGui.InputScalarN", autogoimgui.InputScalarN, true)
	engine.RegisterMethod("imgui.internalInputTextEx", "ImGui.InternalInputTextEx", autogoimgui.InternalInputTextEx, true)
	engine.RegisterMethod("imgui.invisibleButton", "ImGui.InvisibleButton", autogoimgui.InvisibleButton, true)
	engine.RegisterMethod("imgui.isItemClicked", "ImGui.IsItemClicked", autogoimgui.IsItemClicked, true)
	engine.RegisterMethod("imgui.isItemHovered", "ImGui.IsItemHovered", autogoimgui.IsItemHovered, true)
	engine.RegisterMethod("imgui.internalIsKeyChordPressedInputFlags", "ImGui.InternalIsKeyChordPressedInputFlags", autogoimgui.InternalIsKeyChordPressedInputFlags, true)
	engine.RegisterMethod("imgui.isKeyPressedBool", "ImGui.IsKeyPressedBool", autogoimgui.IsKeyPressedBool, true)
	engine.RegisterMethod("imgui.internalIsKeyPressedInputFlags", "ImGui.InternalIsKeyPressedInputFlags", autogoimgui.InternalIsKeyPressedInputFlags, true)
	engine.RegisterMethod("imgui.isMouseClickedBool", "ImGui.IsMouseClickedBool", autogoimgui.IsMouseClickedBool, true)
	engine.RegisterMethod("imgui.internalIsMouseClickedInputFlags", "ImGui.InternalIsMouseClickedInputFlags", autogoimgui.InternalIsMouseClickedInputFlags, true)
	engine.RegisterMethod("imgui.internalIsMouseDragPastThreshold", "ImGui.InternalIsMouseDragPastThreshold", autogoimgui.InternalIsMouseDragPastThreshold, true)
	engine.RegisterMethod("imgui.isMouseDragging", "ImGui.IsMouseDragging", autogoimgui.IsMouseDragging, true)
	engine.RegisterMethod("imgui.isMouseHoveringRect", "ImGui.IsMouseHoveringRect", autogoimgui.IsMouseHoveringRect, true)
	engine.RegisterMethod("imgui.isMousePosValid", "ImGui.IsMousePosValid", autogoimgui.IsMousePosValid, true)
	engine.RegisterMethod("imgui.isPopupOpenStr", "ImGui.IsPopupOpenStr", autogoimgui.IsPopupOpenStr, true)
	engine.RegisterMethod("imgui.internalIsWindowContentHoverable", "ImGui.InternalIsWindowContentHoverable", autogoimgui.InternalIsWindowContentHoverable, true)
	engine.RegisterMethod("imgui.isWindowFocused", "ImGui.IsWindowFocused", autogoimgui.IsWindowFocused, true)
	engine.RegisterMethod("imgui.isWindowHovered", "ImGui.IsWindowHovered", autogoimgui.IsWindowHovered, true)
	engine.RegisterMethod("imgui.internalItemAdd", "ImGui.InternalItemAdd", autogoimgui.InternalItemAdd, true)
	engine.RegisterMethod("imgui.internalItemSizeRect", "ImGui.InternalItemSizeRect", autogoimgui.InternalItemSizeRect, true)
	engine.RegisterMethod("imgui.internalItemSizeVec2", "ImGui.InternalItemSizeVec2", autogoimgui.InternalItemSizeVec2, true)
	engine.RegisterMethod("imgui.listBoxStrarr", "ImGui.ListBoxStrarr", autogoimgui.ListBoxStrarr, true)
	engine.RegisterMethod("imgui.loadIniSettingsFromMemory", "ImGui.LoadIniSettingsFromMemory", autogoimgui.LoadIniSettingsFromMemory, true)
	engine.RegisterMethod("imgui.internalLogRenderedText", "ImGui.InternalLogRenderedText", autogoimgui.InternalLogRenderedText, true)
	engine.RegisterMethod("imgui.internalLogToBuffer", "ImGui.InternalLogToBuffer", autogoimgui.InternalLogToBuffer, true)
	engine.RegisterMethod("imgui.logToClipboard", "ImGui.LogToClipboard", autogoimgui.LogToClipboard, true)
	engine.RegisterMethod("imgui.logToFile", "ImGui.LogToFile", autogoimgui.LogToFile, true)
	engine.RegisterMethod("imgui.logToTTY", "ImGui.LogToTTY", autogoimgui.LogToTTY, true)
	engine.RegisterMethod("imgui.internalMenuItemEx", "ImGui.InternalMenuItemEx", autogoimgui.InternalMenuItemEx, true)
	engine.RegisterMethod("imgui.menuItemBool", "ImGui.MenuItemBool", autogoimgui.MenuItemBool, true)
	engine.RegisterMethod("imgui.menuItemBoolPtr", "ImGui.MenuItemBoolPtr", autogoimgui.MenuItemBoolPtr, true)
	engine.RegisterMethod("imgui.internalOpenPopupEx", "ImGui.InternalOpenPopupEx", autogoimgui.InternalOpenPopupEx, true)
	engine.RegisterMethod("imgui.openPopupOnItemClick", "ImGui.OpenPopupOnItemClick", autogoimgui.OpenPopupOnItemClick, true)
	engine.RegisterMethod("imgui.openPopupID", "ImGui.OpenPopupID", autogoimgui.OpenPopupID, true)
	engine.RegisterMethod("imgui.openPopupStr", "ImGui.OpenPopupStr", autogoimgui.OpenPopupStr, true)
	engine.RegisterMethod("imgui.plotHistogramFloatPtr", "ImGui.PlotHistogramFloatPtr", autogoimgui.PlotHistogramFloatPtr, true)
	engine.RegisterMethod("imgui.plotLinesFloatPtr", "ImGui.PlotLinesFloatPtr", autogoimgui.PlotLinesFloatPtr, true)
	engine.RegisterMethod("imgui.popStyleColor", "ImGui.PopStyleColor", autogoimgui.PopStyleColor, true)
	engine.RegisterMethod("imgui.popStyleVar", "ImGui.PopStyleVar", autogoimgui.PopStyleVar, true)
	engine.RegisterMethod("imgui.progressBar", "ImGui.ProgressBar", autogoimgui.ProgressBar, true)
	engine.RegisterMethod("imgui.pushTextWrapPos", "ImGui.PushTextWrapPos", autogoimgui.PushTextWrapPos, true)
	engine.RegisterMethod("imgui.internalRenderArrow", "ImGui.InternalRenderArrow", autogoimgui.InternalRenderArrow, true)
	engine.RegisterMethod("imgui.internalRenderColorRectWithAlphaCheckerboard", "ImGui.InternalRenderColorRectWithAlphaCheckerboard", autogoimgui.InternalRenderColorRectWithAlphaCheckerboard, true)
	engine.RegisterMethod("imgui.internalRenderFrame", "ImGui.InternalRenderFrame", autogoimgui.InternalRenderFrame, true)
	engine.RegisterMethod("imgui.internalRenderFrameBorder", "ImGui.InternalRenderFrameBorder", autogoimgui.InternalRenderFrameBorder, true)
	engine.RegisterMethod("imgui.internalRenderNavCursor", "ImGui.InternalRenderNavCursor", autogoimgui.InternalRenderNavCursor, true)
	engine.RegisterMethod("imgui.renderPlatformWindowsDefault", "ImGui.RenderPlatformWindowsDefault", autogoimgui.RenderPlatformWindowsDefault, true)
	engine.RegisterMethod("imgui.internalRenderText", "ImGui.InternalRenderText", autogoimgui.InternalRenderText, true)
	engine.RegisterMethod("imgui.internalRenderTextClipped", "ImGui.InternalRenderTextClipped", autogoimgui.InternalRenderTextClipped, true)
	engine.RegisterMethod("imgui.internalRenderTextClippedEx", "ImGui.InternalRenderTextClippedEx", autogoimgui.InternalRenderTextClippedEx, true)
	engine.RegisterMethod("imgui.resetMouseDragDelta", "ImGui.ResetMouseDragDelta", autogoimgui.ResetMouseDragDelta, true)
	engine.RegisterMethod("imgui.sameLine", "ImGui.SameLine", autogoimgui.SameLine, true)
	engine.RegisterMethod("imgui.saveIniSettingsToMemory", "ImGui.SaveIniSettingsToMemory", autogoimgui.SaveIniSettingsToMemory, true)
	engine.RegisterMethod("imgui.internalScrollToItem", "ImGui.InternalScrollToItem", autogoimgui.InternalScrollToItem, true)
	engine.RegisterMethod("imgui.internalScrollToRect", "ImGui.InternalScrollToRect", autogoimgui.InternalScrollToRect, true)
	engine.RegisterMethod("imgui.internalScrollToRectEx", "ImGui.InternalScrollToRectEx", autogoimgui.InternalScrollToRectEx, true)
	engine.RegisterMethod("imgui.internalScrollbarEx", "ImGui.InternalScrollbarEx", autogoimgui.InternalScrollbarEx, true)
	engine.RegisterMethod("imgui.selectableBool", "ImGui.SelectableBool", autogoimgui.SelectableBool, true)
	engine.RegisterMethod("imgui.selectableBoolPtr", "ImGui.SelectableBoolPtr", autogoimgui.SelectableBoolPtr, true)
	engine.RegisterMethod("imgui.internalSeparatorEx", "ImGui.InternalSeparatorEx", autogoimgui.InternalSeparatorEx, true)
	engine.RegisterMethod("imgui.setAllocatorFunctions", "ImGui.SetAllocatorFunctions", autogoimgui.SetAllocatorFunctions, true)
	engine.RegisterMethod("imgui.setDragDropPayload", "ImGui.SetDragDropPayload", autogoimgui.SetDragDropPayload, true)
	engine.RegisterMethod("imgui.internalSetKeyOwner", "ImGui.InternalSetKeyOwner", autogoimgui.InternalSetKeyOwner, true)
	engine.RegisterMethod("imgui.internalSetKeyOwnersForKeyChord", "ImGui.InternalSetKeyOwnersForKeyChord", autogoimgui.InternalSetKeyOwnersForKeyChord, true)
	engine.RegisterMethod("imgui.setKeyboardFocusHere", "ImGui.SetKeyboardFocusHere", autogoimgui.SetKeyboardFocusHere, true)
	engine.RegisterMethod("imgui.setNextItemOpen", "ImGui.SetNextItemOpen", autogoimgui.SetNextItemOpen, true)
	engine.RegisterMethod("imgui.setNextItemShortcut", "ImGui.SetNextItemShortcut", autogoimgui.SetNextItemShortcut, true)
	engine.RegisterMethod("imgui.setNextWindowCollapsed", "ImGui.SetNextWindowCollapsed", autogoimgui.SetNextWindowCollapsed, true)
	engine.RegisterMethod("imgui.setNextWindowDockID", "ImGui.SetNextWindowDockID", autogoimgui.SetNextWindowDockID, true)
	engine.RegisterMethod("imgui.setNextWindowPos", "ImGui.SetNextWindowPos", autogoimgui.SetNextWindowPos, true)
	engine.RegisterMethod("imgui.setNextWindowSize", "ImGui.SetNextWindowSize", autogoimgui.SetNextWindowSize, true)
	engine.RegisterMethod("imgui.setNextWindowSizeConstraints", "ImGui.SetNextWindowSizeConstraints", autogoimgui.SetNextWindowSizeConstraints, true)
	engine.RegisterMethod("imgui.setScrollFromPosXFloat", "ImGui.SetScrollFromPosXFloat", autogoimgui.SetScrollFromPosXFloat, true)
	engine.RegisterMethod("imgui.setScrollFromPosYFloat", "ImGui.SetScrollFromPosYFloat", autogoimgui.SetScrollFromPosYFloat, true)
	engine.RegisterMethod("imgui.setScrollHereX", "ImGui.SetScrollHereX", autogoimgui.SetScrollHereX, true)
	engine.RegisterMethod("imgui.setScrollHereY", "ImGui.SetScrollHereY", autogoimgui.SetScrollHereY, true)
	engine.RegisterMethod("imgui.setWindowCollapsedBool", "ImGui.SetWindowCollapsedBool", autogoimgui.SetWindowCollapsedBool, true)
	engine.RegisterMethod("imgui.setWindowCollapsedStr", "ImGui.SetWindowCollapsedStr", autogoimgui.SetWindowCollapsedStr, true)
	engine.RegisterMethod("imgui.internalSetWindowCollapsedWindowPtr", "ImGui.InternalSetWindowCollapsedWindowPtr", autogoimgui.InternalSetWindowCollapsedWindowPtr, true)
	engine.RegisterMethod("imgui.setWindowPosStr", "ImGui.SetWindowPosStr", autogoimgui.SetWindowPosStr, true)
	engine.RegisterMethod("imgui.setWindowPosVec2", "ImGui.SetWindowPosVec2", autogoimgui.SetWindowPosVec2, true)
	engine.RegisterMethod("imgui.internalSetWindowPosWindowPtr", "ImGui.InternalSetWindowPosWindowPtr", autogoimgui.InternalSetWindowPosWindowPtr, true)
	engine.RegisterMethod("imgui.setWindowSizeStr", "ImGui.SetWindowSizeStr", autogoimgui.SetWindowSizeStr, true)
	engine.RegisterMethod("imgui.setWindowSizeVec2", "ImGui.SetWindowSizeVec2", autogoimgui.SetWindowSizeVec2, true)
	engine.RegisterMethod("imgui.internalSetWindowSizeWindowPtr", "ImGui.InternalSetWindowSizeWindowPtr", autogoimgui.InternalSetWindowSizeWindowPtr, true)
	engine.RegisterMethod("imgui.shortcut", "ImGui.Shortcut", autogoimgui.Shortcut, true)
	engine.RegisterMethod("imgui.showAboutWindow", "ImGui.ShowAboutWindow", autogoimgui.ShowAboutWindow, true)
	engine.RegisterMethod("imgui.showDebugLogWindow", "ImGui.ShowDebugLogWindow", autogoimgui.ShowDebugLogWindow, true)
	engine.RegisterMethod("imgui.showDemoWindow", "ImGui.ShowDemoWindow", autogoimgui.ShowDemoWindow, true)
	engine.RegisterMethod("imgui.showIDStackToolWindow", "ImGui.ShowIDStackToolWindow", autogoimgui.ShowIDStackToolWindow, true)
	engine.RegisterMethod("imgui.showMetricsWindow", "ImGui.ShowMetricsWindow", autogoimgui.ShowMetricsWindow, true)
	engine.RegisterMethod("imgui.showStyleEditor", "ImGui.ShowStyleEditor", autogoimgui.ShowStyleEditor, true)
	engine.RegisterMethod("imgui.sliderAngle", "ImGui.SliderAngle", autogoimgui.SliderAngle, true)
	engine.RegisterMethod("imgui.sliderFloat", "ImGui.SliderFloat", autogoimgui.SliderFloat, true)
	engine.RegisterMethod("imgui.sliderFloat2", "ImGui.SliderFloat2", autogoimgui.SliderFloat2, true)
	engine.RegisterMethod("imgui.sliderFloat3", "ImGui.SliderFloat3", autogoimgui.SliderFloat3, true)
	engine.RegisterMethod("imgui.sliderFloat4", "ImGui.SliderFloat4", autogoimgui.SliderFloat4, true)
	engine.RegisterMethod("imgui.sliderInt", "ImGui.SliderInt", autogoimgui.SliderInt, true)
	engine.RegisterMethod("imgui.sliderInt2", "ImGui.SliderInt2", autogoimgui.SliderInt2, true)
	engine.RegisterMethod("imgui.sliderInt3", "ImGui.SliderInt3", autogoimgui.SliderInt3, true)
	engine.RegisterMethod("imgui.sliderInt4", "ImGui.SliderInt4", autogoimgui.SliderInt4, true)
	engine.RegisterMethod("imgui.sliderScalar", "ImGui.SliderScalar", autogoimgui.SliderScalar, true)
	engine.RegisterMethod("imgui.sliderScalarN", "ImGui.SliderScalarN", autogoimgui.SliderScalarN, true)
	engine.RegisterMethod("imgui.internalSplitterBehavior", "ImGui.InternalSplitterBehavior", autogoimgui.InternalSplitterBehavior, true)
	engine.RegisterMethod("imgui.styleColorsClassic", "ImGui.StyleColorsClassic", autogoimgui.StyleColorsClassic, true)
	engine.RegisterMethod("imgui.styleColorsDark", "ImGui.StyleColorsDark", autogoimgui.StyleColorsDark, true)
	engine.RegisterMethod("imgui.styleColorsLight", "ImGui.StyleColorsLight", autogoimgui.StyleColorsLight, true)
	engine.RegisterMethod("imgui.tabItemButton", "ImGui.TabItemButton", autogoimgui.TabItemButton, true)
	engine.RegisterMethod("imgui.tableGetColumnFlags", "ImGui.TableGetColumnFlags", autogoimgui.TableGetColumnFlags, true)
	engine.RegisterMethod("imgui.tableGetColumnNameInt", "ImGui.TableGetColumnNameInt", autogoimgui.TableGetColumnNameInt, true)
	engine.RegisterMethod("imgui.internalTableGetColumnResizeID", "ImGui.InternalTableGetColumnResizeID", autogoimgui.InternalTableGetColumnResizeID, true)
	engine.RegisterMethod("imgui.tableNextRow", "ImGui.TableNextRow", autogoimgui.TableNextRow, true)
	engine.RegisterMethod("imgui.internalTableOpenContextMenu", "ImGui.InternalTableOpenContextMenu", autogoimgui.InternalTableOpenContextMenu, true)
	engine.RegisterMethod("imgui.tableSetBgColor", "ImGui.TableSetBgColor", autogoimgui.TableSetBgColor, true)
	engine.RegisterMethod("imgui.tableSetupColumn", "ImGui.TableSetupColumn", autogoimgui.TableSetupColumn, true)
	engine.RegisterMethod("imgui.internalTempInputScalar", "ImGui.InternalTempInputScalar", autogoimgui.InternalTempInputScalar, true)
	engine.RegisterMethod("imgui.internalTextEx", "ImGui.InternalTextEx", autogoimgui.InternalTextEx, true)
	engine.RegisterMethod("imgui.textLinkOpenURL", "ImGui.TextLinkOpenURL", autogoimgui.TextLinkOpenURL, true)
	engine.RegisterMethod("imgui.textUnformatted", "ImGui.TextUnformatted", autogoimgui.TextUnformatted, true)
	engine.RegisterMethod("imgui.internalTreeNodeBehavior", "ImGui.InternalTreeNodeBehavior", autogoimgui.InternalTreeNodeBehavior, true)
	engine.RegisterMethod("imgui.treeNodeExStr", "ImGui.TreeNodeExStr", autogoimgui.TreeNodeExStr, true)
	engine.RegisterMethod("imgui.unindent", "ImGui.Unindent", autogoimgui.Unindent, true)
	engine.RegisterMethod("imgui.vSliderFloat", "ImGui.VSliderFloat", autogoimgui.VSliderFloat, true)
	engine.RegisterMethod("imgui.vSliderInt", "ImGui.VSliderInt", autogoimgui.VSliderInt, true)
	engine.RegisterMethod("imgui.vSliderScalar", "ImGui.VSliderScalar", autogoimgui.VSliderScalar, true)
	engine.RegisterMethod("imgui.valueFloat", "ImGui.ValueFloat", autogoimgui.ValueFloat, true)
	engine.RegisterMethod("imgui.inputTextWithHint", "ImGui.InputTextWithHint", autogoimgui.InputTextWithHint, true)
	engine.RegisterMethod("imgui.inputTextMultiline", "ImGui.InputTextMultiline", autogoimgui.InputTextMultiline, true)
	engine.RegisterMethod("imgui.createTextureNrgba", "ImGui.CreateTextureNrgba", autogoimgui.CreateTextureNrgba, true)
	engine.RegisterMethod("imgui.newEmptyBitArrayForNamedKeys", "ImGui.NewEmptyBitArrayForNamedKeys", autogoimgui.NewEmptyBitArrayForNamedKeys, true)
	engine.RegisterMethod("imgui.newEmptyBitVector", "ImGui.NewEmptyBitVector", autogoimgui.NewEmptyBitVector, true)
	engine.RegisterMethod("imgui.newEmptyDrawChannel", "ImGui.NewEmptyDrawChannel", autogoimgui.NewEmptyDrawChannel, true)
	engine.RegisterMethod("imgui.newEmptyDrawCmd", "ImGui.NewEmptyDrawCmd", autogoimgui.NewEmptyDrawCmd, true)
	engine.RegisterMethod("imgui.newEmptyDrawCmdHeader", "ImGui.NewEmptyDrawCmdHeader", autogoimgui.NewEmptyDrawCmdHeader, true)
	engine.RegisterMethod("imgui.newEmptyDrawData", "ImGui.NewEmptyDrawData", autogoimgui.NewEmptyDrawData, true)
	engine.RegisterMethod("imgui.newEmptyDrawDataBuilder", "ImGui.NewEmptyDrawDataBuilder", autogoimgui.NewEmptyDrawDataBuilder, true)
	engine.RegisterMethod("imgui.newEmptyDrawList", "ImGui.NewEmptyDrawList", autogoimgui.NewEmptyDrawList, true)
	engine.RegisterMethod("imgui.newEmptyDrawListSharedData", "ImGui.NewEmptyDrawListSharedData", autogoimgui.NewEmptyDrawListSharedData, true)
	engine.RegisterMethod("imgui.newEmptyDrawListSplitter", "ImGui.NewEmptyDrawListSplitter", autogoimgui.NewEmptyDrawListSplitter, true)
	engine.RegisterMethod("imgui.newEmptyDrawVert", "ImGui.NewEmptyDrawVert", autogoimgui.NewEmptyDrawVert, true)
	engine.RegisterMethod("imgui.newEmptyFont", "ImGui.NewEmptyFont", autogoimgui.NewEmptyFont, true)
	engine.RegisterMethod("imgui.newEmptyFontAtlas", "ImGui.NewEmptyFontAtlas", autogoimgui.NewEmptyFontAtlas, true)
	engine.RegisterMethod("imgui.newEmptyFontAtlasBuilder", "ImGui.NewEmptyFontAtlasBuilder", autogoimgui.NewEmptyFontAtlasBuilder, true)
	engine.RegisterMethod("imgui.newEmptyFontAtlasPostProcessData", "ImGui.NewEmptyFontAtlasPostProcessData", autogoimgui.NewEmptyFontAtlasPostProcessData, true)
	engine.RegisterMethod("imgui.newEmptyFontAtlasRect", "ImGui.NewEmptyFontAtlasRect", autogoimgui.NewEmptyFontAtlasRect, true)
	engine.RegisterMethod("imgui.newEmptyFontAtlasRectEntry", "ImGui.NewEmptyFontAtlasRectEntry", autogoimgui.NewEmptyFontAtlasRectEntry, true)
	engine.RegisterMethod("imgui.newEmptyFontBaked", "ImGui.NewEmptyFontBaked", autogoimgui.NewEmptyFontBaked, true)
	engine.RegisterMethod("imgui.newEmptyFontConfig", "ImGui.NewEmptyFontConfig", autogoimgui.NewEmptyFontConfig, true)
	engine.RegisterMethod("imgui.newEmptyFontGlyph", "ImGui.NewEmptyFontGlyph", autogoimgui.NewEmptyFontGlyph, true)
	engine.RegisterMethod("imgui.newEmptyFontGlyphRangesBuilder", "ImGui.NewEmptyFontGlyphRangesBuilder", autogoimgui.NewEmptyFontGlyphRangesBuilder, true)
	engine.RegisterMethod("imgui.newEmptyFontLoader", "ImGui.NewEmptyFontLoader", autogoimgui.NewEmptyFontLoader, true)
	engine.RegisterMethod("imgui.newEmptyFontStackData", "ImGui.NewEmptyFontStackData", autogoimgui.NewEmptyFontStackData, true)
	engine.RegisterMethod("imgui.newEmptyBoxSelectState", "ImGui.NewEmptyBoxSelectState", autogoimgui.NewEmptyBoxSelectState, true)
	engine.RegisterMethod("imgui.newEmptyColorMod", "ImGui.NewEmptyColorMod", autogoimgui.NewEmptyColorMod, true)
	engine.RegisterMethod("imgui.newEmptyComboPreviewData", "ImGui.NewEmptyComboPreviewData", autogoimgui.NewEmptyComboPreviewData, true)
	engine.RegisterMethod("imgui.newEmptyContext", "ImGui.NewEmptyContext", autogoimgui.NewEmptyContext, true)
	engine.RegisterMethod("imgui.newEmptyContextHook", "ImGui.NewEmptyContextHook", autogoimgui.NewEmptyContextHook, true)
	engine.RegisterMethod("imgui.newEmptyDataTypeInfo", "ImGui.NewEmptyDataTypeInfo", autogoimgui.NewEmptyDataTypeInfo, true)
	engine.RegisterMethod("imgui.newEmptyDataTypeStorage", "ImGui.NewEmptyDataTypeStorage", autogoimgui.NewEmptyDataTypeStorage, true)
	engine.RegisterMethod("imgui.newEmptyDeactivatedItemData", "ImGui.NewEmptyDeactivatedItemData", autogoimgui.NewEmptyDeactivatedItemData, true)
	engine.RegisterMethod("imgui.newEmptyDebugAllocEntry", "ImGui.NewEmptyDebugAllocEntry", autogoimgui.NewEmptyDebugAllocEntry, true)
	engine.RegisterMethod("imgui.newEmptyDebugAllocInfo", "ImGui.NewEmptyDebugAllocInfo", autogoimgui.NewEmptyDebugAllocInfo, true)
	engine.RegisterMethod("imgui.newEmptyDockContext", "ImGui.NewEmptyDockContext", autogoimgui.NewEmptyDockContext, true)
	engine.RegisterMethod("imgui.newEmptyDockNode", "ImGui.NewEmptyDockNode", autogoimgui.NewEmptyDockNode, true)
	engine.RegisterMethod("imgui.newEmptyErrorRecoveryState", "ImGui.NewEmptyErrorRecoveryState", autogoimgui.NewEmptyErrorRecoveryState, true)
	engine.RegisterMethod("imgui.newEmptyFocusScopeData", "ImGui.NewEmptyFocusScopeData", autogoimgui.NewEmptyFocusScopeData, true)
	engine.RegisterMethod("imgui.newEmptyGroupData", "ImGui.NewEmptyGroupData", autogoimgui.NewEmptyGroupData, true)
	engine.RegisterMethod("imgui.newEmptyIDStackTool", "ImGui.NewEmptyIDStackTool", autogoimgui.NewEmptyIDStackTool, true)
	engine.RegisterMethod("imgui.newEmptyIO", "ImGui.NewEmptyIO", autogoimgui.NewEmptyIO, true)
	engine.RegisterMethod("imgui.newEmptyInputEvent", "ImGui.NewEmptyInputEvent", autogoimgui.NewEmptyInputEvent, true)
	engine.RegisterMethod("imgui.newEmptyInputEventAppFocused", "ImGui.NewEmptyInputEventAppFocused", autogoimgui.NewEmptyInputEventAppFocused, true)
	engine.RegisterMethod("imgui.newEmptyInputEventKey", "ImGui.NewEmptyInputEventKey", autogoimgui.NewEmptyInputEventKey, true)
	engine.RegisterMethod("imgui.newEmptyInputEventMouseButton", "ImGui.NewEmptyInputEventMouseButton", autogoimgui.NewEmptyInputEventMouseButton, true)
	engine.RegisterMethod("imgui.newEmptyInputEventMousePos", "ImGui.NewEmptyInputEventMousePos", autogoimgui.NewEmptyInputEventMousePos, true)
	engine.RegisterMethod("imgui.newEmptyInputEventMouseViewport", "ImGui.NewEmptyInputEventMouseViewport", autogoimgui.NewEmptyInputEventMouseViewport, true)
	engine.RegisterMethod("imgui.newEmptyInputEventMouseWheel", "ImGui.NewEmptyInputEventMouseWheel", autogoimgui.NewEmptyInputEventMouseWheel, true)
	engine.RegisterMethod("imgui.newEmptyInputEventText", "ImGui.NewEmptyInputEventText", autogoimgui.NewEmptyInputEventText, true)
	engine.RegisterMethod("imgui.newEmptyInputTextCallbackData", "ImGui.NewEmptyInputTextCallbackData", autogoimgui.NewEmptyInputTextCallbackData, true)
	engine.RegisterMethod("imgui.newEmptyInputTextDeactivatedState", "ImGui.NewEmptyInputTextDeactivatedState", autogoimgui.NewEmptyInputTextDeactivatedState, true)
	engine.RegisterMethod("imgui.newEmptyInputTextState", "ImGui.NewEmptyInputTextState", autogoimgui.NewEmptyInputTextState, true)
	engine.RegisterMethod("imgui.newEmptyKeyData", "ImGui.NewEmptyKeyData", autogoimgui.NewEmptyKeyData, true)
	engine.RegisterMethod("imgui.newEmptyKeyOwnerData", "ImGui.NewEmptyKeyOwnerData", autogoimgui.NewEmptyKeyOwnerData, true)
	engine.RegisterMethod("imgui.newEmptyKeyRoutingData", "ImGui.NewEmptyKeyRoutingData", autogoimgui.NewEmptyKeyRoutingData, true)
	engine.RegisterMethod("imgui.newEmptyKeyRoutingTable", "ImGui.NewEmptyKeyRoutingTable", autogoimgui.NewEmptyKeyRoutingTable, true)
	engine.RegisterMethod("imgui.newEmptyLastItemData", "ImGui.NewEmptyLastItemData", autogoimgui.NewEmptyLastItemData, true)
	engine.RegisterMethod("imgui.newEmptyListClipper", "ImGui.NewEmptyListClipper", autogoimgui.NewEmptyListClipper, true)
	engine.RegisterMethod("imgui.newEmptyListClipperData", "ImGui.NewEmptyListClipperData", autogoimgui.NewEmptyListClipperData, true)
	engine.RegisterMethod("imgui.newEmptyListClipperRange", "ImGui.NewEmptyListClipperRange", autogoimgui.NewEmptyListClipperRange, true)
	engine.RegisterMethod("imgui.newEmptyLocEntry", "ImGui.NewEmptyLocEntry", autogoimgui.NewEmptyLocEntry, true)
	engine.RegisterMethod("imgui.newEmptyMenuColumns", "ImGui.NewEmptyMenuColumns", autogoimgui.NewEmptyMenuColumns, true)
	engine.RegisterMethod("imgui.newEmptyMetricsConfig", "ImGui.NewEmptyMetricsConfig", autogoimgui.NewEmptyMetricsConfig, true)
	engine.RegisterMethod("imgui.newEmptyMultiSelectIO", "ImGui.NewEmptyMultiSelectIO", autogoimgui.NewEmptyMultiSelectIO, true)
	engine.RegisterMethod("imgui.newEmptyMultiSelectState", "ImGui.NewEmptyMultiSelectState", autogoimgui.NewEmptyMultiSelectState, true)
	engine.RegisterMethod("imgui.newEmptyMultiSelectTempData", "ImGui.NewEmptyMultiSelectTempData", autogoimgui.NewEmptyMultiSelectTempData, true)
	engine.RegisterMethod("imgui.newEmptyNavItemData", "ImGui.NewEmptyNavItemData", autogoimgui.NewEmptyNavItemData, true)
	engine.RegisterMethod("imgui.newEmptyNextItemData", "ImGui.NewEmptyNextItemData", autogoimgui.NewEmptyNextItemData, true)
	engine.RegisterMethod("imgui.newEmptyNextWindowData", "ImGui.NewEmptyNextWindowData", autogoimgui.NewEmptyNextWindowData, true)
	engine.RegisterMethod("imgui.newEmptyOldColumnData", "ImGui.NewEmptyOldColumnData", autogoimgui.NewEmptyOldColumnData, true)
	engine.RegisterMethod("imgui.newEmptyOldColumns", "ImGui.NewEmptyOldColumns", autogoimgui.NewEmptyOldColumns, true)
	engine.RegisterMethod("imgui.newEmptyOnceUponAFrame", "ImGui.NewEmptyOnceUponAFrame", autogoimgui.NewEmptyOnceUponAFrame, true)
	engine.RegisterMethod("imgui.newEmptyPayload", "ImGui.NewEmptyPayload", autogoimgui.NewEmptyPayload, true)
	engine.RegisterMethod("imgui.newEmptyPlatformIO", "ImGui.NewEmptyPlatformIO", autogoimgui.NewEmptyPlatformIO, true)
	engine.RegisterMethod("imgui.newEmptyPlatformImeData", "ImGui.NewEmptyPlatformImeData", autogoimgui.NewEmptyPlatformImeData, true)
	engine.RegisterMethod("imgui.newEmptyPlatformMonitor", "ImGui.NewEmptyPlatformMonitor", autogoimgui.NewEmptyPlatformMonitor, true)
	engine.RegisterMethod("imgui.newEmptyPopupData", "ImGui.NewEmptyPopupData", autogoimgui.NewEmptyPopupData, true)
	engine.RegisterMethod("imgui.newEmptyPtrOrIndex", "ImGui.NewEmptyPtrOrIndex", autogoimgui.NewEmptyPtrOrIndex, true)
	engine.RegisterMethod("imgui.newEmptySelectionBasicStorage", "ImGui.NewEmptySelectionBasicStorage", autogoimgui.NewEmptySelectionBasicStorage, true)
	engine.RegisterMethod("imgui.newEmptySelectionExternalStorage", "ImGui.NewEmptySelectionExternalStorage", autogoimgui.NewEmptySelectionExternalStorage, true)
	engine.RegisterMethod("imgui.newEmptySelectionRequest", "ImGui.NewEmptySelectionRequest", autogoimgui.NewEmptySelectionRequest, true)
	engine.RegisterMethod("imgui.newEmptySettingsHandler", "ImGui.NewEmptySettingsHandler", autogoimgui.NewEmptySettingsHandler, true)
	engine.RegisterMethod("imgui.newEmptyShrinkWidthItem", "ImGui.NewEmptyShrinkWidthItem", autogoimgui.NewEmptyShrinkWidthItem, true)
	engine.RegisterMethod("imgui.newEmptySizeCallbackData", "ImGui.NewEmptySizeCallbackData", autogoimgui.NewEmptySizeCallbackData, true)
	engine.RegisterMethod("imgui.newEmptyStackLevelInfo", "ImGui.NewEmptyStackLevelInfo", autogoimgui.NewEmptyStackLevelInfo, true)
	engine.RegisterMethod("imgui.newEmptyStorage", "ImGui.NewEmptyStorage", autogoimgui.NewEmptyStorage, true)
	engine.RegisterMethod("imgui.newEmptyStoragePair", "ImGui.NewEmptyStoragePair", autogoimgui.NewEmptyStoragePair, true)
	engine.RegisterMethod("imgui.newEmptyStyle", "ImGui.NewEmptyStyle", autogoimgui.NewEmptyStyle, true)
	engine.RegisterMethod("imgui.newEmptyStyleMod", "ImGui.NewEmptyStyleMod", autogoimgui.NewEmptyStyleMod, true)
	engine.RegisterMethod("imgui.newEmptyStyleVarInfo", "ImGui.NewEmptyStyleVarInfo", autogoimgui.NewEmptyStyleVarInfo, true)
	engine.RegisterMethod("imgui.newEmptyTabBar", "ImGui.NewEmptyTabBar", autogoimgui.NewEmptyTabBar, true)
	engine.RegisterMethod("imgui.newEmptyTabItem", "ImGui.NewEmptyTabItem", autogoimgui.NewEmptyTabItem, true)
	engine.RegisterMethod("imgui.newEmptyTable", "ImGui.NewEmptyTable", autogoimgui.NewEmptyTable, true)
	engine.RegisterMethod("imgui.newEmptyTableCellData", "ImGui.NewEmptyTableCellData", autogoimgui.NewEmptyTableCellData, true)
	engine.RegisterMethod("imgui.newEmptyTableColumn", "ImGui.NewEmptyTableColumn", autogoimgui.NewEmptyTableColumn, true)
	engine.RegisterMethod("imgui.newEmptyTableColumnSettings", "ImGui.NewEmptyTableColumnSettings", autogoimgui.NewEmptyTableColumnSettings, true)
	engine.RegisterMethod("imgui.newEmptyTableColumnSortSpecs", "ImGui.NewEmptyTableColumnSortSpecs", autogoimgui.NewEmptyTableColumnSortSpecs, true)
	engine.RegisterMethod("imgui.newEmptyTableHeaderData", "ImGui.NewEmptyTableHeaderData", autogoimgui.NewEmptyTableHeaderData, true)
	engine.RegisterMethod("imgui.newEmptyTableInstanceData", "ImGui.NewEmptyTableInstanceData", autogoimgui.NewEmptyTableInstanceData, true)
	engine.RegisterMethod("imgui.newEmptyTableSettings", "ImGui.NewEmptyTableSettings", autogoimgui.NewEmptyTableSettings, true)
	engine.RegisterMethod("imgui.newEmptyTableSortSpecs", "ImGui.NewEmptyTableSortSpecs", autogoimgui.NewEmptyTableSortSpecs, true)
	engine.RegisterMethod("imgui.newEmptyTableTempData", "ImGui.NewEmptyTableTempData", autogoimgui.NewEmptyTableTempData, true)
	engine.RegisterMethod("imgui.newEmptyTextBuffer", "ImGui.NewEmptyTextBuffer", autogoimgui.NewEmptyTextBuffer, true)
	engine.RegisterMethod("imgui.newEmptyTextFilter", "ImGui.NewEmptyTextFilter", autogoimgui.NewEmptyTextFilter, true)
	engine.RegisterMethod("imgui.newEmptyTextIndex", "ImGui.NewEmptyTextIndex", autogoimgui.NewEmptyTextIndex, true)
	engine.RegisterMethod("imgui.newEmptyTextRange", "ImGui.NewEmptyTextRange", autogoimgui.NewEmptyTextRange, true)
	engine.RegisterMethod("imgui.newEmptyTreeNodeStackData", "ImGui.NewEmptyTreeNodeStackData", autogoimgui.NewEmptyTreeNodeStackData, true)
	engine.RegisterMethod("imgui.newEmptyTypingSelectRequest", "ImGui.NewEmptyTypingSelectRequest", autogoimgui.NewEmptyTypingSelectRequest, true)
	engine.RegisterMethod("imgui.newEmptyTypingSelectState", "ImGui.NewEmptyTypingSelectState", autogoimgui.NewEmptyTypingSelectState, true)
	engine.RegisterMethod("imgui.newEmptyViewport", "ImGui.NewEmptyViewport", autogoimgui.NewEmptyViewport, true)
	engine.RegisterMethod("imgui.newEmptyViewportP", "ImGui.NewEmptyViewportP", autogoimgui.NewEmptyViewportP, true)
	engine.RegisterMethod("imgui.newEmptyWindow", "ImGui.NewEmptyWindow", autogoimgui.NewEmptyWindow, true)
	engine.RegisterMethod("imgui.newEmptyWindowClass", "ImGui.NewEmptyWindowClass", autogoimgui.NewEmptyWindowClass, true)
	engine.RegisterMethod("imgui.newEmptyWindowDockStyle", "ImGui.NewEmptyWindowDockStyle", autogoimgui.NewEmptyWindowDockStyle, true)
	engine.RegisterMethod("imgui.newEmptyWindowSettings", "ImGui.NewEmptyWindowSettings", autogoimgui.NewEmptyWindowSettings, true)
	engine.RegisterMethod("imgui.newEmptyWindowStackData", "ImGui.NewEmptyWindowStackData", autogoimgui.NewEmptyWindowStackData, true)
	engine.RegisterMethod("imgui.newEmptyWindowTempData", "ImGui.NewEmptyWindowTempData", autogoimgui.NewEmptyWindowTempData, true)
	engine.RegisterMethod("imgui.newEmptyTextureData", "ImGui.NewEmptyTextureData", autogoimgui.NewEmptyTextureData, true)
	engine.RegisterMethod("imgui.newEmptyTextureRect", "ImGui.NewEmptyTextureRect", autogoimgui.NewEmptyTextureRect, true)
	engine.RegisterMethod("imgui.newEmptyTextureRef", "ImGui.NewEmptyTextureRef", autogoimgui.NewEmptyTextureRef, true)
	engine.RegisterMethod("imgui.newEmptyVec1", "ImGui.NewEmptyVec1", autogoimgui.NewEmptyVec1, true)
	engine.RegisterMethod("imgui.newEmptyVec2i", "ImGui.NewEmptyVec2i", autogoimgui.NewEmptyVec2i, true)
	engine.RegisterMethod("imgui.newEmptystbrpcontextopaque", "ImGui.NewEmptystbrpcontextopaque", autogoimgui.NewEmptystbrpcontextopaque, true)
	engine.RegisterMethod("imgui.vertexBufferLayout", "ImGui.VertexBufferLayout", autogoimgui.VertexBufferLayout, true)
	engine.RegisterMethod("imgui.indexBufferLayout", "ImGui.IndexBufferLayout", autogoimgui.IndexBufferLayout, true)
	engine.RegisterMethod("imgui.newGlyphRange", "ImGui.NewGlyphRange", autogoimgui.NewGlyphRange, true)
